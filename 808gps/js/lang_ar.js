function langArabic() {
  ...
  this.vehicle_tscertificatemanagement =
    "Transportation Certificate Management";
  ...
  this.del = "حذف";
  this.delconfirm =
    "البيانات المحذوفة لا يمكن استراجاعها، هل تريد الاستمرار ام لا?";
  ...
  this.errInfo =
    "المتصفح الخاص بك لا يسمح لك بالحصول على صورة bitmap من الصورة، , يمكنك فقط الحصول على صورة VML التي يمكنك استخدامها في Microsoft Office.<br />";
  ...
  this.usermgr_user_roleNullTip =
    "لم يتم تحديد مهام المتخدم, ولا يملك اي صلاحية! هل تريد الاستمرار?";
  ...
  this.usermgr_user_tipResetDefaultPwd =
    "استعادة كلمة المرور الافتراضية (كلمة المرور الافتراضية هي: 000000)?";
  ...
  this.vehicle_nameParamRegx =
    'الاسم لابد ان لا يحتوي (# $ @% ^ &   /: *?  "<> |,) وباقي الحروف الخاصة.';
  ...
  this.vehicle_group_drag_tip =
    "لا يمكن استخدام عملية السحب لنقل مركبة او مجموعة";
  ...
  this.vehicle_group_groupHasChild =
    "هذه المجموعة ايضا موجودة ولا يمكن حذف المجموعة الفرعية او عقدة المركبة!";
  this.vehicle_brand_groupHasChild =
    "هذه العلامة التجارية ايضا موجودة , لايمكن حذف نوع المعلومات!!";
  ...
  this.vehicle_downplan_timeunvalid =
    "وقت البداية لابد ان لا يكون اكبر من وقت النهاية!";
  ...
  this.vehicle_mapfence_speedHighWarnHighError =
    "السرعة الزائدة لابد ان لا تتخطى اقصي سرعة!";
  this.vehicle_mapfence_speedLowWarnHighError =
    "السرعة المنخفضة لابد ان لاتتخطى  اقل سرعة!";
  ...
  this.vehicle_mapfence_speedHighLowError =
    "اقل سرعة لابد ان لا تتخطى اقصي سرعة!";
  this.vehicle_mapfence_parkTimeError =
    "تأخير التوقف يتراوح بين 60-9999 الرجاء اعادة الادخال!";
  ...
  this.vehicle_snapshotpaln_intervalError =
    "الفاصل الزمني للالتقاط يتراوح بين 60-3600, الرجاء الادخال مرة اخرى!";
  ...
  this.vehicle_recordpaln_alarmDelayError =
    "تأخير تسجيل التنبية يتراوح بين 30-900, الرجاء اعادة الادخال!";
  this.vehicle_tipStorage =
    "ملاحظة: مدير النظام يقوم بتهيئة وحدة التخزين المقترنة اولا";
  ...
  this.vehicle_alarmaction_spanTipSmsContent =
    "اذا ماكان المحتوى فارغ, المحتوى الخاص بالرسالة: المحطة + الوقت + وصف التنبية";
  ...
  this.vehicle_alarmaction_spanTipEmailContent =
    "أذا ما كان المحتوى فارغ, المحتوي في البريد الالكتروني سيكون: المحطة + الوقت + وصف التنبية";
  this.vehicle_alarmaction_spanTipTime =
    "وخلال هذه الفترة الزمنية قبل تنفيذ الربط";
  this.vehicle_alarmaction_smsAddressEmpty =
    "رقم الجوال يجب أن لا يكون فارغاً!";
  this.vehicle_alarmaction_smsAddressUnvalid =
    "خطأ في رقم الجوال! لابد ان يكون ارقام, استخدم ; فصل بـ!";
  this.vehicle_alarmaction_emailAddressEmpty =
    "البريد الالكتروني لابد ان لا يكون فارغ!";
  ...
  this.vehicle_alarmaction_recordingTimeError =
    "وقت التسجيل يتراوح بين 30-1800, الرجاء اعادة الادخال!";
  ...
  this.vehicle_alarmaction_alarmSubTypeTip =
    "استخدم , منفصلة!,فقط التنبيهات المخصصه يمكن تعينها,كل الانواع الفرعية لا يمكن تهيئتها منفصله";
  this.vehicle_alarmaction_alarmSubTypeEmpty =
    "لا يمكن ان يكون النوع الفرعي للتنبية فارغ!";
  this.vehicle_alarmaction_alarmSubTypeUnvalid =
    "الوع الفرعي للتنبية المخصص خطأ! لابد ان يكون ارقام, استخدم , منفصلة!";
  ...
  this.report_line_key_points_not_arrive =
    "(النظام الاساسي)النقطة الرئيسية للخط(لم يتم الوصول)";
  ...
  this.report_line_key_points_not_leave =
    "(النظام الاساسي)النقطة الرئيسية للخط(لم يتم المغادرة)";
  ...
  this.report_oil_mileage_monthly =
    "تقرير شهري للمسافة المقطوعة بالوقود للشركة";
  ...
  this.errDeviceBatchIdnoErr =
    "اخر ثلاث عناصر من IDNO. لابد ان تكون رقم, وبالزيادة لتأكيد الفاعلية!"; //RET_DEVICE_BATCH_IDNO_ERR = 14;
  ...
  this.errGroupHasUsed =
    "المجموعة ما زالت مشغولة (ايضا المجموعات الفرعية او المركبات التابعة)"; //RET_GROUP_HAS_USED = 27;	//车辆分组信息还在被占用（还存储子分组或者下级车辆）
  ...
  this.report_oil_operate_tip_one =
    "ملاحظة 1: تبديل الصورة (انواع الصور لتحويل الرسم المخطط), تنزيل الصور (يمكن تنزيل المخطط كصورة) , لاستعادة الصورة (المخططات المصورة يمكن تحويلها الي مخططات).";
  this.report_oil_operate_tip_two =
    "ملاحظة 2: الضغط والتحريك باستخدام الفارة, يمكنك التكبير والتركيز علي منحني الفترة الزمنية المحددة, بالضغط مرتين علي المنحني يمكنك استعادة الحجم الاصلي.";
  ...
  this.delvehicles =
    "Whether Selected Vehicles corresponding device info delete?";
  ...
  this.startTime_of_drivers_license =
    "The Driver's License Valid Starting Time";
  ...
  this.selThisAfterSelVideo =
    "After selecting the video before they can choose intercom and monitor!";
  ...
  this.last7Days = "اخر ٧ ايام";
  this.last7DaysEx = "اخر ٧ ايام";
  ...
  this.labelUser = "User:";
  this.vehicleTotalCount = "اجمالي المركبات";
  this.realTimeVehicleCount = "عدد المركبات في الوقت الآني";
  this.safeTyVehiNum = "المركبات النشطة";
  this.securityCloudScreen = "الحالة العامة للنظام";

  //   Added props
  this.toilets = "المراحيض";
  this.total = "الإجمالي";
  ...
  this.report_equipment_offlineRecordingEquipmentUpgrade =
    "Device OFL UPG Record RPT";
  ...
  this.label_tipStorage =
    "Tip: system administrator configure the storage associated first";
  ...
  this.server_tipServerAddress2 =
    "Usually, address 1 and 2 will be consistent!";
  ...
  this.corresponding_to_the_amount_of_oil =
    "Corresponding to the amount of oil (liters)";
  ...
  this.organization_analysis_chart =
    "organization of illegal Rank analysis chart";
  this.before = "before";
  this.organization_violation =
    " Organization Violation ranking analysis chart";
  ...
  this.delete_before_company =
    "(Need to first remove the vehicle under the company, the team, role, device, sim card, driver, IC Card, Rule information)";
  ...
  this.tire_pressure_monitoring_information =
  ...
  this.passwordcheck =
    "Password length of at least 8, by letters, numbers, symbols, more than two kinds of composition";
  ...
  this.selectDepartmentTip =
    "There is no corresponding value in the Department list.";
  ...
  this.deleteDepartmentBefore =
    "(Need to be the first Department of police officers, users, roles, equipment information deleted)";
  this.existchildCompany =
    "The current department can not modify the superior department";
  ...
  this.policelstError =
    "(The Department can not be empty, The Police Number / Equipment Number can not be empty and does not appear to be repeated (Cell format is recommended to use text mode)";
  this.policeDepartmentTips =
    "(The current department has not been created, please first create the Department to import)";
  this.deviceExist = "(Tip: The device already exists)";
  this.policeExist = "(Tip: Police number already exists)";
  this.notNullTips =
    "Requirements: Account only, The Organization and Role Permissions can not be empty! Role permissions can only belong to an organization.";
  this.roleErrorTips =
    "A role can only belong to an organization, please check whether the role is occupied by other organizations. )";
  ...
  this.userImportCompanyError =
    "All the organizations within the current excel have not been created yet!";
  this.userImportErrorAfter =
    "The organization has not yet created. Please create the organization, and then import operation";

  this.report_vehicle_video_inspection = "Vehicle Video Inspection Report";
  this.report_enterprise_video_inspection_summary =
    "Enterprise Video Inspection Summary";
  this.report_vehicle_video_inspection_summary =
    "Vehicle Video Inspection Summary";
  this.report_vehicle_video_inspection_detail =
    "Vehicle Video Inspection Detail";
  ...
  this["system.log.sysusr.server.downstation.add"] =
    "sumar sitio de descarga : ID Sitio: {0} , nombre del sitio : {1}";
  ...
  this["account.role"] =
    "Role Permission (cannot be empty, cannot belong to more than one organization)";
  ...
  this["report.tire.pressure.monitoring.summary"] =
    "Tire Pressure Monitoring Summary";
  ...
  this["report.alarm.detail.motion"] =
    "movimiento horario de alarma de detección";
  ...
  this["system.log.sysusr.server.downstation.del"] =
    "eliminar descarga sitio: ID Sitio: {0} , nombre del sitio : {1}";
  ...
  this["user.log.login.getsvrfailed"] =
    "Asignar falla del servidor del usuario";
  ...
  this["system.log.sysusr.device.batchadd"] =
    "batch agregar la información del dispositivo , número de dispositivo : {0}, number: {1}";
  ...
  this["system.log.sysusr.client.add"] =
    "sumar la información del cliente , la cuenta de inicio de sesión: {0}";
  ...
  this["report.alarm.detail.gpssignnal"] =
    "lista de alarmas de pérdida de señal GPS";
  ...
  this["system.log.sysusr.server.storagerelation.add"] =
    "sumar la asociación de almacenamiento : ID de servidor: {0} , ID de servidor: {1} , el número de dispositivo: {2}";
  ...
  this["system.log.sysusr.device.batchdel"] =
    "Bulk Device Delete: ID de dispositivo: {0}";
  ...
  this["report.temp.detailException"] =
    "Temperature Over-Temperature Breakdown";
  ...
  this["system.log.sysusr.deletetip"] =
    "Nota: Si el nombre de usuario no se conoce , puede haber sido borrado de la información de usuario";
  ...
  this["report.alarm.detail.nightdriving"] =
    "Lista de alarmas Conducir de noche";
  ...
  this["system.log.sysusr.client.del"] =
    "borrar la información del cliente , la cuenta de inicio de sesión: {0}";
  this["terminal.mobile.sex"] = "sexo";
  this["north"] = "North";
  this["terminal.sim"] = "tarjeta SIM";
  this["system.log.server.logout"] =
    "servidor de salida (logout al servidor de inicio de sesión)";
  ...
  this["system.log.sysusr.server.storagerelation.del"] =
    "Borrar Asociación de almacenamiento: ID de servidor: {0} , ID de servidor: {1} , el número de dispositivo: {2}";
  this["report.alarm.speed.unit.km"] = "Km/h";
  this["system.log.sysusr.server.add"] =
    "Agrega {0} de la información, el ID de servidor: {1}";
  this["vehicle.relation.chnAttr"] = "Number Of Channels";
  this["system.log.sysusr.server.gpsdb"] =
    "GPS modificar la información de base de datos, GPS Número de registro: {0}, nombre de base de datos GPS: {1}";
  ...
  this["system.log.sysusr.device.batchsale"] =
    "dispositivos del mercado de masas : Cuenta: {0},el número de dispositivo: {1}";
  ...
  this["report.alarm.detail.urgencybutton"] =
    "botón de lista de alarma de emergencia";
  this["report.trip.total"] = "Total Trip Times";
  this["report.platform.areaPoint"] =
    "The Key Point Monitoring Alarm (Platform)";
  this["line.outbound.time"] = "Outbound Time";
  this["report.rolloverCollisionAlarmTriggered"] =
    "Rollover Collision Alarm Is Triggered";
  ...
  this["importModel.department"] =
    "Organization (Not empty current account corresponding to the company and subsidiaries);";
  this["report.alarm.io12"] = "IO_12 Alarm";
  this["system.log.sysusr.client.edit"] =
    "modificar la información del cliente , la cuenta de inicio de sesión: {0}";
  ...
  this["system.log.sysusr.server.del"] =
    "{0} borrar información , el ID de servidor: {1}";
  ...
  this["system.log.server.deletetip"] =
    "Nota: Si el nombre del servidor no se conoce , puede haber sido borrado de la información del servidor";
  ...
  this["system.log.sysusr.device.add"] =
    "sumar la información del dispositivo , ID de dispositivo: {0}";
  this["report.speed.summary"] = "resumen de alarmas de velocidad";
  this["terminal.name"] = "nombre";
  this["report.fence.inOverspeed"] =
    "área de admisión de alarma de exceso de velocidad";
  ...
  this["system.log.sysusr.client.resetpwd"] =
    "Contraseña al cliente información de restablecimiento, la cuenta de inicio de sesión: {0}";
  ...
  this["system.log.sysusr.device.del"] =
    "borrar la información del dispositivo , número de dispositivo: {0}";
  this["system.log.sysusr.device.resale"] =
    "equipo de transferencia : Equipment ID: {0},{1} de la cuenta del cliente se transfiere a la cuenta del cliente {2}";
  this["report.bounds"] = "Cross-border police";
  this["report.platform"] = "Platform";
  this["system.log.sysusr.server.edit"] =
    "{0} modificar la información , el ID de servidor: {1}";
  this["male"] = "Male";
  ...
  this["report.tire.pressure.monitoring.detail"] =
    "Tire Pressure Monitoring Excessive Detail";
  ...
  this["system.log.sysusr.server.downstation.edit"] =
    "Modificar sitio de descarga : ID Sitio: {0} , nombre del sitio : {1}";
  ...
  this["system.log.sysusr.device.batchresale"] =
    "equipos de transferencia de masa : Equipment ID : {0},{1} de la cuenta del cliente se transfiere a la cuenta del cliente {2}";
  ...
  this["report.alarm.detail.diskerror"] =
    "lista de alarmas de error de disco duro";
  ...
  this["system.log.sysusr.device.edit"] =
    "modificar la información del dispositivo , número de dispositivo: {0}";
  ...
  this["report.platform.roadLvlOverSpeed"] =
    "Road Class Speed Alarm (Platform)";
  ...
  this["report.InadequateOrTooLongRoadTravelTime"] =
    "Inadequate Or Too Long Road Travel Time";
  ...
  this["report.platform.outOfRegional"] =
    "Go In And Out Regional Alarm (Platform)";
  ...
  this["system.log.sysusr.login"] =
    "sistema de inicio de sesión de usuario, dirección de registro: {0}";
  ...
  this["tire.pressure.monitoring.information"] =
    "Tire Pressure Monitoring Information";
  this["direction"] = "Direction";
  this["report.alarm.urgencybutton"] = "alarma botón de emergencia";
  this["system.log.sysusr.device.sale"] =
    "venta de equipo : Equipos de Identificación: {0},el número de cuenta del cliente: {1}";
  ...
  this["report.alarm.detail.videolost"] =
    "lista de alarmas de pérdida de vídeo";
  ...
  this["user.log.login.login"] =
    "sistema de inicio de sesión de usuario, dirección de registro : {0} , escriba: {1}";
  ...
  this["system.log.server.login"] =
    "servidor de inicio de sesión (registrado con el servidor de inicio de sesión)";
  ...
  this["system.log.sysusr.server.login"] =
    "modificar la información del servidor de registro";
  ...
  this["system.log.sysusr.server.sysdb"] =
    "modificar el sistema de información de base de datos";
