function langEnglish() {
  ...
  // 网约车
  this.onlineCarLicenseNo = "Online car license NO";
  ...
  this.noOnlineCarLicenseExpireDuration =
    "{0} days left, Online car license expire";
  ...
  this.vehicle_tscertificatemanagement = "Transportation Certificate";
  ...
  this.multi_screen_monitoring = "Video mode";
  ...
  this.delvehicles =
    "Whether selected vehicles corresponding device information delete?";
  this.deleting = "Delete is being performed ...";
  this.logistics_transportation = "Cargo Freight";
  ...
  this.min_hour = "Hour";
  this.minute = "Minute";
  this.min_minute = "Minute";
  this.second = "Seconds";
  this.min_second = "Seconds";
  this.good = "Good";
  this.bad = "Bad";
  ...
  this.vehicle_team_drag_tip =
    "You can drag to move the team, the motorcade can only move to the subordinate company of the company and the motorcade of the company, motorcade under the same company can move to each other;";
  ...
  this.vehicle_team_selectGroupNode =
    "Please select the company or motorcade nodes!";
  this.vehicle_team_selectNotCompanyNode =
    "Motorcade can not add motorcade, please select the company nodes!";
  this.vehicle_team_editNotCompanyNode =
    "You can not modify company information, please select motorcade nodes!";
  this.vehicle_team_groupHasChild =
    "The motorcade exists inside the vehicle information, can not be deleted!";
  this.vehicle_team_labelSelectCompany = "Select CO.:";
  ...
  this.vehicle_team_notMoveTeam =
    "The motorcade can not be moved to other teams!";
  ...
  this.account_all_permissions =
    "Master Account has full authority to operate!";
  this.account_vehicle_permissions =
    "Master Account has authority to operate the all vehicles under company!";
  ...
  this.device_sysVideoDeviceTip =
    "(Number of management video can be used to add GPS)";
  this.device_factory_type = "Factory Type";

  this.single_add = "Single Add";
  this.batch_add = "Bulk Add";
  this.msg_device_tip =
    "(Not including the last four digits, such as 'CX051234' Enter 'CX05')";
  this.msg_device_bf_tip = "Last four digits from";
  this.msg_device_mid_tip = " to";
  this.msg_device_bg_tip = " ";
  this.msg_device_install_tip =
    "Device has been assembled, can not be modified.";
  ...
  this.validity_of_drivers_license = "Driver's License Expiration Date";
  this.startTime_of_drivers_license = "Driver's License Valid Start Time";
  ...
  this.heartbeat_transmission_interval =
    "Terminal Heartbeat Transmission Interval";
  this.message_response_timeout = " Message Response Timeout";
  this.number_retransmissions = " NO. Of Retransmissions Of  Messages";
  this.CallMonitorSetting_setting = "Call / monitor settings";
  ...
  this.Turn_off_all_wireless_communication =
    "Turn Off All Wireless Communication";
  this.Control_terminal_connect_specified_server =
    "Control Terminal To Connect To The Specified Server";
  this.Connection_control = "Connection Control";
  this.Switch_specified_monitoring_platform_server =
    "Switch To The Specified Monitoring Platform Server";
  this.Switch_original_default_monitoring_platform_server =
    "Switch Back To The Original Default Monitoring Platform Server";
  this.information = "Information";
  this.Authentication_code = "Authentication Code";
  this.set_up_to_other = "Set To Other Vehicles";

  this.Server_APN =
    "Primary Server APN, Wireless Communication Dial-up Access Point";
  this.Wireless_call_username =
    "Primary Server Wireless Communication Dial-up Username";
  this.Wireless_call_psw =
    "Primary Server Wireless Communication Dial Password";
  this.Primary_server_address = "Primary Server Addr (ip or domain name)";

  this.secondary_Server_APN =
    "Secondary Server APN, Wireless Communication Dial-up Access Point";
  this.secondary_Wireless_call_username =
    "Secondary  Server Wireless Communication Dial-up Username";
  this.secondary_Wireless_call_psw =
    "Secondary  Server Wireless Communication Dial Password";
  this.secondary_Primary_server_address =
    " Secondary Server Addr (ip or domain name)";
  ...
  this.distance_photo_switch =
    "Fixed Distance Camera Switch Flag (0: off 1: open)";
  this.distance_photo_storage =
    "Fixed Distance Photo Storage Flag (0: storage 1: upload)";
  ...
  this.Backup_Server_APN =
    "Backup Server APN, Wireless Communication Dial-up Access Point";
  this.Backup_Wireless_call_username =
    "Backup Server Wireless Communication Dial-up Username";
  this.Backup_Wireless_call_psw =
    "Backup Server Wireless Communication Dial Password";
  ...
  this.IC_certification_serverIP =
    "Road Transport Card IC Card Authentication Master Server IP Addr or Domain Name";
  this.IC_certification_TCPPort =
    "Road Transport Card IC Card Authentication Main Server TCP Port";
  this.IC_certification_UDPPort =
    "Road Transport Card IC Card Authentication Main Server UDP Port";
  this.IC_certification_Backup_serverIP =
    "Road Transport Permit IC Card Authentication Backup Server IP Addr or Domain Name";
  ...
  this.data_acquisition_frequency_unit =
    "The unit is seconds, the default is 1";
  ...
  this.by_umulative_time =
    "Upload By Cumulative Time, Automatically Stop Uploading After The Transfer Time Is Reached";
  this.by_cumulative_distance =
    "Upload By Cumulative Distance, Automatically Stop Uploading After Reaching The Distance";
  this.by_cumulative_number =
    "Upload By Cumulative NO., Automatically Stop Uploading After Reaching The NO. Of Uploads";
  ...
  this.Audio_video_channel_parameter_config =
    "Audio And Video Channel Parameter Configuration";
  ...
  this.Individual_video_channel_config =
    "Individual Video Channel Parameter Configuration";
  this.Special_alarm_percentage =
    "Special Alarm Recording Takes Up The Main Memory Storage Threshold Percentage";
  ...
  this.Image_analysis_alarm_parameter_setting =
  ...
  this.Vehicle_load_capacity_description =
    "Passengers Carry Passengers To Determine The Number Of Passengers, And When The Video Analysis Results Exceed, An Alarm Is Generated.";
  this.Fatigue_threshold_description =
    "Video Analysis Fatigue Driving Alarm Threshold, When An Alarm Occurs";
  ...
  this.moduleOilControl =
    "Fuel Line Controller (Off the fuel and the fuel recovery)";
  this.moduleElecControl =
    "Circuit Controller (Cutoff circuit and recovery circuit)";
  ...
  this.manDevice_not_Video =
    "The Master Device In The Dual Device Must Be A Video Terminal";
  this.exists_Device_Gps =
    "The Secondary Device In The Dual Device Needs To Be The Positioning Terminal.";
  this.device = "Device";
  this.device_num_limit = "Once Add Up To 200 Devices";
  this.vehicle_sim_not_tip =
    "If you enter the SIM does not exist, will create a SIM!";
  this.vehicle_device_not_tip =
    "If you enter the device number does not exist, will create a device!";
  this.exists_same_device = "Exist the same device!";
  this.exists_same_sim = "Exist the same SIM!";
  this.chnCountGreaterThan =
    "The number of channels is greater than 12, please check!";
  this.ioCountGreaterThan =
    "The number of IO input is greater than 12, please check!";
  this.tempCountGreaterThan =
    "The number of temperature sensor is greater than 6, please check!";
  ...
  this.notSelModuleInTwoDev =
    "Peripheral property can not be the same on both devices simultaneously!";
  this.mustSelVideoDev = "You must select a video device!";
  this.selOneChnParam = "Only one device can set the channel parameters!";
  this.selOneTempParam =
    "Only one device can set the temperature sensor parameters!";
  ...
  this.invalid_excel_info =
    "invalid data in excel : line {placehold1} ,error reason : {placehold2}.";
  ...
  this.excel_company_notexist_error =
    "company not exist in server, please contact the admin add";
  ...
  this.excel_driver_duplicate_error =
    "The Driver Number Has Been Filled In Repeatedly";
  this.excel_sex_text_error = "Gender Cell Is Not Text Format Or Format Error";
  this.excel_license_text_error =
    "Driver's License Type Cell Is Not In Text Format Or Format Error";
  this.excel_rushDate_text_error =
    "Driver's License Start Date Is Not In Text Format Or Format Error";
  this.excel_validity_text_error =
    "Driver's License Deadline Is Not Text Format Or Format Error";
  this.excel_reminderDays_text_error =
    "Early Reminder Days Are Not Text Format Or Format Error";
  this.excel_reminderDaysType_text_error = "Early Reminder Days Format Error";
  this.excel_validity_before_text_error =
    "Driver's License Deadline Is Earlier Than The Start Date";

  //保险管理
  this.safe_com = "Insurance CO.";
  this.agent = "Agent";
  ...
  this.report_alarm_disposal_sumary = "Alarm Handling Statistics RPT";
  this.login_report_Statistics_summary = "Online Rate Statistics Monthly RPT";

  this.loginReportStatisticsSummaryExplainByDay =
    "Online rate = number of days online / select days";
  this.loginReportStatisticsSummaryExplainByMonth =
    "Online rate = online days / days in the month";
  this.loginRateExplainByDay =
    "Online rate = online duration / (24 x 60 x 60) second";
  this.vehiGpsOnlineRateExplain = "A qualified GPS is 100%, otherwise it is 0.";
  this.loginRateSummaryExplainByDay =
    "Online rate = online duration / number of days apart";
  ...
  this.download_instructions =
    "Photo way: After turning pictures - right in the picture save picture as (IE9 following browsers are not supported)";
  ...
  this.errInfo =
    "Your browser does not allow you to get a bitmap image from here, you can use in Microsoft Office VML image obtained.";
  ...
  this.report_temperatureErr =
    "The temperature value is only one bit after the decimal point!";
  this.report_selectCompanyNullErr = "Please select company!";
  this.report_selectUserNullErr = "Please select a user!";
  this.report_park_timeLess180 =
    "Parking time shall not be less than 180 seconds!";
  this.report_park_timeMax9999 =
    "Parking time shall not be more than 9999 seconds!";
  ...
  this.taxi_Check_out_method = "Sign-out Method";
  ...
  this.report_sms_detail_new = "Issued Info Detail RPT(New)";
  ...
  this.report_InadequateOrTooLongRoadTravelTime =
    "Roads and The Lack of Time or Too Long";
  ...
  this.report_nightdriving = "Early Morning Operation(Platform)";
  ...
  this.report_roadLvlOverSpeed_platform =
    "Road Class Overspeed Alarm(Platform)";
  ...
  this.Empty_drive_mileage = "Empty Drive Mileage";
  this.Fuel_Surcharge = "Fuel Surcharge";
  this.Regional_surcharge = "Regional Surcharge";
  ...
  this.report_storage_harddiskStatusInformationDetail =
    "Storagy Medium Disk Status";
  ...
  this.report_equipment_offlineRecordingEquipmentUpgrade = "Device UPG Offline";
  ...
  this.report_liCheng_dayMonth_detail = "Mileage Day/Month RPT";
  ...
  this.report_vehicle_txt = "Text";
  this.report_vehicle_photo_new = "Photos (new)";
  this.report_vehicle_audio_new = "Audio (new)";
  this.report_vehicle_video_new = "Video (New)";
  ...
  this.rolloverCollisionAlarmTriggered =
    "Rollover Collision Alarm Is Triggered";
  ...
  this.monitor_flashVehicleStatusGetDeviceError =
    "Refresh vehicle state acquisition device error!";
  this.monitor_flashVehicleStatusGetVehicleError =
    "Refresh vehicle state acquiring vehicle Error!";
  this.monitor_gpsMonitor = "GPS Monitor";
  this.monitor_alarmInfo = "Alarm INFO";
  this.monitor_alarmInfo1 = "Alarm";
  this.monitor_systemEvent = "System Event";
  this.monitor_systemEvent1 = "System";
  ...
  this.monitor_vehicle_alarm = "Alarm";
  ...
  this.monitor_noDataTOExport =
    "There is no data, you can not export the report!";
  ...
  this.monitor_messageMoreThan =
    "(Not more than 240 characters,And cannot contain special characters  @#,|?<>\"':*\\/$%^&*)";
  ...
  this.monitor_GPS_reporting_interval_settings =
    "GPS Reporting Interval Settings";
  ...
  this.monitor_control_tip =
    "Please re-enter user name and password before Issue control instruction";
  this.monitor_reporting_interval = "Reporting Interval";
  this.monitor_reporting_interval_timeError =
    "Interval Time Range Between 0-3600, Please Re-enter!";
  this.monitor_reporting_interval_time_tip =
    "(0-3600 seconds,0 means not upload GPS)";
  this.monitor_reporting_interval_tip =
    "Set GPS reporting interval of {repSecond} seconds";
  this.monitor_task_status_label = "Task Status:";
  this.monitor_alarm_handle = "Handle";
  this.monitor_handle_content_errorMessage =
    "Handle content length can not exceed 240 characters!";
  ...
  this.monitor_remark_errorMessage =
    "Remark length can not exceed 240 characters!";
  ...
  this.monitor_select_line =
    "Please select the line in the bottom of the inside line to monitor";
  ...
  this.provincial_id = "Provincial ID";
  ...
  this.param_urgentAlarmInterval_error =
    "Emergency alarm reporting interval can not be empty! And greater than 0!";
  this.param_defaultInterval_error =
    "The default interval can not be empty! And greater than 0!";
  this.param_notLoggedInterval_error =
    "Driver logged in reporting interval can not be empty! And greater than 0!";
  this.param_sleepDistance_error =
    "Reporting from the interval can not be empty when hibernation! And greater than 0!";
  this.param_urgentAlarmDistance_error =
    "Reporting from the interval can not be empty when the emergency alarm! And greater than 0!";
  this.param_defaultDistance_error =
    "The default distance interval can not be empty! And greater than 0!";
  this.param_notLoggedDistance_error =
    "Distance interval logged in to report the driver can not be empty! And greater than 0!";
  ...
  this.autoPopImage =
    "After the successful capture, automatic bomb box displays";
  ...
  this.capture_capturing_stop =
    "The channel is to capture, make further capture later!";
  ...
  this.talkback_selectVehicle =
    "Please select online vehicle, right-click menu to open the intercom";
  this.listen_selectVehicle =
    "Please select online vehicle, right-click menu to open listening";
  this.device_nosupport = "Device does not support this feature";
  this.talkback_openMic = "Please turn FLASH plug microphone";
  this.talkback_flashMicStep1 =
    "1. select Settings in the video window on the right-click menu";
  this.talkback_flashMicStep2 =
    "The second step in the Settings window select 'Allow' and check the 'Remember'";
  this.talkback_flashMicStep3 = "Close the settings and restart the intercom";
  this.talkback_noMic =
    "There is no microphone on your computer, you can not start speaking";
  ...
  this.track_select_vehicle_num_error =
    "Too many vehicles selected, intercept the first 16 impressions!";
  ...
  this.rule_overspeed = "Overspeed alarm violation";
  this.rule_night_overspeed = "Night speeding alarm violation";
  this.rule_fatigue_single = "Fatigue driving alarm violation (single driving)";
  ...
  this.rule_overspeed_span = "Overspeed alarm violation";
  this.rule_night_overspeed_span = "Night speeding alarm violation";
  this.rule_fatigue_single_span =
    "Fatigue driving alarm violation (single driving)";
  ...
  this.rule_messageContentTip =
    "SMS content: Terminal + Time + Alarm description";
  this.rule_mailContentTip =
    "Email content: Terminal + Time + Alarm description";
  this.rule_phoneFillTip =
    "Please fill in the correct phone number, if multiple use; separation";
  this.rule_mailFillTip =
    "Please fill in the correct e-mail address, if more than one use; separation";
  this.rule_assignRuleTip =
    "Double-click the left of company or the left of vehicle, the rules appear to the right, select rules,and then click save settings, rules can only be assigned to the  vehicle in company.";
  this.rule_sendTtsTimeTip = "s（60-86399）";

  this.rule_fatigueDurationTimeOverMax =
  ...
  this.rule_minSpeedNotThanMax =
    "Minimum speed can not exceed the maximum speed!";
  this.rule_startNotThanEnd =
    "Starting position number can not be greater than the end position number!";
  this.rule_offsetWidthNotNull = "Offset width can not be empty!";
  this.rule_offsetWidthNotInScope =
    "Offset width is not within the scope of the set!";
  this.rule_parkTimeNotNull = "Parking time can not be empty!";
  this.rule_parkTimeNotInScope =
    "Parking time is not within the scope of the set!";
  this.rule_startTimeNotThanEnd =
  ...
  this.rule_videoTimeNotThan =
    "Video time can not be greater than 1800 seconds!";
  ...
  this.rule_captureTimeNotInScope =
    "Capture interval is not within the scope of the set!";
  ...
  this.label_tipStorage =
    "Tip: the system administrator in the server management serverin the storage inside the terminal association, associated with the need forregular recording equipment, the device can be configured storage plan ";
  this.label_tipWifi =
    "Tip: The system administrator configuresthe download site and the download server in the server administration to take effect.";
  ...
  this.rule_type_tip = "Type:";
  this.rule_image_format_error =
    "Please select a file of gif, jpg, bmp, png, JPEG and other formats";
  this.rule_image_size_error = "File size can not exceed 10M";
  this.rule_addTip =
    "Rules for use: 1. Add rules 2. Set the rules of the custom conditions 3. Vehicle authorization to the rules 4. If the rule matches all vehicles, the assigned vehicle will not be judged by the rule";
  ...
  this.server_stationTip =
    "SSID name to distinguish the download site, you must ensure that the ssid name of the uniqueness of the site";
  this.server_stationTip1 =
    "Single download site, and can support multiple ssid, please use the name; separated, for example: ssid1; ssid2";
  this.server_selectStationTip = "Select a download site";
  this.server_downStationNullTip =
    "Download site does not exist, add the download site after the operation!";
  ...
  this.server_stoRelationTip =
    "Tip: Please configure the storage associated first";
  ...
  this.server_tipServerAddress2 =
    "Usually, address 1 and 2 and 3 will be consistent!";
  ...
  this.deviceTip =
    "Tip: sub-account management query device can not be associated with sim";
  ...
  this.website_download_gViewerGoogle = "Google Map(Authorized)";
  this.website_download_now = "Download";
  this.website_title1 =
    "Intelligent Transportation  Ministry Of Standard Platforms";
  ...
  this.function_position_location_info =
    "Realize the vehicle positioning function, the map shows that the location of the vehicle, vehicle information will be displayed on the map, and so on.";
  this.function_video_surveillance = "3G / 4G Video Surveillance";
  this.function_video_surveillance_info =
    "<p> Through 3G or 4G wireless networks, through PC and mobile real-time view video. </p>.";
  this.function_download_storage = "Download Video Storage";
  this.function_download_storage_info =
    "<p> Through the PC client remote view videos, and download the video to local </p>";
  this.function_image_capture = "Image Capture";
  this.function_image_capture_info =
    "Design the plan of video capture,through the front camera timing snapping pictures and save to the storage server, saving the traffic. ";
  this.function_track_playback = "Vehicle Track Playback";
  this.function_track_playback_info =
    "Play back the history of the vehicle trajectory, the user of vehicle driving process be clear at a glance.";
  this.function_voice_intercom = "Talkback";
  this.function_voice_intercom_info =
    "Realizes the vehicles and vehicles, vehicles and the monitoring center, or vehicles and centre group  talkback.";
  this.function_platforms = "Ministry of Transportation Standard Platform";
  this.function_platforms_info =
    "CMSV6 standard platform for the Ministry of Transportation Ministry,in line with JT / T 808, JT / T 809 Ministry of standard";
  this.function_phone =
    "Fun phone, anytime, anywhere viewing position and the video screen";
  this.function_phone_info =
    "Vehicle location positioning, real-time video viewing, support Android system and IOS System";
  this.function_statistical_reports = "Rich Reporting Statistics";
  this.function_statistical_reports_info =
    "Alarm types: emergency button alarm, no video signal alarm, illegal door alarm, hard disk error alarm, speed / low alarm, motion detection alarm, parking too long alarm, temperature alarm, GPS signals loss alarm ...... ";
  this.function_information_management = "Information Management Philosophy";
  this.function_information_management_info =
    "Adhering to the information management platform design, implement user, vehicles, device, advertising and other information management ......";
  ...
  this.alarm_type_mainPowerFailure = "Main Ower Failure";
  ...
  this.alarm_type_fatigue = "Fatigue Driving";
  ...
  this.alarm_type_cumulativeDayDrivingTimeout =
    "Day Cumulative Driving Timed Out";
  ...
  this.alarm_type_InadequateOrTooLongRoadTravelTime =
    "Roads and The Lack of Time or Too Long";
  ...
  this.alarm_type_areaPoint_platform =
    "The Key Point Monitoring Alarm(Platform)";
  ...
  this.alarm_type_gps_signal_loss = "GPS Signal Loss";
  this.alarm_type_userDefine = "User Defined Alarm";
  ...
  this.alarm_door_abnormal_1 =
    "Vehicle to the station without stopping, open the door";
  this.alarm_door_abnormal_2 =
    "Vehicle left the station, the door is not closed";
  ...
  this.special_alarm_type_video_to_storage_threshold =
    "Special Alarm Video To The Storage Threshold Alarm";
  ...
  this.errDeviceLimitErr =
    "Shall't exceed the number of the system can manage!"; //RET_DEVICE_LIMIT_ERR = 13;
  this.errDeviceBatchIdnoErr =
    "Latter three of IDNO. must be number, and increments to maintain effective!"; //RET_DEVICE_BATCH_IDNO_ERR = 14;
  ...
  this.errRoleHasUsed =
    "Also use the information on this role! Can not be deleted!"; //RET_ROLE_HAS_USER = 23;   //还有用户使用此角色信息！无法删除！
  ...
  this.errGroupNoExist = "fleet does not exist!"; //RET_GROUP_NO_EXIST = 26;  //车辆分组不存在
  this.errGroupHasUsed =
    "The fleet information is still being occupied (there are still sub-fleet or vehicles under the fleet)!"; //RET_GROUP_HAS_USED = 27;  //车辆分组信息还在被占用（还存储子分组或者下级车辆）
  ...
  this.errDownStationUsed =
    "The download site is still occupied (with download server information)"; //RET_DOWN_STATION_USED = 32;    //下载站点还被使用（拥有下载服务器信息）
  ...
  this.errCompanyHasCompany =
    "The company has other information! Can not be deleted!"; //RET_COMPANY_HAS_COMPANY = 45;    //公司还有子公司信息！无法删除！
  ...
  this.errDeviceIdnoExists = "Device number or vehicle number already exists!"; //RET_SIMCARD_EXIST = 39;  //设备号已存在
  this.errVehiTeamNotMove =
    "Motorcade can not be moved to the parent company,  can move to the subsidiaries of company and the motorcade of company"; //RET_VEHITEAM_NOT_MOVE = 50; //车队不能移动到父公司
  ...
  this.errMoreThanTheVehiSeats =
    "Beyond the vehicle can accommodate the number of students"; //RET_STUDENT_NUM= 74;   //超出车辆所能容纳学生数
  ...
  this.errRegionTopExist = "A top-level administrative area already exists!"; // RET_REGION_TOP_EXIST = 97; //已存在顶级行政区域
  this.errSimInstalled = "Sim has been installed, can not be deleted!"; // RET_INSTALLED = 113; //sim卡已安装

  this.errCompanyNotExists =
    "Has no corresponding value in the list of company!";
  ...
  this.errValueNotExists =
    "No value of the input box in the listbox, please reselect!";
  this.errValueContainSpace = "Contains a space, please re-enter!";
  this.errDownloadTaskExists = "Download task already exists!";
  this.errorDeviceNoResponse =
    "The device does not receive feedback information";
  ...
  this.WeChatSecurityReportPushTimeSetting =
    "WeChat Security Report Push Time Setting";
  ...
  this.Fatigue_driving_warning_difference =
    "Fatigue Driving Warning Difference";
  this.secondary_server_setting = "Secondary Server Settings";
  this.Camera_black_screen_alarm = "Camera Black Screen(Platform)";
  ...
  this.creation_time = "Creation Time";
  ...
  this.isProceedLoad =
    "{number} data has been loaded, whether to continue loading?";
  ...
  this.mapGoogle = "Google Map(Authorized)";
  ...
  this.vehicle_alarmaction_spanTipSmsContent =
    "If the content is empty, the content of the message: terminal + time + alarm description";
  ...
  this.vehicle_alarmaction_spanTipEmailContent =
    "If the content is empty, the content of the E-mail: terminal + time + alarm description";
  this.vehicle_alarmaction_spanTipTime =
    "During this time period before the implementation of the linkage";
  this.vehicle_alarmaction_smsAddressEmpty = "Mobile must not be empty!";
  this.vehicle_alarmaction_smsAddressUnvalid =
    "Mobile wrong! Must be digital, use ; separated!";
  this.vehicle_alarmaction_emailAddressEmpty =
    "The E-mail address not be empty!";
  ...
  this.vehicle_alarmaction_recordingTimeError =
    "Recording time range between 30-1800, please re-enter!";
  ...
  this.vehicle_alarmaction_alarmSubTypeTip =
    "Use , separated!,only custom alarm can be set,Each sub-type can not be configured separately";
  this.vehicle_alarmaction_alarmSubTypeEmpty =
    "Custom alarm sub-type can not be empty!";
  this.vehicle_alarmaction_alarmSubTypeUnvalid =
    "Custom alarm sub-type wrong! Must be digital, use , separated!";
  ...
  this.vehicle_alarmaction_timeunvalid =
    "Start time is not greater than the end time!";
  this.vehicle_alarmaction_captureChnunvalid =
    "Please check the capture channel!";
  this.vehicle_alarmaction_recordChnunvalid = "Please check the video channel!";
  this.vehicle_alarmaction_noSelVehiGlobal =
    "If not selected vehicle, the global settings, the global settings parameters are valid for all vehicles. If the vehicle has been linked settings, global settings parameters do not work for this car.";
  ...
  this.vehicle_alarmaction_selAudioTip =
    "Upload mp3 format only supports, within two seconds, the alarm sound is too long it will affect prompt effect.";
  this.vehicle_alarmaction_fileNameNotNull = "File name can not be empty!";
  this.vehicle_alarmaction_fileNameNotMoreThan =
    "File name can not be more than 40 characters!";
  this.vehicle_alarmaction_fileDescNotMoreThan =
    "File description is not more than 240 characters!";
  ...
  this.vehicle_alarmaction_audioFileNameTip =
    "(File name does not contain a suffix, no more than 40 characters)";
  ...
  this.vehicle_alarmaction_previewTimeError =
    "Preview Time Range Between 30-1800, Please Re-enter!";
  this.vehicle_alarmaction_previewChnunvalid =
    "Please check the Preview channel!";
  ...
  this.vehicle_alarmaction_alarmCenterTip =
    "Vehicle centered when alarm coming";
  this.vehicle_alarmaction_previewTimeTip =
    "If it is 0, then stop when the alarm preview ends.";
  this.vehicle_alarmaction_notHaveChinese =
    "File names can not have Chinese characters!";
  ...
  this.downloadTaskTip =
    "If the selected time within the default time range is segmented downloading; otherwise, it is to download the entire file.";
  ...
  this.upgrade_tip =
    "Tip: If the device is online, it will be upgraded in time, if not online, when you upgrade the device line";
  this.upload_tip =
    "Tip: If the device is online, it will be uploaded in time, if not online, when you upload the device line";
  this.photo_format = "Please select Jpg / Png / Bmp format file!";
  this.photo_type = "Image Type";
  this.config_file = "Config File";
  this.browser_tip =
    "The System only supports ie8 more than one browser!360 browser compatibility mode is not supported!";
  this.browser_tip_txt_1 =
    "Ah, your browser version is too old, the real-time monitoring page no longer supports access...";
  this.browser_tip_txt_2 = "Other pages can be accessed normally";
  this.browser_tip_txt_3 =
    "The following browsers can access the real-time monitoring page normally：";
  ...
  this.flowOverLimitTip =
    "Flow limit is not allowed to operate the video preview and other large amounts of data media business";
  ...
  this.flowErrorMonthLimit =
    "Monthly limit between 0-1024000! Please re-enter!";
  this.flowErrorDayLimit = "daily limit between 0-1024000! Please re-enter!";
  this.flowDeviceUpperLimit =
    "devices have reached the maximum flow, can not be operated!";
  this.excel_tip =
    "When a query is longer than three hours, without location resolution, to export only the latitude and longitude";
  this.flowConfigNoExist =
    "Please save the current vehicle traffic configuration first.";
  ...
  this.Taxi_phone_Summer_Report = "Phone Order Summary RPT";
  ...
  this.report_statistics_total_scale =
    "Driving Behavior Statistics (Scale Drawing)";
  this.report_proportion = "The Proportion";
  this.report_summary_graph = "Summary Graph";
  this.report_rank_figure = "Rank Figure";
  this.organization_analysis_chart =
    "Company Alarm Number Ranking Analysis Chart";
  this.before = "Before";
  ...
  this.vehicle_month_analysis_chart =
    "Vehicle-Month Trip Times Ranking Analysis Chart";
  this.vehicle_month_violation =
    "Vehicle Month Trip Times Ranking Analysis Chart";
  this.ranking_month_vehicle = "Vehicle Month Trip Times Ranking";
  this.vehicle_daily_analysis_chart =
    "Vehicle-Day Trip Times Ranking Analysis Chart";
  this.vehicle_daily_violation =
    "Vehicle Day Trip Times Ranking Analysis Chart";
  ...
  this.driver_daily_analysis_chart =
    "Driver-Day Trip Times Ranking Analysis Chart";
  ...
  this.monitor_searchDriverOrVehicleNo =
    "Please enter driver's name/binding license plate number";
  ...
  this.delete_before_company =
    "(Need to first remove the vehicle under the company, the team, role, device, sim card, driver, IC Card, Project filing, Rule information)";
  this.delete_before_region =
    "(The sub-area, company, and regulatory platform user information under the administrative area must be deleted first.)";
  ...
  this.tire_pressure_monitoring_detail =
    "Tire Pressure Monitoring Excessive Detail";
  ...
  this.vehicle_transport_analysis_chart =
    "Transport Vehicles Month Ranking Analysis Chart";
  this.vehicle_transport_violation =
    "Transport Vehicles Month Ranking Analysis Chart";
  this.ranking_transport_vehicle = "Vehicle Transport Month Ranking";
  this.vehicle_transport_daily_analysis_chart =
    "Transport Vehicles Daily Analysis Chart Rankings";
  this.vehicle_transport_daily_violation =
    "Transport Vehicles Daily Analysis Chart Rankings";
  ...
  this.multimap_otherVehicle =
    "Map already exists in the monitoring, please choose another vehicle!";
  ...
  this.xc_infoeasytoget =
    "Student attendance information WeChat notification, video real-time monitoring vehicle location";
  ...
  this.object_importSuccess =
    "Effective data has been successfully imported! If you can not query to the data, please check your Excel data is valid!";
  ...
  this.passwordcheck =
    "Password length of at 8 - 12, Must contain numbers, uppercase and lowercase letters";
  ...
  this.departmentInfo = "Company INFO";
  this.policeIdno = "Number Of Police Officers";
  this.policeAll = "All Police";
  this.departmentAll = "All Company";
  this.delPoliceTip =
    "Whether the selection of police information corresponding to the equipment information deleted?";
  this.selectDepartment = "Select Company";
  this.selectDepartmentTip =
    "There is no corresponding value in the Company list.";
  ...
  this.searchDepartment = "Search Company";
  this.belongPolice = "Police Officer";
  this.selectDepTip = "Please Select Company";
  this.tipdeletepolicedev = "Whether to delete the corresponding device?";
  this.police_user_importFailed =
    "Excel memory in invalid data, please check the data after re import!";
  ...
  this.startBgLastEndtips =
    "The start position index of the current rule must be higher than the end of the last rule";
  this.selectStartAndEnd = "Please select the line start or end position";
  this.endBgStart =
    "The end position index of the current rule must be higher than the start position index";
  this.eidtRuleBefore =
    "At the beginning of the current rule, the index and the end position index must be in the(";
  this.eidtRuleAfter = ")";
  this.radiusTips = "Radius range 50-999m";
  this.radiusNullTips = "Radius cannot be empty";
  this.speedMinAndMaxTips =
    "The minimum speed cannot be greater than the maximum speed";
  ...
  this.changeLineTips =
    "Are you sure you want to switch the line? (The speed limit will be emptied after switching)";
  this.ruleNeedTips = "At least one of the speed limit rules";
  this.timeStartNotEqEnt = "Start time and end time can't be the same";
  this.inputError =
    "Vehicle approved load format error (Please enter an integer or decimal)";
  this.singleLogin = "Single Sign On";
  this.checkPositionUse =
    "Please check if you are currently setting up a section of the road to be occupied by other sections of the situation";
  this.smNextStarttips =
    "At the end of the current line must not be greater than the next index start position";
  this.bgLastEndtips =
    "At the beginning of the current line must not be less than the end of the previous index";
  this.deleteDepartmentBefore =
    "(Need to be the first Company of police officers, users, roles, Rules,equipment information deleted)";
  this.existchildCompany =
    "The current company can not modify the superior company";
  ...
  this.policelstError =
    "The Company / The Police Number / Equipment Number  can not be empty ";
  this.policeDepartmentTips =
    "(The current company has not been created, please first create the Company to import)";
  this.deviceExist = "(Tip: The device already exists)";
  this.policeExist = "(Tip: Police number already exists)";
  this.notNullTips =
    "Requirements: Account only, The company and Role Permissions can not be empty! Role permissions can only belong to an company.Password is strong password";
  this.roleErrorTips =
    "A role can only belong to an company, please check whether the role is occupied by other company. )";
  ...
  this.userImportCompanyError =
    "All the company within the current excel have not been created yet!";
  this.userImportErrorAfter =
    "The company has not yet created. Please create the company, and then import operation";
  ...
  this.policeVideoManage1 = "Police";
  ...
  this.videoSearchTips =
    "If you need a video query operation - please go to the video playback module to view";
  ...
  this.deviceNumLimt =
    "The number of fences corresponding to each device shall not exceed 8";
  this.doDelSelBefore = "Please select the data you want to delete";
  this.addSingle = "Please add a single add operation";
  this.deviceCurNum =
    "The number of fences corresponding to each device shall not exceed 8,number of fences in the current device: ";
  ...
  this.changeMapTips =
    "Switching map will restore initial information. Please confirm whether or not to switch";

  this.excelCellTypeError = "Tips: Excel cells use text mode。";
  this.policeIdnoSameError =
    "Police officer number repeat。Tips: The same police number cannot be found in Excel。";
  ...
  this.devIdNOSameError =
    "Device number IMEI repeat。Tips: The same device number cannot exist in Excel。";
  this.devIdNONotExistError =
    "The device number is required. Tip: At least one device is bound to Excel.";
  ...
  this.server_tip =
    "Tip: Use when the server is deployed on the same physical server";
  ...
  this.server_tips =
    "Local IP configuration may be incorrect, the LAN IP in the database can not be found in the current server LAN IP list. Please select the local area network IP available in the current server";
  this.server_tips1 = "Please get the current server IP first";
  this.server_tips2 = "Get the public network ip failure";
  this.server_tips3 =
    "Please check the database above the external network IP and the current server outside the network IP re-configure the server IP";
  ...
  this.wifi_configure_chooseDownloadServerAndStation =
    "Select download station / server";
  ...
  this.wifi_configure_deviceStationSameSsid =
    "Device to connect to the SSID and site SSID matching state";
  this.wifi_configure_downloadServerIpStatus =
    "Download server LAN IP configuration status";
  this.wifi_configure_deviceWifiDownload =
    "Device configuration WiFi download task";
  this.wifi_configure_deviceStationSameLan =
    "The device and the download site are in the same LAN";

  this.wifi_configure_nowWifiRight =
    "Currently in the Wifi connection state, the Wifi connection is normal.";
  ...
  this.wifi_configure_deviceStationSsidRight =
    "The device is connected to the SSID and the site of the SSID matches both";
  this.wifi_configure_deviceStationSsidWrong =
    "Device connected to the SSID and the site's SSID does not match the device's SSID is";
  this.wifi_configure_stationSsidIs = "Site SSID is";
  this.wifi_configure_downloadServerLanIpRight =
    "Download the server LAN IP match correctly,Ip is";
  this.wifi_configure_downloadServerLanIpWrongOld =
    "Download the server's local area network IP matching error";
  this.wifi_configure_downloadServerLanIpWrong =
    "Download the server's local area network IP matching error, LAN Ip: ";
  this.wifi_configure_downloadServerIpIs = ",Download server Ip for: ";
  this.wifi_configure_selectedDeviceRuleRight =
    "The selected device has been authorized to download the WiFi rules";
  this.wifi_configure_selectedDeviceRuleWrong =
    "The selected device is not authorized to download the WiFi rules";
  this.wifi_configure_deviceStationSameLanRight =
    "Device and download site is in a local area network";
  this.wifi_configure_deviceStationSameLanWrong =
    "Device and download sites are not in a local area network";
  ...
  this.modifyPassword = "Disable Password Change";

  this.modifyTime = "Update Time";
  this.tipDailyReport =
    "Data statistics the next day, today's data is recommended to use the next day query(data more accurate)";
  ...
  this.driver_drives_through_the_schedule =
    "Drvier Drives Through The Schedule";
  ...
  this.channelTypeDisabled =
    "The current channel device type does not have the camera function";
  ...
  this.curDepartmentDevTips =
    "No individual soldier equipment can be added to the current company";
  this.noDepartmentDevTips =
    "The current company can only increase individual equipment";
  ...
  this.chnChangeConfirm =
    "Please make sure that the number of device channels is set to zero";
  ...
  this.vehicle_info_plateType_null_error =
    "Vehicle Plate Color Can Not Be Empty";
  ...
  this.errorValidServer =
    "The number of device registration does not match, please check the number of equipment exceeds the number of registration!";
  this.errorValidServerEx =
    "The number of device registration does not match, please check the number of equipment exceeds the number of registration!5 minutes after the automatic exit!";
  this.tipMapSave = "Default Location";
  this.setMapCenterTip =
    "Is the current map location set to the map location after landing?";
  ...
  // 2017年7月10日14:42:22
  this.department_management = "Company Structure";
  this.departmentuser_management = "Department Management";
  ...
  this.department_drag_tip =
    "You can use drag to move the department, and the company's subordinate departments can move each other;";
  this.department_move_tip =
    "Click on the company to refresh the unassigned personnel; click on the department to refresh the assigned personnel; the personnel must be removed from the department before they can be assigned to other departments; personnel can only be assigned to the departments under their company;";
  ...
  this.all_department = "All Company";
  this.higher_department = "Higher Company:";
  this.department_selectGroupNode =
    "Please select a company or department node!";
  this.department_editNotCompanyNode =
    "Cannot modify company information, please select department node!";
  this.department_selectTeamNode = "Please select a department node!";
  this.department_groupHasChild =
    "There are still child departments in this department and cannot be deleted!";
  ...
  this.department_have_people =
    "There are also assigned people under the department";
  this.department_name_exist = "Department name already exists";
  this.wayBill = "Electronic Way Bill";
  this.waybill_user_car = "Car Application";
  this.waybill_examine = "Approval Management";
  ...
  this.please_choose_department =
    "Please select a department or department sub-node!";

  this.approval_null_error = "The approval type cannot be empty!";
  this.sure_delete_this_approval_type =
    "You are sure to delete this approval type. The deletion cannot be revoked!";
  this.sure_push_all_info =
    "Do you want to push all process information under this approval type?";
  this.sure_cancel_push_all_info =
    "Do you want to cancel pushing all process information under this approval type?";
  this.push_info = "Push Approval Information";

  this.approval_flow_management = "Approval Process";
  ...
  this.process_tip_drag =
    "First select the department in the department list, load the approval type, then select the approval type, and load the user and user list in the approval process;";
  this.process_tip_move =
    "The approval type can be moved up and down; each approval type corresponds to an approval process; users in the same department can be assigned to different approval processes; deleting an approval type will delete the corresponding approval process.";
  ...
  this.companyIdno =
    "Application Form Number/User/Car Unit/License Plate Number";
  ...
  this.companyIdnoUseCar =
    "Application Form Number/Approval Code/User/Car Unit";
  ...
  this.confirm_dele_requisition =
    "Please confirm to delete this car application form!";
  this.approved_final = "Approval has been completed";
  this.examine_mydriver =
    "Application Form Number/Approval Code/Application Type/Applicant";
  ...
  this.allotcar_serchIdno =
    "License plate number/approval code/dispatcher/driver/user/dispatch number/unit name";
  this.create_dispatch = "Create a new dispatch order";
  this.driver_type_selection = "Driver Type Selection";
  this.not_dispatching_application =
    "Application form for not dispatching a car";
  ...
  this.select_department_sub_department =
    "Please select the user's department or sub-department";
  ...
  this.waybilltype_tip_1 =
    "Single selection can only select one driver/vehicle, and the application ticket number can only select the ticket number that has not uploaded the file.";
  this.waybilltype_tip_2 =
    "Multiple selection allows multiple drivers/vehicles to be selected, and the application number can only be the number of the uploaded file.";
  ...
  this.abnormalPosition_Tip =
    "Intervals:{second} seconds, Separation distance:{distance} m";
  ...
  this.number_of_downloads_simultaneously =
    "Number Of Downloads Simultaneously：";
  ...
  this.day_number_limit =
    "Ordinary video retention time (15-730) days, alarm video retention time (183-730) days";
  ...
  this.copyFailedMess =
    " failed to copy(The number of device registration does not match)";
  this.errorEditDeviceType =
    "There are two devices in the vehicle, can not modify the device type!";
  ...
  this.dispatch_accountTip =
    "Tip: the scheduling terminal login client after the coordination of scheduling functions. Scheduling terminals need to take up the number of video devices.";
  ...
  this.dispatcher_company = "Subordinate Company";
  ...
  this.default_group_tips =
    "The default group is set as the current group will clear before the group is located";
  this.dispatcher_report = "Report Management";
  this.dispatcher_logReport = "Cooperative Schedule Log RPT";
  ...
  this.dispatch_user_error =
    "There is an exception to the dispatcher account operation database (check device, vehicle association table, current account number)";
  ...
  this.selecttime_limit =
    "The period of validity shall not be lower than the current time!";
  ...
  this.vedio_undefined =
    "The video plug-in is not opened (allowing the site to run Flash)";
  ...
  this.notNullInfos =
    "(prompt: name does not repeat, can not be empty, cell style is text)";
  this.nameExLine =
    "(prompt: the name is repeated. Please check the name of the Excel to change the duplicate.)";
  this.mapMarkLimit =
    "(hint: Map markup can only enter a value in [1,2,3,4,10]. \r\n map type can only be input (3：Baidu 4：Autonavi 7：Baidu Offline 8：Google Offline  9：bing  10：OSM 11：Google 12：Mapbar 18: TianDi Map) \r\n note: confirm form text format.";
  this.longitudeLimit = "(hint: longitude range [-180180].";
  this.latitudeLimit = "(hint: latitudes range [-90,90].";
  this.imageLimit =
    "(hint: the format of the image is not correct. Reference style: upload/area/xxx.png or upload/area/xxx.JPG XXX corresponds to the background name.";
  this.shareLimit =
    "(hint: the sharing table can only enter one of the values in the [0,1,2])";
  this.mapTypeLimit =
    "(hint: the map type can only enter one of the values in [0,3])";
  this.mapColorLimit =
    "(hint: the color table can only enter the sixteen - band color code. For example: FF0000)";
  this.radioScopeLimit =
    "(prompt: when the current map markup type is a circular area, the radius must be a valid number (positive integer). )";
  this.mapNameExist = "(hint: the name has already existed. )";
  this.companyNotExist =
    "(prompt: the company has not been created, please first Create Company to import. )";
  this.childCompanyNotBelong =
    "(hint: the company is not a subsidiary of the current login account for the company or the corresponding company. )";
  this.companyAllNotExist =
    "All departments in Excel have not been created yet, please create the import first.";
  this.excelTypeError =
    "Error in cell format! Please check that all cells in Excel are text types.";
  ...
  //adas安全辅助驾驶汇总表
  this.report_adas_evidence_summary_vehisort =
    "Analysis Chart Of The Ranking Of The Number Of Vehicle Alarm";
  this.report_adas_evidence_summary_driver =
    "Analysis Chart Of The Ranking Of The Number Of Driver Alarm";
  ...
  this.report_adas_evidence_summary_alarmtimes =
    "Number of alarm times (Times)";
  ...
  this.group_type_new = "Temporary Group";
  this.group_type_tip =
    "Hint: the default group can not modify and delete related operations";
  ...
  this.unproven_driving = "Unplugged Card";
  ...
  this.dispatcher_disabled_login =
    "The current version does not support scheduling user login";
  ...
  this.report_integrity_rate_detail_traceerror = "Discontinuous Course";
  this.face_fatigue = "Facial Fatigue";
  this.nocturnal_overspeed = "Nocturnal Overspeed";
  this.nocturnal_prohibition = "Early Morning Operation";
  ...
  this.zfpt_table_user_contact = "Contact Details";
  ...
  this.report_haiju_company_vehicle_unline = "Non Online Vehicle";
  ...
  this.subiao_driverGradeArmSummary = "Driver Rating RPT";
  ...
  this.net_alarm_type_sb_l1_hit_pedestrian =
    "Pedestrian Collision Alarm Level One";
  this.net_alarm_type_sb_l2_hit_pedestrian =
    "Pedestrian Collision Alarm Level Two";
  this.net_alarm_type_sb_l1_frequent_lane_change =
    "Frequent Lane Change Level One";
  this.net_alarm_type_sb_l2_frequent_lane_change =
    "Frequent Lane Change Level Two";
  this.net_alarm_type_sb_l1_road_marking_over_limit =
    "Road Sign Overrun Alarm Level One";
  this.net_alarm_type_sb_l2_road_marking_over_limit =
    "Road Sign Overrun Alarm Level Two";
  ...
  this.dev_model_info_version_tip =
    "The target version number can not be empty!";
  ...
  this.driver_recognise_ok_tip =
    "The degree of successful acquaintance cannot be empty!";
  this.driver_recognise_fail_tip = "The degree of failure can not be empty!";
  this.driver_recognise_fail_range =
    "The degree of failure should not be higher than the degree of successful acquaintance!";
  ...
  this.net_alarm_type_sb_driver_identification_through =
    "Identification Success";
  this.net_alarm_type_sb_driver_identification_unknown = "Unrecognized";
  this.net_alarm_type_sb_driver_identification_notThrough =
    "Identification Failure";
  this.net_alarm_type_sb_driver_identification_notCompare =
    "Comparison Failure";
  this.net_alarm_type_sb_driver_identification_ratio = "Contrast:";
  this.net_alarm_type_sb_driver_identification_fail =
    "Default failure matching degree:";
  this.net_alarm_type_sb_driver_identification_success =
    "Default success matching degree:";
  ...
  this.fileStorageDeleted =
    "The Corresponding File Of The Storage Server Has Been Deleted";

  this.hideShowColumns = "Hide/Show Columns";

  // map key configuration
  this.keyConfig_browser_baidukey = "Baidu Map Key Configuration";
  this.keyConfig_browser_googlekey =
    "Google Maps Browser Side Map Key Configuration";
  this.keyConfig_browser_gaodekey = "Autonavi map key configuration";
  this.keyConfig_server_baidukey =
    "Baidu map server-side map key configuration";
  this.keyConfig_server_googlekey =
    "Google Maps Server Side Map Key Configuration";
  ...
  this.version_tips =
    "Version Number,Version Name (Note: English comma separated)";
  ...
  this.repairSave =
    "The Selected Vehicle Already Has A Maintenance Record aAnd Will Continue To Be Saved？";
  ...
  this.mysql_create_index_tip =
    "When the server version is updated to 7.13.0.1_0921 and later, perform update alarm table index operation to improve report query efficiency";
  ...
  this.mysql_data_tips =
    "When the server version is updated to 7.13.0.1_0921 and later, perform the update migration media information operation to improve the report query efficiency";
  ...
  this.inspectTips =
    '(Hint: The Content Is Less Than 128 Character And Cannot Contain Characters."|")';
  this.inspectTipsEx =
    '(Hint: The Content Is Less Than 256 Bytes And Cannot Contain Characters."|")';
  ...
  this.lowerPlatformSingleHouseholds =
    "Subordinate Platform Belongs To a Single Business";
  this.lowerPlatformAllHouseholds =
    "All The Subordinate Platforms Belong To All The Households";
  ...
  // ~ 无穹大报警督办
  this.handleMisinformation = "False positive";
  this.handleDriverFixTimely = "The driver corrects in time";
  this.handleReminderAndfix =
    "A reminder has been issued to correct the instruction. Then the alarm is released.";
  this.handleReminderAndReport =
    "A reminder has been issued to correct the instruction. Then report to the corporate safety management agency, and finally the alarm is released.";
  this.handleReminderAndReportPolice =
    "A reminder has been issued to correct the instruction. Then report to the safety management agency of the enterprise, and since it still does not correct, report to the traffic management department of the public security agency in time.";
  this.handleCustom = "customize";
  ...
  this.mysql_media_tips =
    "When the server version is updated to 7.13.0.1_0921 and later, the old media data cannot be queried. Please perform a data migration operation";
  this.mysql_adas_tips =
    "When the server version is updated to 7.13.0.1_0921 and later, some old ADAS alarm data cannot be queried. Please perform a data migration operation";
  ...
  this.password_simple =
    "The password strength is low and must contain a combination of uppercase and lowercase letters and numbers. Special characters cannot be used. The length is between 8-12.！";
  this.login_ret_password_relogin =
    "The password will be locked 5 times in a row, and there will be {} chances left";
  this.login_ret_password_waitlogin =
    "The current account is locked 30 minutes!";
  ...
  this.pageNonsupportIE8 =
    "This Page Does Not Support IE8, Please Upgrade Your Browser Or Replace Other Browsers!";
  this.safetyAdas = "Active Safety(ADAS)";
  ...
  this.function_config_complexCode =
    "Account Login Verification Complex Code Mask";
  ...
  this.car_add_error_tip =
    "Only video devices can set channels under dual devices";
  ...
  this.addedVideoDeviceTip =
    "Note: The Number Of Dispatching Can Be Used To Add Law Enforcement And PTT Terminals";
  this.incorrect_login_information = "Incorrect Login Information!";

  this.apiRetNetError = "Abnormal Network Connection";
  this.transportClassNotExistsError =
    "Transportation Industry Category Does Not Exist";
  this.transportClassNumberError =
    "Transport Industry Category Please Enter The Number";
  this.transportTypeNotExistsError = "Transport Vehicle Type Does Not Exist";
  this.transportTypeNumberError =
    "Please Enter The Number Of The Transport Vehicle Type";
  this.transportPlaceNotExistsError = "Car Ownership Does Not Exist";
  this.transportPlaceNumberError =
    "Please Enter The Number Of The Car Registration";
  ...
  this.operatingNumTextError =
    "Transport Certificate Number Text Format Error.";
  this.transportClassTextError =
    "Transportation Industry Category Text Format Error.";
  ...
  this.controlList = "Portrait Library";
  ...
  this.notExistControlPersonInfo =
    "There Is No Information About The Controller";
  ...
  this.position_abnormal_alarm =
    "Location Information Exception Alarm(platform)";
  ...
  this.filter_by_vehiIdno =
    "The company and the license plate number cannot be empty at the same time!";
  ...
  this.flash_error =
    "Flash loading exception：\r\r    1.Flash plugin not installed \r    2.The browser you are accessing disables flash \r\r\rConfirm the Flash plugin installation?";
  ...
  this.dev_offline_rule_tipes =
    "The camera and video functions configured in the device offline rule will be invalid. (Hint: the device is offline!)";
  ...
  this.vehicle_idno_identification = "License Plate Recognition";
  this.face_identification = "Face Recognition";

  this.markAreaNotNull = "Administrative Area Cannot Be Empty";
  this.policeNameTitle = "Name";
  this.digitalSurveillance = "Visualize Large Screen";
  ...
  this.net_alarm_tire_number = "Tire Number";
  ...
  this.configurationOhterSetting = "Parameter Settings";
  this.report_anaysis_number =
    "Single request to call API to resolve the maximum number of GPS (0 - no limit)";
  this.geographical_analysis = "Geographical Analysis";
  this.normal_user_limit =
    "Ordinary users are not authorized to view drivers of unauthorized vehicle companies!";
  this.alarm_name_644 = "Drinking Water Alarm";
  this.drive_recorder_speed = "Drive Recorder Speed:";
  this.keys_tips = "key1,key2(Tips: Multiple separated by commas)";

  this.vehicleTotalCount = "Total Vehicles";
  ...
  this.muck_open_status_none = "None";
  ...
  this.muck_truck_cover_alarm = "Area Illegal Opening (platform)";
  ...
  this.rocessing_report = "Processing RPT";
  this.rocessing_report_puls = "Batch Processing RPT";
  this.rocessing_report_status_label = "Report Status:";
  this.rocessing_report_tips =
    "Please select a valid alarm that needs to be processed!";
  ...
  this.rocessing_report_status_no = "Not reported";
  ...
  this.over_speed_last_time = "Overspeed Duration";
  ...
  this.concreteCar = "Concrete Car";
  this.excavator = "Excavator";
  this.constructionVehicle = "Construction Vehicle";

  this.travel = "Driving";
  this.overview = "Overview";
  this.total_number_of_vehicles = "Total Vehicles";
  ...
  this.face_recognition_success_686 =
    "Dynamic Checkpoint Recognition Success Popup";
  this.face_recognition_fail_686 = "Dynamic Checkpoint Recognition Fail Popup";
  this.face_recognition_success_646 =
    "Card Comparison Identification Success Popup";
  this.face_recognition_fail_646 = "Card Comparison Identification Fail Popup";
  this.face_recognition_success_647 =
    "Inspection Comparison Identification Success Popup";
  this.face_recognition_fail_647 =
    "Inspection Comparison Identification Fail Popup";
  this.face_recognition_success_648 =
    "Ignition Comparison Identification Success Popup";
  this.face_recognition_fail_648 =
    "Ignition Comparison Identification Fail Popup";
  ...
  this.ICReadResult1 =
    "Card Reading Failed Because The Card Key Authentication Failed";
  ...
  this.http_or_https = "Please use the full link at http:// or https://";
  this.deviceAddPatchTips =
    "The device number (The ast four digits), the start cannot be greater than the cutoff number";
  ...
  this.normal_user_move_team =
    "Unauthorized vehicles under the team, unable to move the fleet";
  this.dispatch_op_tips =
    "The web does not support the cluster intercom scheduling function temporarily<br/>Please use the PC client.";
  ...
  this.alarm_gravity_acceleration_threshold_tips =
    "Alarm Gravity Acceleration Threshold:";
  ...
  this.version_match_error =
    "This rule is an old version rule, please delete to re-create a new rule";
  ...
  this.driver_identification_event_platform =
    "Driver Identification Event (Platform)";
  this.dynamic_check_platform = "Dynamic Check (Platform)";
  this.driver_identification_event_platform_success =
    "Driver Identification Success (Platform)";
  this.driver_identification_event_platform_fail =
    "Driver Identity Abnormal (Platform)";
  ...
  this.intelligent_testing_evidence_center =
    "Intelligent Testing Evidence Center";
  ...
  this.active_security_alarm_customization =
    "Active Security Type Customization";
  ...
  this.drivingTips1 =
    "Driving Situation Is Very Stable, Continue To Refuel, Promotion And Salary Increase Is Just Around The Corner!";
  this.drivingTips2 =
    "Driving situation Needs To Be Improved, Roads Are Tens Of Millions, Safety Is The First!";
  this.drivingTips3 =
    "Driving situation Is Quite Tortuous, There Is Room For Improvement, Continue To Work Hard!";
  ...
  this.dailyAlarmCountAnalysis = "Daily Alarm Number Analysis";
  this.weeklyAlarmCountAnalysis = "Weekly Alarm Number Analysis";
  this.monthlyAlarmCountAnalysis = "Monthly Alarm Number Analysis";
  ...
  this.drivingWorkTime = "Driving Time";
  ...
  this.safetyRiskPortrait = "Active Security Risk Portrait";
  ...
  this.most = "Most";
  this.least = "Least";
  this.safeAlarm_performance_driver = "Driver Identification Evidence Inquiry";
  ...
  this.active_security_alarm_name_customization_partial =
    "Active Security Name Customization";
  this.current_alarm_name_tip =
    "Please select the name of the alarm you want to replace!";
  ...
  this.homeBox1Tips1 = "Data Analysis";
  this.homeBox1Tips2 =
    "Output Big Data Analysis, Output Security Reports, Big Data Big Value";
  ...
  this.homeBox3Tips2 =
    "Multi-Dimensional, Full-Process Security Management Through AI Intelligent System";
  ...
  this.driver_identity_information_base_configuration =
    "Driver Identity Information Base Configuration";
  this.driver_identification_event = "Driver Identification";
  this.card_comparison_identification_reporting_event =
    "Card Comparison Identification Reporting Event";
  this.patrol_comparison_identification_reporting_event =
    "Patrol Comparison Identification Reporting Event";
  this.ignition_ratio_identification_report_event =
    "Ignition Ratio Identification Report Event";
  this.leave_return_to_compare_the_identity_report_event =
    "Leave Return To Compare The Identity Report Event";
  ...
  this.driver_identification_event_connection_abnormality =
    "Connection Abnormality";
  this.driver_identification_event_no_specified_face =
    "No Specified Face Image";
  this.driver_identification_event_unmanned_face_library =
    "Unmanned Face Library";
  ...
  this.alarm_name_support_tips =
    "The current server does not support this alarm custom noun!";
  this.driver_down_response = "Driver Identity Database Data Download Response";
  ...
  this.identityCollectionRpt = "Identity Collection RPT";
  ...
  this.taxi_status_vehicle_limit =
    "Restricted Operations/Times Have Been Reached";
  ...
  this.taxi_alarm_clock_error =
    "The Real-Time Clock of The Metering Device Exceeds the Specified Error Range";
  this.taxi_alarm_emergency = "Emergency Alarm Button Failure";
  this.taxi_alarm_violation =
    "Cruise Car Does Not Operate On the Table / Network Car Tour With Passengers";
  ...
  this.simultaneouslyLoginNum = "Simultaneously Online Num";
  this.accountDelConfigTips =
    "This Configuration Needs To Check The Main Account To Add Police Officer Management.";
  ...
  this.layuiUploadTip1 =
    "Obtaining An Abnormal Response Message After Uploading";
  ...
  this.maxVehicleNumErrorCode1 =
    "The current number of added vehicles exceeds the company's limit";
  this.maxVehicleNumErrorCode2 =
    "The upper-level vehicle addition amount is full";
  this.maxVehicleNumErrorCode3 =
    "The added amount of lower-level vehicles is full";
  this.maxVehicleNumErrorCode4 =
    "The number of vehicles in the current company has exceeded the number of vehicles added";
  this.maxVehicleNumErrorCode5 =
    "The number of vehicles of the subordinate company has exceeded the number of vehicles added";
  this.maxVehicleNumErrorCode6 =
    "The limit number cannot exceed the authorized number";
  this.maxVehicleNumErrorCode8 =
    "The number of vehicle restrictions cannot be greater than the number of equipment of the superior company";
  this.maxVehicleNumErrorCode9 =
    "The number of vehicle restrictions cannot be less than the number of equipment of the lower-level company";
  this.maxVehicleNumErrorCode10 =
    "{}The number of management devices exceeds the limit, please contact the administrator";

  this.playbackDesc =
    'For h5 player, if isVodMode is configured as true when initializing, there can be a playback toolbar and drag operation can be performed. The h5 player can also support multi-channel synchronous playback startVodM(url, "0,1,2,3"), and the device needs to support multi-channel synchronous playback. The second parameter "0,1,2,3" Indicates the playback channel';
  ...
  this.flashTip3 =
    "Return 0 success, 1 means talking, 2 means no mic, 3 means mic is disabled";
  ...
  this.err_Dev_tran_msvr_empty =
    "Device media forwarding association information does not exist";
  ...
  this.err_dev_disk_full = "Insufficient hard disk space";
  this.err_dev_up_ver_same =
    "The upgrade file version is the same as the device version, and no upgrade operation is performed.";
  this.err_dev_up_file_err =
    "Upgrade file does not exist or is corrupted and unreadable";
  this.err_dev_up_file_crc = "Upgrade file crc check failed";
  this.err_dev_up_ver_failed =
    "Cannot upgrade from the current version to the target version";
  this.err_dev_up_failed = "Upgrade failed";
  this.err_dev_session_limit =
    "Session restrictions, such as device restrictions, only allow 4 customers to download video at the same time";
  ...
  this.taxi_order_status_1 = "Issued";
  this.taxi_order_status_2 = "Order Received";
  this.taxi_order_status_3 = "Executing";
  this.taxi_order_status_4 = "Completed";
  ...
  this.taxi_order_issued_send = "Issued";
  this.taxi_order_issued_cancel = "Cancel";
  ...
  this.taxi_order_use_time_less_tips =
    "Use time must not be less than the current time";
  this.taxi_status = "Vehicle Status";
  ...
  this.report_of_violation_report_1 = "Report Of Violation RPT";
  this.violation_type = "Violation Type";
  this.Overloaded_number = "Overloaded People";
  this.vehicle_speedTimes = "Number Of Speeding";
  ...
  this.Block_the_lens = "Block The Lens";
  this.No_photo = "No Photo";
  this.Overstaff = "Overstaff";
  this.Violation_time = "Violation Time";
  this.overspeed_threshold_report = "Overspeed Threshold RPT";
  this.overspeed_threshold_report_1 = "Overspeed Threshold RPT";
  ...
  this.face_sign_report_identity_incident =
    "Face Sign Report Identity Incident";
  this.dynamic_check_post_identification_event =
    "Dynamic Check Post Identification Event";
  ...
  this.run_stop_reason_other = "Other";
  ...
  this.fence_line_useing =
    "The line is already in use, Please delete the fence line rule first";
  this.fence_start_end_same =
    "The starting and ending fences cannot be the same";
  this.revokeconfirm =
    "Data cannot be restored after it is revoked! Is it revoked?";
  ...
  this.confirm_submission_of_violation_report =
    "Confirm Submission Of Violation RPT";
  ...
  this.report_violation_type = "Violation Type";
  this.report_violation_overspeed_times = "Overspeed Times";
  this.report_violation_overload_number = "Overload Number";
  ...
  this.report_violation_type_location = "No Position";
  this.report_violation_type_offLine = "Offline Operation";
  this.report_violation_type_overspeed = "Overspeed";
  this.report_violation_type_screen = "Black Screen";
  this.report_violation_type_twist = "Twist Lens";
  this.report_violation_type_occlusion = "Block Lens";
  this.report_violation_type_photo = "No Photo";
  this.report_violation_type_overload = "Overstaff";
  this.query_track_first =
    "Please perform trajectory search before reporting violations!";
  this.vehicleAddAndDel = "Vehicle Add/Remove";
  this.parentNeedVehicleAddAndDel =
    "Please enable the parent “Vehicle Add/Remove”";
  ...
  this.taxi_status_vehicle_no_limit =
    "Limit Number Of Operations / Time Not Reached";
  ...
  this.According_Empty_heavy_status =
    "According To Empty And Heavy Truck Status";
  this.According_Empty_heavy_login_status =
    "According To The Login Status And The Empty And Heavy Vehicles Status";
  ...
  this.Empty_vehicle_reporting_distance_interval =
    "Empty Vehicle Reporting Distance Interval";
  this.Heavy_vehicle_reporting_distance_interval =
    "Heavy Vehicle Reporting Distance Interval";
  this.Time_to_sleep_after_ACC_OFF = "Time To Sleep After ACC OFF";
  this.Time_to_enter_shutdown_after_ACC_OFF =
    "Time To Enter Shutdown After ACC OFF";
  ...
  this.Telecall_Service_Center_Customer_Service_Phone =
    "Telecall Service Center Customer Service Phone";
  this.Accumulated_driving_time_threshold_for_the_day =
    "Accumulated Driving Time Threshold For The Day";
  ...
  this.Take_photos_when_ACC_status_changes =
    "Take Photos When ACC Status Changes";
  this.Driver_sign_in_and_check_out =
    "Take Photos When Driver Sign In And Check Out";
  ...
  this.Distracted_driving_taking_pictures =
    "Distracted Driving Taking Pictures";
  ...
  this.Limits_number_of_times_the_metering_device_operates =
    "Limits On The Number Of Times The Metering Device Operates";
  this.Time_limit_of_metering_device = "Time Limit Of Metering Device";
  this.Taxi_business_operation_license_number =
    "Taxi Business Operation License NO.";
  ...
  this.Frame_number = "Frame NO.";
  this.Unique_number_of_metering_device = "Unique Number Of Metering Device";
  this.Means_no_restrictions = "Means No Restrictions";
  this.change_shifts_Direction_list_val =
    "Separated by a semicolon, up to 20 bytes in the direction of each location";
  this.ISU_recording_mode = "ISU Recording Mode";
  this.Full_recording = "Full Recording";
  this.Flop_recording = "Flop Recording";
  this.Maximum_length_of_ISU_recording_file =
    "Maximum Length Of ISU Recording File";
  this.LCD_heartbeat_interval = "LCD Heartbeat Interval";
  this.LED_heartbeat_interval = "LED Heartbeat Interval";
  this.Time_to_enter_sleep_mode_after_ACC_OFF =
    "Time To Enter Sleep Mode After ACC OFF";
  this.Video_latch_time_before_key_event_alarm =
    "Video Latch Time Before Key Event Alarm";
  this.Video_latch_after_alarm =
    "Video Latch Duration After Critical Event Alarm";
  this.Key_event_video_retention_time = "Key Event Video Retention Time";
  this.Face_recognition_acquaintance_threshold =
    "Face Recognition Acquaintance Threshold";
  this.Video_detection_sensitivity = "Video Detection Sensitivity";
  this.Most_sensitive = "Most Sensitive";
  this.Special_alarm_video_lock_control_word =
    "Special Alarm Video Lock Control Word";
  this.taxi_alarm_violation_ =
    "Operation Without Meter /Online Car Parade Alarm";
  ...
  this.Fuel_Surcharge_data_val =
    "The format is YYYYMMDD (all 0 flags are not enabled)";
  ...
  this.Empty_Turn_into_Heavy =
    "Empty Turn Into Heavy Voice Prompt Additional INFO.";
  this.Heavy_Turn_into_Empty =
    "Heavy Turn Into Empty Voice Prompt Additional INFO.";
  this.Voice_reminder_after_service_evaluation =
    "Voice Reminder After Service Evaluation";
  this.extra_information_1 = "Please supervise our services";
  this.extra_information_2 =
    "Thank you for your ride, please bring your belongings";
  this.extra_information_3 =
    "Thank you for your review, please bring your belongings";
  ...
  this.Photo_interval = "Photo Interval";
  this.Camera_channel_number = "Camera Channel NO.";
  this.Driver_in_out_camera_configuration =
    "Driver Sign-in Check-out Camera Configuration";
  this.Passengers_taking_pictures_on_board =
    "Passengers Taking Pictures On Board";
  this.Passengers_get_off_the_camera_to_take_pictures =
    "Passengers Get Off The Camera To Take Pictures";
  this.Timer_photo_configuration = "Timer Photo Configuration";
  this.Physiological_fatigue_alarm_camera_configuration =
    "Physiological Fatigue Alarm Camera Configuration";
  this.Distracted_driving_alarm_camera_configuration =
    "Distracted Driving Alarm Camera Configuration";
  this.Driving_smoke_alarm_camera_configuration =
    "Driving Smoke Alarm Camera Configuration";
  this.Driving_and_calling_alarm_camera_configuration =
    "Driving And Calling Alarm Camera Configuration";
  this.Speeding_alarm_camera_configuration =
    "Speeding Alarm Camera Configuration";
  this.Audio_and_video_parameter_settings =
    "Audio And Video Parameter Settings";
  this.rotationTime = "Rotation Time";
  this.Logic_channel_1_audio_and_video_parameters =
    "Logic Channel 1 Audio And Video Parameters";
  this.Logic_channel_2_audio_and_video_parameters =
    "Logic Channel 2 Audio And Video Parameters";
  this.Logic_channel_3_audio_and_video_parameters =
    "Logic Channel 3 Audio And Video Parameters";
  this.Logic_channel_4_audio_and_video_parameters =
    "Logic Channel 4 Audio And Video Parameters";
  ...
  this.Upper_limit_of_storage_stream_code_rate =
    "Upper Limit Of Storage Stream Code Rate";
  this.Real_time_streaming_video_resolution =
    "Real Time Streaming Video Resolution";
  this.Real_time_streaming_frame_rate = "Real Time Streaming Frame Rate";
  this.Real_time_streaming_bit_rate_limit =
    "Real-time Streaming Bit Rate Limit";
  ...
  this.taxi_mileage_revenue_ranking_title =
    "Milestone Revenue Ranking (RMB / Km)";
  ...
  this.taxi_legend_vehicle = "Vehicle";
  ...
  this.Video_server_APN =
    "Video server APN, wireless communication dial-up access point";
  this.Video_server_wireless_communication_dial_up_username =
    "Video server wireless communication dial up username";
  this.Video_server_wireless_communication_dial_password =
    "Video server wireless communication dial password";
  ...
  this.driver_identification_report_incident =
    "Driver Identification Report Incident";
  this.alarm_type_nightdriving_zsy =
    "Night driving is forbidden without a road order at night (platform)";

  this.vehicleBelongCompany = "Vehicle Company";
  this.excel_idNumber_notexist_error =
    "ID number cell is not text formatted or malformed";
  this.excel_idNumber_repeat_error = "ID number is duplicate or already exists";
  this.excel_contact_repeat_error =
    "Contact information is duplicated or already exists";
  this.excel_liceNumber_notexist_error =
    "Driver's license number cell is not in text format or malformed";
  this.excel_liceNumber_repeat_error =
    "Duplicate license number or already exists";
  this.excel_birthday_notexist_error =
    "Date of birth cell is not text formatted or malformed";
  this.excel_rdEx_notexist_error =
    "Driving license application date cell is not in text format or malformed";
  this.excel_dateAfter_error = "Date later than today";

  this.gather_alarm_rule_title = "Aggregate Alarm Rule";
  this.hot_area_rule_title = "Hotspot Rules";
  this.gather_vehicle_number_tips =
    "Gathering vehicle number valid range 1-9999";
  this.empty_vehicle_number_tips =
    "The number of empty cars must be greater than or equal to 0";
  this.stop_vehicle_number_tips =
    "The number of outages must be greater than or equal to 0";
  this.hot_area_warning = "Early Warning";
  this.hot_area_alarm = "Alarm";
  this.and = "And";
  this.or = "Or";
  ...
  this.taxi_goods_search_param_tips =
    "Start time and end time of boarding information cannot be empty";
  ...
  this.taxi_goods_search_start = "Start Time";
  this.taxi_goods_search_end = "End Time";
  this.taxi_goods_search_up_area = "Start Area";
  this.taxi_goods_search_down = "Drop-off";
  this.taxi_goods_search_down_area = "End Area";
  this.taxi_goods_find_save_tips =
    "The boarding time must not be longer than the boarding time";
  ...
  this.Terminal_interaction_equipment =
    "Terminal Human-computer Interaction Equipment";
  ...
  this.Number_of_cached_operating_records =
    "Number Of Cached Operating Records";
  ...
  this.East_longitude = "East Longitude";
  this.West_longitude = "West Longitude";
  this.Appointment_task_car = "Appointment (task car)";
  this.Vehicle_oil_circuit_is_normal = "Vehicle Oil Circuit Is Normal";
  this.Vehicle_oil_circuit_disconnected = "Vehicle Oil Circuit Disconnected";
  this.Vehicle_circuit_is_normal = "Vehicle Circuit Is Normal";
  this.Vehicle_circuit_disconnected = "Vehicle Circuit Disconnected";
  this.Reached_limit_operation_times_time =
    "Reached Limit Operation Times/Time";
  this.The_metering_device_is_not_locked = "The Metering Device Is Not Locked";
  this.Failure_of_the_satellite_positioning_module =
    "Failure Of The Satellite Positioning Module";
  this.Missing_or_cut_satellite_positioning_antenna =
    "Missing Or Cut Satellite Positioning Antenna";
  this.Satellite_positioning_antenna_short_circuit =
    "Satellite Positioning Antenna Short Circuit";
  this.Terminal_main_power_undervoltage = "ISU Main Power Undervoltage";
  this.Terminal_main_power_off = "ISU Main Power Off";
  this.Liquid_crystal_LCD_shows_ISU_failure =
    "Liquid Crystal (LCD) Shows ISU Failure";
  this.Speech_synthesis_module_failure = "Speech Synthesis Module Failure";
  this.Access_area_route = "Access Area / Route";
  this.Insufficient_Too_Long_Driving_Time =
  ...
  this.Limit_number_of_operations_time_not_reached =
    "Limit number of operations / time not reached";

  this.taxi_complaint_user_info = "Complainant:";
  this.taxi_complaint_type_label = "Complaint Type:";
  this.taxi_out_town_time_range =
    "Out of town time must not be greater than time to return to town";
  this.taxi_emergency_plan_send_tips =
    "The content of the delivered message cannot be empty!";
  ...
  this.taxi_complaint_type_two = "Refusal"; // 2 拒载
  ...
  this.rule_add_tips =
    "Instructions for the use of rules: 1. Add rules 2. Set custom rule conditions 3. Rule judgment for all vehicles in the company to which the rule belongs";
  ...
  this.Delete_all_information_items_of_the_terminal =
    "Delete all information items of the terminal";
  ...
  this.empty_weight_both_zero =
    "The number of empty cars and the number of shutdowns cannot be 0";
  ...
  this.reportTips =
    "Tip: Report The Alarm Processing To The Upper Platform Through 809";
  ...
  this.taxi_emergency_plan_send_length_tips =
    "The length of the content of the delivered message cannot be greater than 240 characters!";
  ...
  this.Liquid_crystal_LCD_multimedia_scree =
    "Liquid Crystal (LCD) Multimedia Screen";
  ...
  this.Download_of_driving_record_parameters =
    "Download Of Driving Record Parameters";

  this.Setting_information_2003 =
    "Setting INFO. (implementation standard GB / T 19056 2003)";
  this.Setting_information_2012 =
    "Setting INFO. (implementation standard GB / T 19056 2012)";
  this.Set_state_quantity_configuration_information =
    "Set state quantity configuration information(implementation standard GB/T 19056 2012)";
  ...
  this.Vehicle_characteristic_coefficient =
    "Vehicle Characteristic Coefficient";
  this.Setting_Date_First_Installation_Recorder =
    "Setting the Date of the First Installation of the Recorder";
  ...
  this.Information_on_demand_menu_settings =
  ...
  this.Terminal_model = "Terminal Model";
  ...
  this.Query_terminal_audio_video_attributes =
  ...
  this.Maximum_number_physical_audio_channels_supported_terminal =
    "Maximum number of audio physical channels supported by the terminal";
  this.Maximum_number_video_physical_channels_supported_terminal =
    "Maximum number of video physical channels supported by the terminal";

  this.analyze_gps = "Do not resolve GPS (used when dual devices)";
  this.vehicleOnlineTitle = "Vehicle Online Status";
  ...
  this.alarm_channel_ID_tips =
    "(1~255) 100:Control ADAS camera; 101: Control DSM camera";
  this.Shooting_order_tips =
    "(0~65535)0 means stop shooting; 65535 means video; others indicate the number of shots";
  this.Save_sign = "Save Sign";
  this.Live_upload = "Live Upload";
  this.Image_Quality = "Image Quality";
  this.Image_Quality_tips =
    "(1~10,1 means minimal quality loss,10 means the maximum compression ratio)";
  this.Store_multimedia_data_upload = "Store Multimedia Data Upload";
  this.Single_storage_multimedia_data_upload =
    "Single Storage Multimedia Data Upload";
  ...
  this.configurationRegion =
    "To Use This Configuration, First Select The Administrative Area";
  ...
  this.groupNeedDispatch =
    "Team Members Can Only Work For Devices With Cluster Scheduling";
  ...
  this.companyIndexTrendLabel =
    "Trend Chart Of Enterprise Assessment Indicators";
  this.companySafeIndexTrendLabel =
    "Trend Chart Of Enterprise Safe Assessment Indicators";
  ...
  this.fatigueDriving = "Fatigue Driving";
  ...
  this.supervision_alarmDistributionTitle = "Key Alarm Distribution";
  ...
  this.supervision_alarmOverSpeedTitle = "Vehicle Speeding";
  ...
  this.supervision_alarm_tips_chart = "Alarms";
  ...
  this.keyAlarmStatistics = "Key Alarm Statistics";
  this.keyAlarmDistribution = "Key Alarm Distribution";

  this.vehicle_type_passenger_transport = "Passenger";
  this.vehicle_type_danger = "Dangerous";
  this.vehicle_type_freight = "Freight";
  ...
  this.vehicleIndexTrendLabel =
    "Trend Chart Of Vehicle Safe Assessment Indicators";
  this.alarmEventSummary = "Alarm Event Statistics";
  this.scoreHappening = "Scoring Situation";
  ...
  this.must_open_region =
    "Please first open the administrative region management function";
  this.Function_905 = "905 function";
  this.track_setting_supplement_cheackBox =
    "Supplementary Shows Different Colors";
  ...
  this.track_setting_supplement_color = "Supplementary  Color:";
  ...
  this.dangerous_goods = "Dangerous";
  ...
  this.The_content_cannot_exceed_characters =
    "The content cannot exceed 127 characters";
  this.The_content_cannot_exceed_characters_20 =
    "Content must be less than 20 characters";
  ...
  this.alarmDetailSelectHandleTip =
    "Please Select The Alarm To Be Processed In The Alarm Message";
  ...
  this.uninstall_device_delete_tips =
    "Do you want to delete the uninstalled device?";
  ...
  this.Insurance_company_cell_not_in_text_format =
    "Insurance company cell is not in text format";
  this.Agent_cell_not_in_text_format = "Agent cell is not in text format";
  this.Contact_phone_cell_not_in_text_format =
    "Contact phone cell is not in text format";
  this.Insurance_type_cell_not_in_text_format =
    "Insurance type cell is not in text format";
  this.Insurance_policy_number_cell_not_in_text_format =
    "Insurance policy number cell is not in text format";
  this.Effective_time_cell_is_not_in_text_format =
    "Effective time cell is not in text format";
  this.Expiration_time_cell_not_in_text_format =
    "Expiration time cell is not in text format";
  this.Actual_price_cell_is_not_in_text_format =
    "Price cell is not in text format";
  this.The_actual_price_format_is_wrong = "The price format is wrong";
  this.discount_cell_is_not_in_text_format =
    "Discount cell is not in text format or malformed";
  ...
  this.The_license_plate_number_not_exist =
    "The license plate number does not exist in the database";
  this.Transport_license_number_cell_not_in_text_format =
    "Transport license number cell is not in text format";
  this.Business_area_cells_are_not_in_text_format =
    "Business area cells are not in text format";
  this.Vehicle_technical_grade_assessment_due_time_cell_not_in_text_format =
    "Vehicle technical grade assessment due time cell is not in text format";
  this.format_of_the_cell_for_the_due_date_vehicle_technical_rating_wrong =
    "The format of the cell for the due date of vehicle technical rating is wrong\n";
  this.Remarks_cells_not_in_text_format =
    "Remarks cells are not in text format";

  this.Driving_license_number_cell_not_in_text_format_or_format_error =
    "Driving license number cell is not in text format or format error";
  this.Using_nature_cells_not_text_format_or_malformed =
    "Using nature cells is not a text format or malformed";
  this.Brand_model_cell_not_in_text_format_or_format_error =
    "Brand model cell is not in text format or format error";
  this.Engine_number_cell_not_in_text_format_or_malformed =
    "Engine number cell is not in text format or malformed";
  this.Transport_certificate_information_already_exists =
    "The vehicle already has the transport certificate information";
  this.Driving_license_information_already_exists =
    "The vehicle already has driving license information";
  this.vehicleIdnoLogin = "Plate NO. Login";
  this.IllegalAccessToHTML = "Illegal access to HTML";
  this.license_plater_number_not_allow_login =
    "The license plate number does not allow login";
  this.accountInfoExists =
    "License Plate Number Or Account Name Already Exists";
  this.voltage_sensor = "Voltage Sensor";
  this.voltage_unit = " Voltage";
  this.selectAlarmOrRemark =
    "Please Select The Type Of Alarm Or Fill In The Remarks";
  ...
  this.The_expiration_time_is_earlier_than_the_effective_time =
    "The expiration time is earlier than the effective time\n";
  ...
  this.selected_required_least_one =
    "Select at least one company with modification rights";
  this.passenger_reportEx = "Passenger Report(1078)";
  this.Vehicle_authorization_change =
    "The user's vehicle authorization has changed and the page needs to be refreshed";
  this.auto_snapshot_dsm = "DSM Automatically Snapshot";
  this.auto_snapshot_inspection = "Driver Identity Inspection";
  this.http_map_https_port =
    "Nginx Https port and server Http port mapping(6604:16604;6605:16605)";
  ...
  this.alarm_name_151 = "Early Morning Operation(Platform)";
  ...
  this.networkControlAlarmsAnalysis =
    "The Number Of Networked Joint Control Alarms";
  this.safetyAnalysis = "Active Safety Analysis";
  this.companySafetyScoreChart = "Trend Chart Of Company Active Safety Score";
  this.companyIndexSafeLabel = "Company Active Safety Assessment Indicators";
  this.companyIndexTrendSafeLabel =
    "Trend Chart Of Company Active Safety Indicators";
  ...
  this.safetyKeyAlarmsAnalysis =
    "Analysis Of The Number Of Active Focus Safety Alarms";
  ...
  this.There_are_three_pictures_at_this_location =
    "There are three pictures at this location";
  this.The_recommended_resolution = "The recommended resolution is";
  this.Sort_already_exists = "Sort already exists";

  this.pdfExportTips =
    "The content is too long, and export is not supported yet. It is recommended to configure a few key alarm types for a small amount";
  this.offlineTips = "Offline notification";
  this.userOfflineTips =
    "The current user has logged in at another location and has been forced to log off.";
  ...
  this.dirt_truck_operation = "Operation RPT";
  ...
  this.Daily_monthly_report_amount_soil_collected_consumer_site =
    " Report Of Consumer Field";
  // ~ ocr
  ...
  this.auto_authorize_vehicle = "Authorization(new vehicles)";
  ...
  this.errorBySiteSelectMarkId =
    "Only map markers of construction site type can be selected";
  this.errorByconsumptionSelectMarkId =
    "Only map markers of consumer field type can be selected";
  ...
  this.consumptionSiteRemark = "Remark";
  this.consumptionSiteUpdateTime = "Consumption Site Update Time";
  this.consumptionSiteCreateTime = "Consumption Site Create Time";
  ...
  this.siteStartTime = "Effective Period Start Time";
  ...
  this.siteRemark = "Remarks";
  this.siteUpdateTime = "Update Time";
  this.siteCreateTime = "Creation Time";
  ...
  this.transportDistanceDistribution = "Transport Distance Distribution";
  this.transportDistanceDistributionDriver =
    "Transport Distance Distribution Driver";
  this.transportDistanceDistributionCompanty =
    " Transport Distance Distribution Companty";
  this.transportDistanceDistributionVehicle =
    "Transport Distance Distribution Vehicle";
  ...
  this.muck_truck_lift_alarm = "Regional Illegal Lifting (Platform)";
  ...
  this.taxi_average_revenue = "Average Revenue";
  ...
  this.taxi_kilometer_output_value = "Kilometer Output Value";
  ...
  this.oilCurveRpt = "Fuel Consumption Curve RPT";
  this.totalOil = "Total Oil";
  this.oildayMonth = "Fuel Daily/Monthly RPT";
  ...
  this.waterLevelLabel = "Water Level";
  this.mileage_fuel_consumption = "Mileage Fuel Consumption Chart";
  this.oilLabel = "Oil";
  this.speed_licheng = "Speed/Mileage";
  this.waterLevelRpt = "Water Level RPT";
  this.waterLevelCurveRpt = "Water Level Curve RPT";
  ...
  this.waterChangeDetailRpt = "Water Level Change RPT";
  this.saveImg = "Save As Picture";
  this.auxiliaryTank = "Auxiliary Tank";

  this.Main_oil_tank = "Main Oil Tank";
  this.Auxiliary_oil_tank = "Auxiliary Oil Tank";
  this.Water_level_scale_calculation_configuration =
  ...
  this.WeChat_settings_management_tips =
    "WeChat configuration items must be filled in or not filled at all!";
  ...
  this.Conventional_parameters_val =
    "Conventional parameters are as follows:\n" +
    ...
    "Call the actual The url is:\n" +
    "http://xxx/abcd?abc=测Axxxxx&ddd=0138546425";
  this.Custom_menu_too_long =
    "The total number of words in the custom menu does not exceed 1024";
  ...
  this.governmentCheckPortChagangStatisticsTable =
    "Superior platform company check the post statistics table";
  this.governmentCheckPortChagangExplanation =
    " Arithmetic types such as (1+1=?) Chagang can analyze the accuracy, as long as the reply of the text Chagang is correct, the reply is correct";
  this.currentlyConnectedSubordinate = "Currently connected subordinate";
  this.singleUserToLowerLevel = "Single user to lower level";
  this.allUsersBelongingToSubordinate = "All users belonging to subordinate";
  this.correctReply = "Correct reply";
  this.correctError = "Error reply";
  this.correctNormal = "Replied";
  this.superiorPlatform = "Superior platform";
  ...
  this.operaManagementSimDeleteUninstall =
    "Whether to delete the uninstalled SIM card?";

  this.over_speed_or_tired = "Overspeed/Fatigue Alarm";
  this.h5player_no_support_talk =
    "h5 player does not support intercom function temporarily, please use flash player";
  ...
  this.report_user_log_PTZControl = "PTZ Control";
  ...
  this.report_user_log_getNetworkTrafficInfo =
    "Get Network Traffic Information";
  this.report_user_log_setNetworkTrafficInfo =
    "Set Network Traffic Information";
  this.report_user_log_clearNetworkTrafficSummary =
    "Clear Network Traffic Statistics";
  this.report_user_log_correctionNetworkTrafficSummary =
    "Correct Network Traffic Statistics";
  this.report_user_log_sendSchedulingInstruction =
  ...
  this.report_user_log_transparentParam = "Parameters Config";
  ...
  this.report_user_log_transparentData = "Transparent Data";
  ...
  this.report_user_log_questionIssued = "Question Issued";
  this.report_user_log_informationDemand = "Information Demand";
  this.report_user_log_informationService = "Information Service";
  this.report_user_log_phoneCallBack = "Phone Call Back";
  this.report_user_log_setPhoneBook = "Set Phone Book";
  this.report_user_log_vehicleControl = "Vehicle Control";
  ...
  this.report_user_log_recordingCommand = "Recording Command";
  this.report_user_log_mediaUpload = "Media Upload";
  this.report_vehicleModify_addPolice = "Add Police";
  this.report_vehicleModify_addVehicle = "Add Vehicle";
  ...
  this.report_vehicleModify_mediaAudio = "Audio Monitoring";
  ...
  this.Total_number_of_passenger_transport_policies =
    "Total Number Of Passenger Transport Policies";
  this.Number_of_passengers_entering_the_network =
    "Number Of Passengers Entering The Network";
  this.Passenger_access_rate = "Passenger Access Rate";
  this.Total_number_of_tourism_chartered_vehicles =
    "Total Number Of Tourism Chartered Vehicles";
  this.Number_of_tourist_chartered_cars = "Number Of Tourist Chartered Cars";
  this.Travel_charter_network_access_rate =
    "Travel Charter Network Access Rate";
  this.Total_number_of_dangerous_goods_transportation_policies =
    "Total Number Of Dangerous Goods Transportation Policies";
  this.Number_of_dangerous_goods_entering_the_network =
    "Number Of Dangerous Goods Entering The Network";
  ...
  this.Number_of_freight_into_the_network =
    "Number Of Freight Into The Network";
  ...
  this.Daily_monthly_report_of_network_access_rate =
    "Daily/monthly report of network access rate";

  this.Daily_monthly_report_of_online_rate_of_online_joint_control =
    "Daily / monthly report of online rate of online joint control";
  this.Daily_report_of_online_rate_of_online_joint_control =
    "Daily report of online rate of online joint control";
  this.Monthly_report_of_online_rate_of_online_joint_control =
    "Monthly report of online rate of online joint control";
  ...
  this.Number_of_tour_charter_buses_on_line =
    "Number Of Tour Charter Buses On Line";
  ...
  this.Number_of_lines = "Number Of Lines";

  this.Daily_monthly_report_of_integrity_rate_networked_joint_control_track =
    "Daily/monthly report of integrity rate of networked joint control track";
  this.Daily_report_of_integrity_rate_of_networked_joint_control_track =
    "Daily report of integrity rate of networked joint control track";
  this.Monthly_report_of_integrity_rate_of_networked_joint_control_track =
    "Monthly report on integrity rate of networked joint control track";
  ...
  this.Hazardous_Goods_Track_Completeness =
    "Hazardous Goods Track Completeness";
  ...
  this.Track_Completeness = "Track Completeness";

  this.Report_of_Data_Qualification_Rate_for_Networked_Control =
    "Daily/Monthly Report of Networked Joint Control Data Qualification Rate";
  this.Daily_report_of_qualified_rate_of_networked_joint_control_data =
    "Daily report of qualified rate of networked joint control data";
  this.Monthly_report_of_qualified_rate_of_networked_joint_control_data =
    "Monthly report of qualified rate of networked joint control data";
  this.Total_number_of_passenger_data_bars =
    "Total Number Of Passenger Data Bars";
  ...
  this.Number_of_qualified_entries_for_charter_car_data =
    "Number Of Qualified Entries For Charter Car Data";
  this.Qualification_Rate_of_Tour_Charter_Data =
    "Qualification Rate Of Tour Charter Data";
  this.Total_Hazardous_Goods_Data = "Total Hazardous Goods Data";
  this.Hazardous_Goods_Data_Qualified_Bars =
    "Hazardous Goods Data Qualified Bars";
  this.Hazardous_Goods_Data_Qualification_Rate =
    "Hazardous Goods Data Qualification Rate";
  this.Total_number_of_freight_data_bars = "Total Number Of Freight Data Bars";
  this.Number_of_eligible_bars_for_freight_data =
    "Number Of Eligible Bars For Freight Data";
  ...
  this.Number_of_Eligible_Bars_for_Other_Data =
    "Number of Eligible Bars for Other Data";
  ...
  this.Data_Qualification_Rate = "Data Qualification Rate";

  this.report_on_response_rate_of_online_joint_control_inspection =
    "Daily/monthly Report On Response Rate Of Online Joint Control Inspection";
  this.Daily_report_on_response_rate_of_online_inspection =
    "Daily Report On Response Rate Of Online Inspection";
  this.Monthly_report_on_response_rate_of_online_inspection =
    "Monthly report on response rate of online inspection";
  this.Number_of_post_checks = "Number Of Post Checks";
  this.Number_of_responses = "Number Of Responses";
  ...
  this.Internet_not_speeding_report =
    "Daily/monthly report of networked joint control without speeding";
  this.Daily_report_of_networked_joint_control_without_speeding =
    "Daily report of networked joint control without speeding";
  this.Monthly_report_of_networked_joint_control_without_speeding =
    "Monthly report of networked joint control without speeding";
  this.Number_of_passenger_vehicles_entering_the_network =
    "Number Of Passenger Vehicles Entering The Network";
  this.Number_of_passenger_vehicles_without_speeding =
    "Number Of Passenger Vehicles Without Speeding";
  this.Passenger_traffic_rate_of_non_speeding_vehicles =
    "Passenger Traffic Rate Of no speeding Vehicles";
  this.Number_of_tourist_chartered_vehicles_connected_to_the_network =
    "Number Of Tourist Chartered Vehicles Connected To The Network";
  this.Number_of_non_speeding_vehicles = "Number Of No Speeding Vehicles";
  this.Rate_of_non_speeding_tourist_chartered_vehicles =
    "Rate Of No Speeding Tourist Chartered Vehicles";
  this.Number_of_vehicles_with_dangerous_goods_entering_the_network =
    "Number Of Vehicles With Dangerous Goods Entering The Network";
  this.Number_of_dangerous_goods_not_speeding_vehicles =
    "Number Of Dangerous Goods Not Speeding Vehicles";
  this.Dangerous_goods_not_speeding_vehicle_rate =
    "Dangerous Goods Not Speeding Vehicle Rate";
  this.Number_of_freight_vehicles_entering_the_network =
    "Number Of Freight Vehicles Entering The Network";
  this.Number_of_freight_vehicles_not_speeding =
    "Number Of Freight Vehicles Not Speeding";
  this.Freight_rate_of_not_speeding_vehicles =
    "Freight Rate Of Not Speeding Vehicles";
  this.Number_of_other_connected_vehicles =
    "Number Of Other Connected Vehicles";
  this.Other_not_speeding_vehicles = "Other Not Speeding Vehicles";
  this.Rate_of_other_not_speeding_vehicles =
    "Rate Of Other Not Speeding Vehicles";
  ...
  this.taxi_goods_down_search_param_tips =
    "The start time and end time of alighting information cannot be empty";

  this.lichengNotNull = "Mileage cannot be empty";
  this.lichengCheckTip =
    "Starting mileage cannot be higher than ending mileage";
  ...
  this.report_integrity_rate_sum_tracerate_scoring =
    "Trajectory Integrity Scoring";
  ...
  this.report_supervision_offlineDisplacement =
    "Offline Displacement Processing";
  ...
  this.report_supervision_overSpeed_summary_company =
    "Company Overspeed Summary";
  ...
  this.report_supervision_overSpeed_rate = "Overspeed Ratio";
  ...
  this.cycle_report = "Periodic RPT";
  this.report_licheng_weekly = "Week RPT";
  ...
  this.forwardIntervalTime = "Interval time";
  ...
  this.forwardOrHandOver = "Is Handover?";
  ...
  this.notificationShow =
    "You have unprocessed shift records, please click to view";
  ...
  this.bus = "bus";
  this.dangerousGoodsTransportation = "Dangerous goods transportation";
  ...
  this.ledgerRemark =
    "For the vehicle status, please fill in the following: 1. Normal 2. Power off 3. Interrupted 4. Offline 5. Not located 6. Not installed 7. Other abnormal";
  ...
  this.ledgerDriverName = "Driver's name";
  ...
  this.Alarm_report_of_network_joint_company =
    "Network Joint Control Company RPT";
  this.Early_morning_operating_daily_report = "Early Morning Operating RPT";
  this.Overspeed_alarm_daily_report = "Overspeed Alarm RPT";
  this.Offline_Daily_Report = "Offline RPT";
  this.Offline_Displacement_Daily_Report = "Offline Displacement RPT";
  this.Fatigue_Driving_Daily_Report = "Fatigue Driving RPT";
  this.Quality_of_Service = "Quality of Service";
  this.Statistics_of_Driver_Violation_Complaints =
    "Driver Violation Complaints Statistics";
  this.Number_of_complaints = "Number of complaints";
  this.Number_of_times_processed = "Number of times processed";
  this.Service_Evaluation_Details_Report = "Service Evaluation Details RPT";
  this.Evaluation_Time = "Evaluation Time";
  this.Service_evaluation_summary_report = "Service Evaluation Summary RPT";
  ...
  this.Deduction_points = "Deduction points";
  ...
  this.ASSESSMENT_ITEMS_EXIST =
    "The appraisal item has been used and cannot be deleted!";
  ...
  this.no_evaluation_items =
    "There is no evaluation item, please go to add it first";
  ...
  this.fence_speedLimit = "Speed Limit";
  this.fence_maxSpeed = "Max Speed";
  this.fence_maxNightSpeed = "Night Max Speed";
  this.fence_duration = "Duration";
  this.fence_enableDrivingTime = "Driving Time";
  this.fence_maxTime = "Driving Max Time";
  this.fence_minTime = "Driving Min Time";
  this.fence_roadWidth = "Road Width";
  this.fence_construction_site = "Construction Site";
  this.fence_restricted_area = "Restricted Area";
  this.fence_elimination_field = "Elimination Field";
  ...
  this.groupMonitor = "Group monitoring";
  this.multiTrack = "Multi-Vehicle Track";
  this.minuteLabel = "M";
  ...
  this.videoCloseTimeTips =
    "A Duration Of 0 Means Not Enabled, Otherwise Enabled, Unit:Second";
  ...
  this.heavy_vehicles_restrictions =
    "Heavy Vehicles Not Restricted In Areas (restricted in non-designated areas)";
  this.undocumented_entry_restrictions = "Undocumented Entry Restrictions";
  this.undocumented_entry_consumer_restrictions =
    "Undocumented Entry Consumer Restricted";
  this.unlimited_speed = "Unlimited Speed (maximum speed)";
  this.platform_limited_speed = "Platform Speed Limit Issued";
  this.heavy_vehicles_limited_speed =
    "(Heavy Vehicles) Speed Limit Roof Not Closed";
  ...
  this.g_sensor_limited_speed =
    "Lift Sensor Failure or Not Connected Speed Limit";
  ...
  this.heavy_certificate_limited_speed =
    "Speed Limit Heavy Vehicles Without Approval Certificate";
  ...
  this.Processing_within_the_specified_time =
  ...
  this.muckTruck_terminal_control_speed = "Speed";
  ...
  this.muckTruck_terminal_control_color_green = "Green";
  ...
  this.rule_custumer_tips =
    "Non-admin user login can only view and operate the enabled rules!";
  ...
  this.showDownLoadDialogByThirdPartDevelop =
    "Need to download the intercom software, are you sure to download it?";
  this.checkTalkEnvironment =
    "Check that your system has not installed the intercom environment, please follow the steps below to complete the installation:";
  this.checkTalkEnvironment_step_2 =
  ...
  this.vehicleCompanyCanNotArea =
    "The company of the vehicle cannot be a region";
  this.coordinate = "Coordinate";
  this.mapZoom = "Zoom";
  this.custom_rule_management = "Custom Rule";
  this.enableNormalUser = "Ordinary User Filter Authorized Company";
  this.enableAllowVehiAccountSameName =
    "VehiIdno And User Account Have The Same Name";
  ...
  this.vehicle_rule_management = "Vehicle Rule Management";
  ...
  this.function_change =
    "The function configuration has been modified and the page needs to be refreshed";
  this.fileUploadType = "File Upload Type";

  this.report_networked_control_daily_monthly_report =
    "Daily / monthly report of Networked Joint Control Summary";
  ...
  this.Call_station_number_already_exists =
    "Call station number already exists!";
  ...
  this.customizeOperationReport = "Customize OperationReport";
  this.customize_report_licheng_daily = "Customize Daily RPT";
  this.customize_report_licheng_weekly = "Customize Weekly RPT";
  this.customize_report_licheng_monthly = "Customize Monthly RPT";
  ...
  this.alarm_name_511 =
    "IC Card Qualification Certificate Reading Failure Alarm";
  ...
  this.alarm_name_522 =
    "IC Card Qualification Certificate Module Failure Alarm";

  this.handleWayTip1 = "The driver corrects in time";
  this.handleWayTip2 =
    "A reminder has been issued to correct the instruction. Then the alarm is cleared";
  this.handleWayTip2_phrase = "Alarm release";
  this.handleWayTip3 =
    "A reminder has been issued to correct the instruction. Then report to the corporate safety management agency, and finally the alarm is released";
  this.handleWayTip3_phrase = "Report to the company, the alarm is released";
  this.handleWayTip4 =
    "A reminder has been issued to correct the instruction. Then report to the safety management agency of the enterprise. As it still has not corrected, report to the traffic management department of the public security agency";
  this.handleWayTip4_phrase =
    "Report to the Police station, the alarm is lifted";
  this.handleWayTip5 = "Customize";
  ...
  this.muck_type_waste = "Construction Waste";
  ...
  this.command_type_identity_face = "Face Recognition";
  ...
  this.Not_reported_after_completing_the_service =
    "Not reported after completing the service";
  ...
  this.Individually_modify_the_vehicle_speed_limit =
    "Individually modify the vehicle speed limit (platform)";
  this.Synchronous_modification_of_vehicle_equipment =
    "Synchronous modification of vehicle equipment";
  ...
  this.driver_identification_evidence_center =
    "Driver Identification Evidence Center";
  this.vehicle_operation_monitoring_evidence_center =
    "Vehicle Operation Monitoring Evidence Center";
  this.equipment_failure_monitoring_evidence_center =
    "Equipment Failure Monitoring Evidence Center";
  ...
  this.clutch_status = "Clutch";
  this.marker_light_status = "Marker Lights";
  ...
  this.platform_inspection_vehicle = "Vehicle Operation";
  ...
  this.Driving_speed = "Driving speed";
  ...
  this.Department_speeding_assessment_summary_table =
    "Department speeding assessment summary table";
  this.Ministry_speeding_assessment_schedule =
    "Ministry speeding assessment schedule";
  ...
  this.rule_way_point_statistics = "Waypoint Rules";
  ...
  this.false_positive_rpt = "False/Positives Alarm Detail";
  this.way_point_rpt = "Waypoint Alarm Detail";
  this.summary_analysis = "Statistical Analysis RPT";
  this.gps_interruption_summary_rpt = "GPS Interrupted Alarm Summary";
  this.false_positive_summary_rpt = "False/Positives Alarm Summary";
  ...
  this.gps_interruption_rpt_label = "GPS Interrupted Alarm RPT";
  this.false_positive_rpt_label = "False/Positives Alarm RPT";
  ...
  this.importModelShare1 =
    "Share (Default 0; 0: does not share 1: packet sharing 2: global share)";
  this.importModelShare2 =
    "Share (Default 0; 0: does not share 1: packet sharing)";
  ...
  this.protocol_8082019_status_bit2_0 = "North Latitude";
  this.protocol_8082019_status_bit2_1 = "South Latitude";
  ...
  this.protocol_8082019_status_bit6_1 =
  ...
  this.protocol_8082019_status_bit12_1 = "Door Lock";
  ...
  this.protocol_8082019_status_bit14_1 = "Door 2 Open (Middle)";
  ...
  this.protocol_8082019_status_bit19_1 = "Use Beidou Satellite Positioning";
  ...
  this.protocol_8082019_status_bit21_1 = "Use Galileo Satellite Positioning";
  ...
  this.protocol_8082019_alarm_bit7_1 =
    "Terminal Main Power Supply Undervoltage";
  ...
  this.protocol_8082019_alarm_bit12_1 =
    "Road Transport Permit IC Card Module Failure";
  ...
  this.protocol_8082019_alarm_bit20_1 = "Entry And Exit Area";
  ...
  this.Engineering_route_approval_management =
    "Engineering route approval management";
  ...
  this.The_department_exists_in_the_approval_process =
    "Regulators are being used and cannot be deleted!";
  ...
  this.Responsible_person_for_application =
    "Responsible person for application";
  ...
  this.Planned_transportation_route_description =
    "Planned transportation route description";
  ...
  this.Person_in_charge_of_subcontracting_unit =
  ...
  this.The_same_record_exists =
    "The same record exists, the selection is invalid";
  this.Please_select_an_administrative_region =
    "Please select an administrative region";
  this.null_value_in_planned_transportation_period =
    "There is a null value in the planned transportation period";
  this.The_planned_shipping_start_date_is_illegal =
    "The planned shipping start date is illegal";
  this.The_planned_shipping_end_date_is_illegal =
    "The planned shipping end date is illegal";
  ...
  this.Confirm_node_prompt =
    "Please confirm the approval node! the approval node cannot be modified after it is generated!";
  this.withdraw = "withdraw";
  this.node_is_empty = "The approval node is empty, please select again!";
  this.withdrawFirm =
    "It cannot be restored after withdrawal! Is it withdrawn?";
  ...
  this.customAccountEditVehicle =
    "Ordinary users are not allowed to modify vehicle information";
  ...
  this.advertisingShow = "Show advertising";
  ...
  this.exceedMaxVehicleNum =
    "Exceed the maximum number of authorized vehicles, please contact the administrator";
  this.exceedMaxVehicleNumAdmin =
    "Exceed the maximum number of vehicles, please modify the maximum number of vehicles.";
  this.exceedMaxVehicleNumCompany =
    "If the maximum number of vehicles authorized by the superior company is exceeded, please contact the administrator.";
  this.exceedMaxVehicleNumCompanySubordinate =
    "The number of vehicles in the current company and subordinate companies has exceeded the current value. Please increase the number of vehicles added or contact the administrator.";
  this.exceedMaxVehicleNumCompanyAutoLogout =
    "If the maximum number of authorized vehicles is exceeded, it will exit automatically after 5 seconds";

  this.identifying = "Identifying";
  this.identifySuccess = "Recognition success";
  this.identifyFail = "Recognition failure";

  this.emailSubscriptionsAccountRepeat =
    "User has subscribed, please do not add repeatedly";
  ...
  this.chear_time_ruiming =
    "The unit is second, 0 means currently valid, other values mean that the invalidation will be released after the interval";
  this.limit_speed_ruiming =
    "0~255, 0: no speed limit, speed limit lifted; others: specific speed limit, unit km/h";
  this.chear_lock_event_ruiming =
    "Valid when unlocking the vehicle; 0: General, release all event control generated by the terminal";
  this.chear_speed_event_ruiming =
    "Valid when the vehicle speed limit is released; 0: general, release all event control generated by the terminal";
  this.chear_lift_event_ruiming =
    "Valid when the vehicle limit is lifted; 0: General, remove all event control generated by the terminal";
  ...
  this.driver_identification_notThrough = "Identification Failure";
  ...
  this.blockVehicleListReport = "Block vehicle Report";

  this.snapshot_picture_details = "Snapshot Details";
  this.excavation_at_site = "Excavation at site(kg)";
  this.Excavated_Quantity_of_Disposal_Site =
    "Excavated Quantity of Disposal Site(kg)";
  this.Reclaim_of_Reclaim_Site = "Reclaim of Reclaim Site(kg)";
  this.The_ranking_of_waste_disposal_field =
    "The ranking of waste disposal field";
  ...
  this.alarm_name_113_53_upgrade_type_12 =
  ...
  this.report_networked_control_daily_report =
    "Networked joint control assessment summary daily report";
  this.Daily_report_of_network_access_rate =
    "Daily Report of Network Access Rate of Network Control";

  this.report_networked_control_monthly_report =
    "Monthly report on networked control assessment summary";
  this.Monthly_report_of_network_access_rate =
    "Monthly Report of Network Access Rate of Networking Control";

  this.at_least_one_report = "Subscribe to at least one report";
  this.EmailSubscriptionsPushTimeSetting =
    "Email Subscriptions Push Time Setting";
  ...
  this.report_table_trips_number = "Number Of Trips";

  this.Null_value_in_transit_time = "Null value in transit time";

  this.handoverReport = "Handover RPT";
  ...
  this.importMapTypeNew =
    "(3：Baidu 4：Autonavi 7：Baidu Offline 8：Google Offline  9：bing  10：OSM 11：Google 12：Mapbar 18: TianDi Map)";
  ...
  this.track_param_alarm = "Alarm Starting Point";
  this.track_param_snap = "Track Capture";
  this.Existing_absorption_field_in_use =
    "There is a clearing ground in use and it cannot be deleted!";
  this.approval_process_management = "approval process management";
  this.Approval_information_changes =
    "The approval information has changed, please try again!";
  ...
  this.track_param_snap = "Show Snap On Track";
  ...
  this.lbTrendSpeed = "Speed";
  this.lbTrendOil = "Tank";
  this.lbTrackWater = "Water Level";
  this.lbTrackSnap = "Snap";
  this.lbtrackMakeUp = "Repost";
  this.lbTrackAlarmOverspeed = "Speed Alarm";
  this.lbTrackWarningOverspeed = "Speed Warning";
  this.lbTrackAlarmFatigue = "Fatigue Alarm";
  this.lbTrackWarningFatigue = "Fatigue Warning";
  ...
  this.Transparent_data = "Transparent data";
  ...
  this.Online_car_driving_license_picture =
    "Online car driving license picture";
  this.Online_Appointment_Driving_License_Validity_Start_Time =
    "Online Appointment Driving License Validity Start Time";
  this.Online_Appointment_Driving_License_Validity_End_Time =
    "Online Appointment Driving License Validity End Time";
  this.signs_forbid = "Prohibition Sign";
  this.signs_park = "No Stop Sign";

  this.Network_joint_control_company_report_black_label =
    "Network joint control company report (black label)";
  ...
  this.Number_of_offline_displacements = "offline displacements";
  this.Number_of_prohibitions = "night prohibitions";
  this.Offline_times = "Offline times";
  this.Monitoring_record_table = "24 Hours Monitoring record table";
  this.Speeding_Daily_Report = "Speeding Daily Report";
  this.Fatigue_Driving_Daily_Report_black = "Fatigue Driving Daily Report";
  this.Offline_displacement_daily_report_black =
    "Offline displacement daily report";
  this.Prohibited_daily_report = "Daily report for night ban";
  this.Offline_daily_report_black = "Offline daily report";
  this.Monthly_report_of_vehicle_driving_behavior_ranking =
    "Monthly report of vehicle driving behavior ranking";
  ...
  this.Description_of_the_handling =
    "Handling of the driver in violation of regulations: ①The vehicle has notified the driver ②The person in charge of the company’s safety has been notified ③The vehicle has been notified that it has triggered the implementation regulations of the Road Traffic Safety Law ④The invalid alarm has been eliminated";
  this.Has_joined_the_monthly_statistics_list =
    "Has joined the monthly statistics list";
  this.Description_of_the_Monitoring_processing =
    "Monitoring processing instructions: ①The vehicle has notified the driver ②The person in charge of the company’s safety has been notified ③The vehicle has been notified that it has triggered the implementation regulations of the Road Traffic Safety Law ④The invalid alarm has been eliminated";
  ...
  this.videoSearchDesc1 =
    "With PlaybackUrlWs, PlaybackUrlWs is preferred. PlaybackUrlWs does not support flash";
  this.videoSearchDesc2 =
    "When mulPlay>0, multi-channel video playback can be performed";
  this.videoSearchDesc3 =
    "If mulChn is not 0, display the channel information obtained by mulChn bitwise value, if mulChn is 0, it is necessary to determine which channels have recording information in the current time period.";

  this.uploadFileTip =
    "The file was not uploaded, or the uploaded file type is wrong!";
  ...
  this.Driver_evaluation_index_management =
    "Driver evaluation index management";
  this.Enterprise_evaluation_index_management =
    "Enterprise evaluation index management";
  this.Driver_indicator_version_management =
    "Driver evaluation index version management";
  this.Initial_score = "Initial score";
  this.Version_type = "Version type";
  this.Driver_indicator_version = "Driver indicator version";
  this.Enterprise_index_version_management =
    "Enterprise evaluation index version management";
  this.Driver_indicator_version = "Driver indicator version";
  this.Enterprise_indicator_version = "Enterprise indicator version";
  this.Indicator_version_details = "Indicator version details";

  this.three_rolls_per_day = "Three-day Roll Monitoring Report";
  ...
  this.three_rolls_time_range_tips =
    "Time sequence needs to be guaranteed [time point 1 >> time point 2 >> time point 3]!";
  ...
  this.three_rolls_handling = "Processing Status";
  this.Driver_index_classification_management =
    "Driver index classification management";
  this.Enterprise_index_classification_management =
    "Enterprise index classification management";
  ...
  this.Cannot_be_less_than_the_assigned_points =
    "Cannot be less than the assigned points";
  this.Index_item = "Index item";
  this.Point_warning =
    "The total score of the indicator category cannot exceed the initial score of the version!";
  ...
  this.rate = "rate";
  this.Point_warning2 =
    "The sum of the total score of the index items cannot exceed the initial score of the classification!";
  this.The_score_cannot_be_greater_than_the_total_score =
    "The score cannot be greater than the total score";
  ...
  this.Driver_personal_information_desensitization =
    "Driver personal information desensitization";

  this.Driver_evaluation_score_level_management =
    "Driver evaluation score level management";
  this.Enterprise_Evaluation_Score_Management =
    "Enterprise Evaluation Score Management";
  this.Highest_score = "Highest score";
  this.Point_warning3 =
    "The highest score cannot exceed the initial score of the version!";
  ...
  this.Enterprise_evaluation_score_record =
    "Enterprise evaluation score record";
  this.Evaluation_time = "Evaluation time";
  this.Driver_credit_assessment = "Driver credit assessment";
  this.Corporate_reputation_assessment = "Corporate reputation assessment";
  ...
  this.Enterprise_Evaluation_Index_Project =
    "Enterprise Evaluation Index Project";
  ...
  this.Driver_evaluation_result_management =
    "Driver evaluation result management";
  this.Enterprise_evaluation_result_management =
    "Enterprise evaluation result management";
  this.Reevaluation = "Reevaluation";
  this.Evaluation_details = "Evaluation details";
  this.The_evaluation_result_already_exists =
    "The evaluation result already exists";
  this.Total_deduction = "Total deduction";
  ...
  this.No_classification_under_version =
    "No indicator classification under indicator version";
  this.no_item_under_classification =
    "There is no indicator item under the indicator category";
  ...
  this.Enterprise_evaluation_plan_management =
    "Enterprise evaluation plan management";
  ...
  this.sentConfirm =
    "SMS is about to be sent to the inspectors. Do you want to send it?";
  this.message_failed_to_send = "message failed to send";
  this.Driver_credit_abnormal_warning = "Driver credit abnormal warning";
  this.Enterprise_credit_abnormal_warning =
    "Enterprise credit abnormal early warning";
  this.Driver_warning_threshold_setting = "Driver warning threshold setting";
  this.Enterprise_warning_threshold_setting =
    "Enterprise warning threshold setting";
  this.Driver_warning_monitoring = "Driver warning monitoring";
  this.Enterprise_early_warning_monitoring =
    "Enterprise early warning monitoring";
  ...
  this.remindConfirm =
    "Relevant personnel will be reminded according to the reminding method";
  ...
  this.Average_score_of_early_warning_events =
    "Average score of early warning events";
  this.Total_score_of_early_warning_events =
    "Total score of early warning events";
  ...
  this.Enterprise_credit_information_release =
    "Enterprise credit information release";
  ...
  this.Query_stats = "Query stats";
  this.Statistics_on_bad_behavior_of_drivers =
    "Statistics on bad behavior of drivers";
  this.Statistics_of_corporate_bad_behavior =
    "Statistics of corporate bad behavior";

  // ~ OSS配置
  this.enableOSSConfig = "Enable";
  ...
  this.innerOuterDomainNotNull =
    "The access domain name (intranet) and access domain name (extranet) must be filled in, and the intranet is preferred.";
  ...
  this.amazonTip =
    "AWS services in the same region access S3 by default through the public network, but no charge";
  ...
  this.tencentSpaceTip =
    "Add-APPID suffix (APPID: the account you get after successfully applying for a Tencent Cloud account, it is automatically assigned by the system, it is fixed and unique, and can be viewed in the account information.)";
  this.tencentDomainTip =
    "By default, the same domain name is supported to resolve to internal and external network addresses, and there is no need to separate domain names/set up DNS and other operations. ";

  this.innerOuterDomain = "Access domain name (internal and external network)";

  this.storageSpaceNameTip =
    "The name of the storage space of the object storage (create the storage space name in the object storage to avoid duplication with other storage space names resulting in failure to create)";
  this.authenticationKeyTip = "AccessKey used to access object storage";
  this.authenticationPrivateKeyTip =
    "AccessKeySecret used to access object storage";
  this.outerDomainTip =
    "Use the domain name location object storage to charge traffic fees";
  this.innerOuterDomainTip =
    "Uses the same domain name for both internal and external network access. Access through the internal network requires the server to configure the internal DNS. ";
  this.fileLifeCycleTip = "Unit day (10-720) default is 180";
  this.innerDomainTip =
    "The server accesses the object storage through this domain name, it is best to configure intranet access, no traffic fee is charged";
  this.fileLifeCycleRange = "must be greater than 10, or less than 720";
  ...
  this.Driver_annual_reputation_distribution =
    "Driver annual reputation distribution";
  this.Corporate_annual_reputation_distribution =
    "Corporate annual reputation distribution";
  this.Grade_distribution = "Grade distribution";
  this.Changes_in_driver_credibility_over_the_years =
    "Changes in driver credibility over the years";
  this.Changes_in_corporate_reputation_over_the_years =
    "Changes in corporate reputation over the years";
  this.Changes_over_the_years = "Changes over the years";
  this.Select_indicator_version = "Indicator version";
  this.Point_warning4 =
    "The lowest score cannot be greater than the highest score";
  this.Change_password_to_enable_SMS_verification =
    "Change password to enable SMS verification";
  this.no_data = "no data";
  ...
  this.supervisionCardStatusAll =
    "Supervision Card Status (0: Assessment and Issuance; 1: Cancellation; 2: Cancellation)";
  this.supervisionCardStatus0 = "Assessment and Issuance";
  this.supervisionCardStatus1 = "Logout";
  this.supervisionCardStatus2 = "Revoked";

  this.displacement_alarm_label = "Displacement/EarlyMorning";
  this.layui_i18n_no_more = "no more";
  this.layui_i18n_load_more = "load more";
  this.layui_i18n_export_tips =
  ...
  this.VerifyMobileVonfirm =
    "The phone number needs to be verified before changing, and we will send the SMS verification code to the current phone number. Current number:";
  this.Resend = "Resend";
  ...
  this.The_password_can_be_changed_after_binding_the_mobile_phone_number =
    "The password can be changed after binding the mobile phone number";
  ...
  this.Enterprise_credit_information_inquiry =
    "Enterprise credit information inquiry";
  this.release_time = "release time";
  this.drive_recorder_speed1 = "Drive Recorder Speed";
  ...
  this.Remote_price_adjustment_management =
    "Remote price adjustment management";
  this.Issuing_remote_freight_documents = "Issuing remote freight documents";
  this.Daytime_one_way_fare_increase_unit_price =
    "Daytime one-way fare increase unit price";
  ...
  this.License_plate_number_of_failed_vehicle =
    "License plate number of failed vehicle:";

  this.match_all_vehicle_rule =
    "This rule matches all vehicles, and the assignment rule operation is not allowed";
  this.device_sim = "Device/SIM";
  this.company_team = "Company/Fleet";
  ...
  this.unfinished_order =
    "Passengers have uncompleted orders and cannot be called temporarily";
  this.already_canceled_order =
    "The order has been cancelled by the driver/passenger";
  ...
  this.rule_match_all_vehicle_tips =
    "This rule matches all vehicles, and the assigned vehicles are not subject to rule judgment";
  ...
  //车辆信息自定义导出列
  this.contacts_phone = "Contact number";
  this.service_start_time = "Service start time";
  this.service_end_time = "Service expiration time";
  ...
  this.needDriver1 =
    "Driver 1 qualification certificate code verification failed";
  ...
  this.excel_err_row_info =
    "Error line : line {placehold1} ,error reason : {placehold2}.";
  this.please_take_custom_template =
    "Please use the download template in the custom import function, and do not modify the header";
  ...
  this.The_unit_price_for_the_second_time_during_the_day =
    "The unit price for the second time during the day";
  this.Unit_price_of_second_air_sticker_at_night =
    "Unit price of second air sticker at night";
  this.Peak_second_time_empty_sticker_unit_price =
    "Peak second time empty sticker unit price";
  this.Starting_price_during_the_day = "Starting price during the day";
  this.Peak_starting_price = "Peak starting price";
  this.Unit_price_for_waiting_time_during_the_day =
    "Unit price for waiting time during the day";
  ...
  this.The_markup_time_is_converted_into_mileage =
    "The markup time is converted into mileage";
  ...
  this.rule_due_reminder_enable_tips =
    "The server has not enabled the related expiration function!";
  this.expiry_type = "Expiry Type";
  this.due_reminder_report = "Embargo Expiration RPT";
  ...
  this.Evaluation_result_reminder =
    "Only if the type is the evaluation result, there will be detailed data!";
  this.Details_of_assessment_results = "Details of assessment results";
  this.Information_has_been_used = "Information has been used";
  this.phone = "cellphone number";
  ...
  this["report.net_alarm_type_sb_l1_driver_sign"] =
    "Road Sign Identification Event Level One";
  this["user.log.media.upload"] = "Upload Device Parameters";
  this["alarm_type_areaInOut_platform"] = "Entry and Exit Area (platform)";
  this["rear_right"] = "Rear Right";
  this["report.line.trip.month"] = "Line Pass Of Monthly RPT";
  this["rocessing_report_status_complete"] = "Processing Completed";
  this["system.log.sysusr.server.edit"] =
    "{0} information edited, the server number is {1}";
  ...
  this["Driving_license_information_template"] =
    "Import driving license information Excel template (set cell format before entering data. Cell Format> Number Settings> Select Text Mode)";
  ...
  this["report.alarm.driverwork.detail.table"] =
    "driver's working hours detail report";
  this["alarm_GSensorStop"] = "GSensor Stop";
  ...
  this["system.log.sysusr.device.resale"] =
    "Removed device(s): device ID: {0}, removed from customer account {1} to customer account {2}";
  ...
  this["system.log.sysusr.deletetip"] =
    "If the user name is unknown, the server information is probably deleted";
  this["taxi_driver_work_mileage"] = "On-duty Mileage";
  this["sb_l1_device_failure_reminder"] =
  ...
  this["unuse_Beidou_satellite"] = "Unuse Beidou satellite for positioning";
  this["export.department"] = "Company";
  this["notPerformed"] = "Not Performed";
  ...
  this["report.cb.Enterprise.Abnormal.car.forbidden"] =
    "The passenger car is forbidden";
  this["associated_vehicle"] = "Associated Vehicle";
  this["taxi_goods_lost_type_five"] = "Other";
  this["supervision_alarmNightTitle"] = "Early Morning Operation";
  ...
  this["Transport_certificate_information"] =
    "Transport certificate information";
  ...
  this["net_alarm_type_sb_l1_driver_auto"] =
    "Automatic Capture Event Level One ";
  this["vehicle.download.template"] =
    "Import Vehicle EXCEL Template(Set cell format before entering data). Cell Format > Number Settings > Select Text Mode)";
  ...
  this["importModel.markType"] =
    "Map Marker Type (Not null.  1: point 2: rectangular 3: polygon 4: route 10: circle)";
  this["vehiWorkDaySummary"] = "Vehicle Work Summary";
  ...
  this["autoUpgrade_type"] = "Upgrade Type";
  this["report.cb.Enterprise.speeding.Overdrive.start"] =
    "Overdrive start position";
  ...
  this["Transport_certificate_template"] =
    "Import Excel template of transport certificate information (set cell format before inputting data. Cell Format> Number Settings> Select Text Mode)";
  this["Invalid"] = "invalid";
  this["taxi_status_task"] = "Appointment (task car)";
  this["monitor_disk2"] = "Disk 2 ";
  ...
  this["monitor_accOpen"] = "ACC On";
  this["system.log.sysusr.server.gpsdb"] =
    "GPS database information editing. GPS database ID is {0}, GPS database name is:{1}";
  this["taxi_camera_status_disconnect"] = "Communication Disconnection";
  this["subiao_tire"] = "Tire Pressure Alarm Evidence";
  this["haiju_user_lookup_type_th"] = "Lookup Type";
  ...
  this["report.cb.check.vehicle.View.location"] =
    "View location (number of vehicles)";
  ...
  this["system.log.sysusr.server.login"] =
    "Edit the information of login server";
  this["report_pointNoArrive_platform"] =
    "Key Point Not Arriving Alarm (platform)";
  this["velocityType_km"] = "KM";
  this["taxi_alarm_clock_error"] =
    "The Real-Time Clock of The Metering Device Exceeds the Specified Error Range";
  this["efficient"] = "Efficient";
  ...
  this["driver_run_licheng"] = "Cumulative Driving Mileage(KM)";
  this["monitor_accClose"] = "ACC Off";
  this["account.download.template"] =
    "Import User EXCEL Template (Recommended Cell Format > Digital Settings > Select Text Mode)";
  this["alarm_name_1000Count"] = "Forward Count";
  this["taxi_alarm_forbidden_road"] = "Forbidden Road";
  ...
  this["police.download.template"] =
    "Import Police Officer EXCEL Template (recommended Cell Format > Digital Settings > Select Text Mode)";
  this["user.log.login.login"] =
    "User login system, client address: {0}, type: {1} ";
  ...
  this["taxi_goods_lost_use_phone"] = "Registrant TEL NO.";
  this["forwardReverseSummaryRpt"] = "Forward Reverse Summary";
  this["report.deviceModify.simMolectronCode"] =
    "SIM Integrated Identification Code";
  this["G_SensorTable_Detail"] = "G-Sensor Alarm Detail";
  this["realTime"] = "(02H)Acquisition Recorder Real Time Clock";
  this["report.pos.psrate.height.error"] = "Height Errors";
  this["vehicle.date_purchase"] = "Date of purchase of the vehicle";
  this["taxi_driver_qualification_certificate_number"] =
    "Driver Qualification Certificate Number";
  this["user.log.content"] = "Description ";
  this["steeringWheelAngle"] = "SteeringWheelAngle";
  this["dangerous_driver_alarm"] = "Dangerous Driving Behavior Alarm";
  this["report.company.vehicle.speed"] = "Overspeed Total";
  this["nomalErrorCount"] = "Nomal Count";
  this["import_isNotEmpty_null"] =
    "(No need to fill in, the system automatically calculates)";
  this["report.boarding"] = "Boarding";
  this["taxi_out_town_out_time"] = "Out Town Time";
  this["report.user.log.sendControl"] =
    "Send Control Command (Off Oil, Power Off)";
  this["taxi_goods_lost_type_two"] = "Clothing Shoes And Bags";
  this["login_ip"] = "Login IP";
  ...
  this["report.net_alarm_type_sb_l2_driver_sign"] =
    "Road Sign Identification Event Level Two";
  this["trajectoryAnalysisSummaryRPT"] = "Trajectory Analysis Summary RPT";
  this["report.cb.Enterprise.video.table"] =
    "Enterprise video inspection summary table";
  ...
  this["system.log.server.deletetip"] =
    "Notice: If the server name is unknown, the server information is probably deleted!";
  this["driverNumberOfSecondaryAlarms"] = "Driver Number Of Secondary Alarms";
  this["dispatcher_addMember"] = "Add group members";
  this["monitor_overSpeed"] = "Overspeed";
  ...
  this["report.cb.Enterprise.speeding.sustained"] =
    "Vehicle sustained speeding summary table";
  this["monitor_3gPoor"] = "Network Signal Poor";
  this["open_door_driver"] = "Door 4 open (driver door)";
  this["position_abnormal_alarm"] =
    "Location Information Exception Alarm(platform)";
  ...
  this["net_alarm_type_sb_l2_driver_active"] =
    "Active Snapshot Event Level Two";
  this["taxi_driver_open_time"] = "Boot Time";
  ...
  this["report.cb.Enterprise.speeding.50%.5.10"] =
    "Speeding 50% (inclusive) 5 (inclusive) -10 minutes";
  ...
  this["report.deviceModify.storageMediumSize"] =
    "Video Storage Media Capacity";
  ...
  this["alarm_name_340"] = "Gather Alarm (platform)";
  this["report.cb.Enterprise.speeding.Vehicle.sustained"] =
    "Vehicle sustained speeding schedule";
  this["open_door_back"] = "Door 3 open (back door)";
  this["transportDistanceDistributionDriver"] =
    "Transport Distance Distribution Driver";
  ...
  this["report.cb.Enterprise.speeding"] =
    "Enterprise sustained speeding summary table";
  this["taxi_evaluation_complaint"] = "Complaint";
  this["report.speed.track"] = "Speed Analysis";
  this["operating.maturity.duration"] =
    "{0} Days Transport Certificate Expires";
  ...
  this["vehicle_offline_handle"] =
    "End warning (new) (alarm has been processed)";
  this["mileage_today"] = "Mileage Today";
  ...
  this["report.platform.regionalSpeedingAlarm"] =
    "Regional Speeding Alarm (Platform)";
  this["gps_alarm_type_leavejob"] = "Get Off Work";
  this["vehicle.plateType.black"] = "Black Label";
  this["report.platform.areaPoint"] =
    "The Key Point Monitoring Alarm (Platform)";
  this["taxi_alarm_fatigue"] = "Physiological Fatigue Alarm";
  ...
  this["number_of_attachments"] = "Attachments NO.";
  this["taxi_order_people_number"] = "Guests NO.";
  this["taxi_alarm_evaluator"] =
    "Service Evaluator Failure (front and rear row) ";
  this["report.user.log.informationDemand"] = "Information Demand";
  this["report.alarm.detail.turnoff"] = "Main Power Off Detail";
  this["report_smsfatigue_driver_detail"] = "Fatigue Drive Detail(platform)";
  this["system.log.sysusr.server.add"] =
    "{0} information added, the server number is {1}";
  this["driver_swipe_issue"] = "Issuing Authority";
  ...
  this["tyreAlarmSummaryRpt"] = "Tire Alarm Summary Rpt";
  this["report.cb.Enterprise.speeding.20%.50%.5"] =
    "Speeding 20 (inclusive) -50% within 5 minutes";
  ...
  this["overspeed_single_vehicle"] = "Single Vehicle Speed Profile";
  this["brakeState"] = "Brake State";
  this["report.cb.Enterprise.Abnormal.Driving"] =
    "Summary Table of Enterprise 's Abnormal Driving";
  this["rocessing_report_status_future"] = "Future Rrocessing";
  this["rocessing_report_status_noHandle"] = "Not Rrocessed";
  ...
  this["net_alarm_type_sb_l2_driver_auto"] =
    "Automatic Capture Event Level Two";
  ...
  this["report_haiju_company_summary"] = "Enterprise Online RPT";
  this["alarm_name_939"] = "Platform Probe Occlusion Alarm";
  this["importModel.department"] =
    "Company (Not empty current account corresponding to the company and subsidiaries)";
  ...
  this["car_province_type23"] = "Sichuan Province";
  this["ICReadResult2"] =
    "Card Reading Failed Because The Card Has Been Locked";
  this["car_province_type22"] = "Chongqing";
  this["ICReadResult1"] =
    "Card Reading Failed Because The Card Key Authentication Failed";
  this["alarm_name_912"] = "Platform Physiological Fatigue Alarm";
  ...
  this["car_province_type18"] = "Hunan Province";
  this["car_province_type17"] = "Hubei Province";
  this["system.log.sysusr.server.downstation.edit"] =
    "Edit download site: ID: {0}, Name: {1}";
  ...
  this["system.log.sysusr.client.del"] =
    "Customer information deleting, the login account is {0}";
  ...
  this["dynamic_check_platform_success"] =
    '"Dynamic check success (platform)";';
  this["vehicleTypeDes"] = "Vehicle Type Description";
  this["report.cb.check.vehicle.enterprise"] =
    "Enterprise check vehicle statistics report";
  this["haiju_version_detail_softInner"] = "Internal Version NO.";
  this["satelliteSpeed"] = "SatelliteSpeed(1/10km/h)";
  this["vehicle_current_speed_limit_value"] =
    "Vehicle Current Speed Limit Value";
  this["belong_company"] = "Company";
  ...
  this["sb_l2_device_failure_reminder"] =
    "Equipment Failure Reminder Alarm Level 2";
  ...
  this["report.cb.Enterprise.speeding.50%.5"] =
    "Speeding 50% (inclusive) within 5 minutes";
  this["report.net_alarm_type_sb_l2_frequent_lane_change"] =
    "Frequent Lane Change Level Two";
  ...
  this["half_load"] = "half load";
  this["system.log.sysusr.client.resetpwd"] =
    "User password reset, the login account is {0}";
  this["user.log.detail"] = "User Action Log ";
  this["terminal.type"] = "Type";
  this["taxi_driver_metering_device_k_value"] =
    "Tax Calculation Device K Value";
  this["report.cb.Enterprise.speeding.20%.5"] =
    "Speeding less than 20% within 5 minutes";
  ...
  this["importModel.color"] =
    "Color (Map mark type can be set except point). Format: Sixteen hexadecimal color code. Default: FF0000)";
  this["taxi_storage_type_SD_card"] = "SD Card";
  ...
  this["system.log.sysusr.login"] =
    "User login the system, login address is {0}";
  this["alarm_engine_speed_threshold_tips"] = "Alarm engine speed threshold:";
  ...
  this["report.cumulativeDayDrivingTimeout"] =
    "Day Cumulative Driving Timed Out";
  this["report.cb.Enterprise.Vehicle.Checklist"] =
    "Vehicle Video Patrol Checklist";
  ...
  this["autoUpgrade_type_blind"] = "BSD";
  this["unuse_gps_satellite"] = "Unuse GPS satellites for positioning";
  this["system.log.sysusr.device.del"] =
    "Device information deleted Device number is {0}";
  ...
  this["report.alarm.doorAbnormal2"] =
    "Car left the station did not close the door";
  ...
  this["report.dailyOnline.title"] =
    "Reporting On The Company's Vehicle Line Rate Day";
  this["taxi_goods_lost_time"] = "Lost Date";
  ...
  this["report.user.log.correctionNetworkTrafficSummary"] =
    "Correct Network Traffic Statistics";
  ...
  this["report_userReport_queryType"] = "Query Alarm Type";
  this["driver_identification_event_matching_success"] = "Match Success";
  this["system.log.sysusr.server.storagerelation.add"] =
    "Add storage associated: Server ID: {0}, Server IDNO: {1}, Device IDNO:{2}";
  ...
  this["alarm_type_InadequateOrTooLongRoadTravelTime"] =
    "Roads and The Lack of Time or Too Long";
  this["vehicle.ImportDrivingLicense"] =
    "(Cannot be empty. Unique identifier. And has been created)";
  this["signin.driverName"] = "Driver's Name";
  this["vehicleRiskPortrait"] = "Vehicle Risk";
  this["record_threshold"] = "Record threshold";
  this["last_start_speeding"] = "Continuous Speeding";
  this["report.alarm.norepositioning.detail.table"] =
    "No Repositioning Detail RPT";
  ...
  this["battery_voltage_none"] = "Battery Voltage";
  this["report.cb.Enterprise.information.Send.personnel"] =
    "Send the personnel";
  this["taxi_complaint_type_seven"] = "Incorrect use of the meter";
  this["taxi_alarm_secure"] = "Security Access Module Failure";
  this["report.cb.Enterprise.speeding.50%.10"] =
    "Speeding 50% (inclusive) 10 (inclusive) minutes or more";
  this["eastLongitude"] = "EastLongitude";
  ...
  this["alarm_type_other_video_device_fault"] =
    "Other Video Device Fault Alarm";
  ...
  this["report.company.vehicle.speedTimes"] =
    "Average Speed of Vehicle Overspeed";
  this["subiao_count_kilometers"] = "Times/100KM";
  ...
  this["trajectoryAnalysisDetailRPT"] = "Trajectory Analysis Detail RPT";
  this["instantaneousFuelConsumption"] = "Instantaneous Fuel Consumption";
  this["report.cb.check.vehicle.history.track.times"] =
    "View history track (times)";
  this["taxi_driver_work_close_time"] = "On-duty Shutdown Time";
  this["cancel"] = "Cancel";
  this["report.normal.monthly"] = "Monthly Mileage Detail";
  this["report.trace.integrity.rate.detail.title"] =
    "Vehicle Trajectory Loss Detail";
  ...
  this["system.log.sysusr.server.downstation.add"] =
    "Add download site: ID: {0}, Name: {1}";
  this["device_serial"] = "Device Serial NO.";
  ...
  this["agent"] = "agent";
  this["monitor_3gExcellent"] = "Network Signal Excellent";
  this["report.net_alarm_type_sb_l2_driver_active"] =
    "Active Snapshot Event Level Two";
  this["recognitionResult"] = "Recognition Result";
  this["report.qualificationCertificateCoding"] =
    "Qualification Certificate Coding:";
  this["east"] = "East";
  ...
  this["plugin_online_status"] = "Online Status";
  this["no"] = "No";
  this["gps_alarm_type_overspeed_l3_ten_more"] =
    "Speeding 50%, 10 (Inclusive) Minutes Or More";
  this["export.company"] = "Company";
  this["taxi_operation_data_detail_report"] = "Operating Income Data Detail";
  this["report.device"] = "Device";
  this["taxi_evaluation_satisfaction"] = "Satisfaction";
  this["export.productBrand"] = "Product Brand";
  this["taxi_alarm_unrecognize"] =
    "Driver Face Recognition Does Not Match Alarm";
  this["report.vehicleModify.module_taxiMeter"] = "TaxiMeter";
  this["alarm_gps_sd"] = "SD";
  this["Black.screen.channel.number"] = "Channel NO.";
  this["Vehicle_technical_grade_assessment_due_time"] =
    "Vehicle technical grade assessment due time";
  this["intake_air_temperature_none"] = "Fuel Intake Temperature";
  ...
  this["IndustryType.logistics"] = "cargo freight";
  this["ptt_terminal"] = "PTT Terminal";
  ...
  this["report.platform.timeOverSpeedAlarm"] =
    "Period Overspeed Alarm (Platform)";
  this["report.alarm.vehiclework.detail.table"] = "Vehicle Work Detail RPT";
  this["report.normal.end.licheng"] = "End Mileage";
  this["system.log.sysusr.server.sysdb"] =
    "System database information editing";
  ...
  this["close_door_middle"] = "Door 2 closed(middle door)";
  this["gather_alarm_vehicle_number"] = "Vehicle Aggregation Number";
  this["report.net_alarm_type_sb_l2_near_car"] =
    "Car Distance Near Alarm Level Two";
  this["obd_detail_report"] = "OBD Detail RPT";
  ...
  this["report.small.classes.in.kindergarten"] =
    "Small Classes In Kindergarten";
  ...
  this["report.cb.vehicle.online.rate"] =
    "Monthly report of vehicle on - line rate";
  this["report.handleTime"] = "Handle Time";
  this["account.role"] =
    "Role Permission (cannot be empty, cannot belong to more than one company)";
  this["Statistical.report.of.alarm.disposal.rate"] =
    "Online Rate Statistics Monthly RPT";
  ...
  this["system.log.sysusr.device.batchdel"] =
    "Device batch deleted: device ID: {0}";
  ...
  this["driver_identification_event_not_enabled"] =
    "This Feature Is Not Enabled";
  this["vehicle.plateType.agriculturalYellow"] = "Agricultural Yellow Card";
  this["importModel.title"] =
    "Map Import Template (Set cell format before entering data). Cell Format > Number Settings > Select Text Mode)";
  this["report.alarm.detail.opendoor"] = "Illegal Open Door Alarm Detail";
  this["report.alarm.enterprice"] = "owned company";
  ...
  this["taxi_status_vehicle_no_limit"] =
    "Limit Number Of Operations / Time Not Reached";
  this["system.log.sysusr.device.sale"] =
    "Sold device(s): device ID :{0}, customer account:{1}";
  ...
  this["system.log.sysusr.client.edit"] =
    "Customer information editing, the login account is {0}";
  ...
  this["gps_alarm_type_overspeed_l1_five_to_ten"] =
    "Speed 20%, 5 (Inclusive) -10 Minutes";
  this["autoUpgrade_result7"] = "Equipment does not support peripherals";
  this["autoUpgrade_result6"] = "Equipment does not support";
  this["report_GNSSAntennaShort"] = "GNSS Antenna Short Circuit";
  this["autoUpgrade_result5"] = "Failure to upgrade";
  ...
  this["no_target_dev"] = "No Target Device Found";
  this["report.cb.check.vehicle.transport.enterprises"] =
    "Owned road transport enterprises";
  this["totalDataBlocks"] = "TotalDataBlocks";
  ...
  this["alarm_type_abnormal_driving_behavior"] =
  ...
  this["loaded"] = "full";
  this["report.parameterConfigurationReport"] =
  ...
  this["system.log.sysusr.device.batchresale"] =
    "Bulk transfer device: Device Number: {0}, {1} from the customer account is transferred to the customer account {2}";
  this["taxi_goods_lost_status_return"] = "Returned";
  ...
  this["taxi_m1_Card_transaction_type"] = "M1 Card Transaction";
  this["zfpt_operation_id"] = "Platform Access Code";
  this["alarm_type_night_overSpeed_platform"] =
    "Night Overspeed Alarm(Platform)";
  ...
  this["neutral"] = "Neutral";
  this["report.vehicleModify.module_oilSensor"] =
    "Fuel Sensor (Detecting vehicle fuel)";
  ...
  this["account.department"] = "Company";
  this["report.oil.oilDec"] = "Fuel Reduction";
  this["stop_rest"] = "Parking Break";
  this["plugin_event"] = "Event";
  this["driver2.job_num"] = "Driver 2 Qualification Number";
  this["report.cb.Enterprise.speeding.20%.50%.10"] =
    "Speeding 20 (inclusive) -50% below 10 (inclusive) minutes or more";
  this["plate_number"] = "Plate No.";
  this["forwardReverseDetailRpt"] = "Forward Reverse Detail";
  this["taxi_goods_lost_desc"] = "Property Desc";
  ...
  this["subiao_vehicleGradeArmSummary"] = "Vehicle Rating RPT";
  this["stop_force"] = "Forced Parking";
  this["report.platform.regionalLowSpeedAlarm"] =
    "Regional Low Speed Alarm (Platform)";
  ...
  this["taxi_camera_status_lost"] = "Video Loss";
  this["vehicle_offline_online"] = "End warning (new) (device online)";
  this["report.vehicleModify.module_oilControl"] =
    "Fuel line controller (off the fuel and the fuel recovery)";
  this["alarm_name_144_Rpt"] = "Distribution Plate Rpt";
  this["alarm_name_745"] = "One-Handed Steering Wheel Alarm";
  ...
  this["report.vehicleModify.module_elecControl"] =
    "Circuit controller (cutoff circuit and recovery circuit)";
  this["driver_work_times"] = "Cumulative Driving Time";
  ...
  this["report.cb.Road.User.User.Online"] =
    "User Online Monthly Statistics Monthly Report ";
  ...
  this["report.platform.roadAbnormalPosition_tip"] =
    "Intervals:{0} seconds, Separation distance:{1} m";
  this["muck_truck_cover_detail"] = "Area Illegal Opening Detail";
  this["line.over.speed"] = "Speed (Times)";
  this["alarm_name_708"] = "Driver Not Detected Alarm ";
  this["gps_alarm_type_overspeed_l2_ten_more"] =
    "Speeding 20%-50% 10 (Inclusive) Minutes Or More";
  ...
  this["taxi_order_wait_time"] = "Wait Time";
  this["alarm_name_1001TimeLength"] = "Reverse Rotation Time";
  this["report.fence.count"] =
    "Total Number Of Entering And Exiting The Region";
  ...
  this["sb_l1_intersection_quickly_passed"] =
    "Intersection Quickly Passed Alarm Level 1";
  this["autoUpgrade_type_dsm"] = "DSM";
  this["sb_l2_driver_assistance_failure"] =
    "Driving Assistance Function Failure Alarm Level 2";
  this["report.class.name"] = "Class";
  this["report.cb.Enterprise.Abnormal.Mountain.road"] =
    "Mountain road forbidden";
  this["pulseSpeed"] = "PulseSpeed";
  ...
  this["report.cb.Enterprise.information.summary.table"] =
    "Enterprise scheduling information summary table";
  ...
  this["muck_truck_overload"] = "Load Overload (platform)";
  this["report_alarm_type_verify_through"] =
    "Driver Verifies The Passing Event";
  this["middle_right"] = "Middle Right";
  this["report.cb.Enterprise.video.Vehicle"] =
    "Vehicle video inspection summary table";
  this["signs_height"] = "High Limit Sign";
  this["report.clutch"] = "Clutch";
  this["taxi_transaction_money"] = "Transaction Amount";
  this["report_pointNoLeave_platform"] =
    "Key Point  Not Leave Alarm (platform)";
  this["Starting_fence"] = "Starting Fence";
  ...
  this["taxi_emergency_plan_creater"] = "Creator";
  this["vehicle.operating_end_date"] =
    "The expiry time of the transport certificate";
  ...
  this["executionTime"] = "Execution Time";
  this["report.user.log.clearNetworkTrafficSummary"] =
    "Clear Network Traffic Statistics";
  this["audio_down"] = "Voice Delivery";
  ...
  this["report.user.log.getNetworkTrafficInfo"] =
    "Get Network Traffic Information";
  this["Number.of.passengers"] = "Number of passengers";
  this["import.channel.parameters"] =
    'Channel Parameters (Multi channel parameters using English comma "," for segmentation)';
  this["account.password"] =
    "Password (do not fill, using the default: 000000)";
  ...
  this["plugin_login_time"] = "Login Time";
  this["gps_alarm_type_overspeed_l2_five_to_ten"] =
    "Speeding 20%-50% 5 (Inclusive) -10 Minutes";
  this["alarm_type_video_lost_status"] = "Video Lost";
  this["report.cb.check.vehicle.Total"] = "Total Vehicles";
  this["report.idle"] = "Idle";
  this["net_alarm_type_sb_l1_driver_active"] =
    "Active Snapshot Event Level One";
  this["account_type"] = "Account Type";
  this["report.labelCount"] = "(count)";
  this["sb_l2_change_driver"] = "Substitution Driving Alarm Level 2";
  this["report_abnormalPosition_platform"] = "Offline displacement(platform)";
  this["sb_l2_driver_monitoring_failure"] =
    "Driver Behavior Monitoring Function Failure Alarm Level 2";
  this["yAxisAcceleration"] = "YAxisAcceleration";
  this["report.kindergarten.intermediate"] = "Kindergarten Intermediate";
  this["report.net_alarm_type_sb_l1_frequent_lane_change"] =
    "Frequent Lane Change Level One";
  ...
  this["report_userReport_queryRange"] = "Query Time Range";
  this["report.cb.Enterprise.speeding.Overdrive.end"] =
    "Overspeed end position";
  this["taxi_evaluation_none"] = "No Evaluation";
  ...
  this["report.deviceModify.transportEnterprise"] =
    "Belong Transportation Enterprise";
  this["muck_truck_overload_alarm"] = "Load Overload (platform)";
  ...
  this["vehicle.importSim"] =
    "(Not empty. New SIM card or SIM card not installed)";
  this["judge_vehicle_oddline"] = "Judge the threshold";
  ...
  this["taxi_complaint_type_ten"] = "Not pulled to the destination";
  this["plugin_slave_link"] = "Slave Link";
  this["import.driverLicenseValidStartTime"] =
    "Driver's License Effective Start Time";
  this["driver.download.template"] =
    "Import Driver EXCEL Template(Set cell format before entering data). Cell Format > Number Settings > Select Text Mode)";
  this["alarm_type_lowSpeed_platform"] = "Period of Low Speed Alarm (platform)";
  this["report.trip.goods.amount"] = "Quantity of transportation goods";
  this["reportInfo.temperature"] = "Current temperature:";
  this["report.cb.Enterprise.Abnormal.vehicle.operation"] =
    "Schedule of abnormal vehicle operation";
  this["companySafetyReport"] = "Co.Safety Rpt";
  this["reportInfo.people"] = "Car / pedestrian distance: ";
  this["report.pos.psrate.title"] = "Vehicle Positioning Rate RPT";
  this["report.net_alarm_type_sb_l1_road_marking_over_limit"] =
    "Road Sign Overrun Alarm Level One";
  this["currentMileage"] = "Current Mileage";
  ...
  this["taxi_emergency_plan_reason"] = "Emergency Cause";
  this["use_GLONASS_satellite"] = "Use GLONASS satellite for positioning";
  this["report.cb.vehicle.online.Monthly.report"] =
    "Monthly report of enterprise vehicle online rate";
  ...
  this["report.cb.Enterprise.information.Vehicle.list"] =
    "Vehicle scheduling information list";
  ...
  this["gps_alarm_type_overspeed_l3_five_less"] =
    "Speeding 50%,Within 5 Minutes";
  this["report.obd.detail"] = "OBDII Detail";
  this["report.probe.no"] = "Probe Name";
  this["system.log.server.online"] = "Server is online";
  this["report.fence.totaltime"] =
    "Total Time Of Entering And Exiting The Region";
  ...
  this["report_userReport_queryRule"] = "Query Rules";
  this["sb_l2_intersection_quickly_passed"] =
    "Intersection Quickly Passed Alarm Level 2";
  ...
  this["alarm_name_626"] = "Driver Abnormal Alarm ";
  this["alarm_name_624"] = "Distracted Driving Alarm";
  this["net_alarm_type_sb_l1_driver_sign"] =
    "Road Sign Identification Event Level One";
  this["alarm_name_622"] = "Smoking Alarm";
  this["report.alarm.sum.drivername"] = "driver name";
  this["alarm_name_620"] = "Call Alarm ";
  this["report.net_alarm_type_sb_l1_fatigue_driving"] =
    "Physiological Fatigue Alarm Level One";
  this["net_alarm_type_sb_driver_identification_unknown"] = "Unrecognized";
  this["report.cb.Enterprise.speeding.20%.10"] =
    "Speeding 20% below 10 (inclusive) minutes or more";
  this["alarm_rapid_tturnright"] = "Sharp Right Turn";
  this["io_status"] = "IO Status Bit";
  this["alarm_time_threshold_unit"] = "(second)";
  this["report_GNSSAntennaMissedOrCut"] = "GNSS Antenna Missed or Cut";
  ...
  this["report_haiju_company_vehicle_online"] = "Online Vehicle NO.";
  this["report.cb.check.vehicle.history.track"] =
    "View history track (number of vehicles)";
  ...
  this["system.log.sysusr.client.add"] =
    "Customer information adding, the login account is {0}";
  this["alarm_low_battery_voltage"] = "Battery Low Pressure Alarm";
  this["taxi_complaint_user"] = "Complainant";
  ...
  this["sdcard"] = "SD Card";
  this["report.platform.roadLvlOverSpeed"] =
    "Road Class Overspeed Alarm (platform)";
  this["system.log.sysusr.server.del"] =
    "{0} information deleted, the server number is {1}";
  ...
  this["gps_alarm_type_overspeed_l1_ten_more"] =
    "Speeding 20%, 10 (Inclusive) Minutes Or More";
  this["gps_alarm_type_overspeed_l2_five_less"] =
    "Speeding 20%-50% Within 5 Minutes";
  this["taxi_goods_lost_status_find"] = "Recovered";
  ...
  this["report.cb.check.vehicle.inspection"] =
    "Vehicle inspection statistical tables";
  ...
  this["zAxisAcceleration"] = "ZAxisAcceleration";
  this["user.login.resetPwd.content"] =
    "{0} have received your password reset request, please click the button below to reset your password within 24 hours.";
  this["sb_l1_driver_assistance_failure"] =
  ...
  this["report.cb.Enterprise.information.Vehicle"] =
    "Vehicle scheduling information summary table";
  this["taxi_order_have_away"] = "Taxi Kilometers";
  this["acc_signal_abnormal"] = "ACC Signal Abnormal Alarm(platform)";
  this["report.net_alarm_type_sb_l2_hit_pedestrian"] =
    "Pedestrian Collision Alarm Level Two";
  this["plugin_port"] = "Port";
  this["driver_card_not_inserted"] = "Driver Card Is Not Inserted";
  ...
  this["report.InadequateOrTooLongRoadTravelTime"] =
    "Roads and The Lack of Time or Too Long";
  this["haiju_user_lookup_answered_timeout"] = "Timeout Reply";
  ...
  this["user.log.login.logout"] =
    "User exits the system, client address: {0}, type: {1}";
  ...
  this["mountain_road_ban"] = "Mountain Road Ban";
  this["account.strongPassword"] =
    "Password (strongly used, the password length is 8-12 digits, Must contain numbers, uppercase and lowercase letters)";
  ...
  this["gps_alarm_type_overspeed_l3_five_to_ten"] =
    "Speed 50%, 5 (Inclusive) -10 Minutes";
  ...
  this["system.log.sysusr.device.add"] =
    "Device information added. Device number is {0}";
  this["report.user.log.locationTrack"] = "Location Track";
  this["operating_num"] = "Operator License NO.";
  this["report.alarm.areaName"] = "Area Name";
  this["on_the_way_offline_alarm"] = "On The Way Offline Alarm";
  this["report.get.off"] = "Get Off";
  this["report.cb.Road.User.Corporate"] =
    "Corporate Monthly Monthly Statistics ";
  ...
  this["taxi_out_town_return_time"] = "Estimated Return Time";
  this["date_of_birth"] = "Date Of Birth";
  this["report.student.card.record.detail"] =
    "Student Credit Card Record Sheet";
  this["taxi_storage_error_read_write"] = "Storage Read And Write Error";
  this["sb_l1_driver_monitoring_failure"] =
  ...
  this["gps_alarm_type_overspeed_l1_five_less"] =
    "Speeding 20%,Within 5 Minutes";
  this["muck_truck_cover_summary"] = "Area Illegal Opening Summary ";
  ...
  this["vehicle_extra_status"] = "Extended Vehicle Signal Status";
  this["operation_device"] = "Equipment Number (IMEI)";
  this["service.maturity.duration"] =
    "{0} Days After The Expiration Of Service";
  ...
  this["taxi_alarm_roof_light"] = "Cruise Car Roof Light Failure";
  this["gps_alarm_type_end_hdd_high_temperature"] =
    "Over Temperature Alarm For Hard Disk";
  this["report.content"] = "Content";
  this["Effective_time"] = "Effective time";
  this["report.alarm.totaltime"] = "Alarm Time";
  this["min_hour"] = "Hour";
  this["report.net_alarm_type_sb_l2_fatigue_driving"] =
    "Physiological Fatigue Alarm Level Two";
  this["report.armType"] = "Alarm Type";
  this["report.cb.Enterprise.speeding.20%.5.10"] =
    "Speeding 20% or less 5 (inclusive) -10 minutes";
  this["report.netflow.monthLimit"] = "Month Limit(MB)";
  this["car_transport_place"] = "Vehicle Place";
  this["user.log.media.upgrade"] = "Device Remote Upgrade";
  this["vehicle_technical_rating_has_expired"] =
    "Vehicle technical rating has expired";
  this["reportInfo_grade_label"] = "Alarm Level";
  ...
  this["export.dispatcher.beforeGroupName"] = "Old Cluster Group name:";
  ...
  this["report.net_alarm_type_sb_l1_driver_active"] =
    "Active Snapshot Event Level One";
  this["report.cb.check.User.statistical"] =
    "User vehicle sampling statistical report";
  ...
  this["report_areaType_platform"] = "Out Regional Alarm (platform)";
  this["alarm_type_areaLowSpeed_platform"] =
    "Regional Low-speed Alarm (platform)";
  this["unreset_travel_alarm"] = "Unreset Travel Alarm";
  this["alarm_type_video_signal_loss"] = "Video Signal Loss Alarm";
  this["user.log.media.recsearch"] = "Video Search";
  this["Number.of.Vehicles.Entering.the.Network"] =
    "Number of Vehicles Entering the Network";
  ...
  this["account.validity"] =
    "Validity Period (yyyy-MM-DD format. Example: 2016-1-1)";
  this["road.state"] = "State Road";
  this["Insurance_information_template"] =
    "Import insurance information Excel template (set cell format before entering data. Cell Format> Number Settings> Select Text Mode)";
  this["system.log.sysusr.device.batchsale"] =
    "Device batch sold: Customer account{0}, device ID {1}";
  this["report.platform.roadAbnormalPosition"] =
    "Offline Displacement(Platform)";
  this["main_memory_failure"] = "Main Memory Failure";
  this["report.cb.Enterprise.Abnormal.vehicle"] =
    "Summary of vehicle abnormal driving";
  ...
  this["system.log.sysusr.server.storagerelation.del"] =
    "Del storage associated: Server ID: {0}, Server IDNO: {1}, Device IDNO:{2}";
  ...
  this["in_group"] = "Entry";
  this["averageFuelConsumption"] = "Avg Fuel Consumption(L/100km)";
  this["net_alarm_type_sb_l2_driver_sign"] =
    "Road Sign Identification Event Level Two";
  this["front.door.number.up"] = "Front Boarding";
  this["system.log.sysusr.device.edit"] =
    "Device information edited. Device number is {0}";
  ...
  this["report.user.log.sendSchedulingInstruction"] =
    "Issued Dispatch Instruction";
  this["no_support_soft"] = "The Software Not Support";
  ...
  this["report.driverStatusCollection"] =
    "Driver Identity Information Acquisition";
  ...
  this["report.user.log.setNetworkTrafficInfo"] =
    "Set Network Traffic Information";
  this["system.log.sysusr.server.downstation.del"] =
    "Delete download site: ID: {0}, Name: {1}";
  ...
  this["system.log.sysusr.device.batchadd"] =
    "Device information batch added. Device ID: {0}, total number:{1}";
  this["alarm_type_electric_off"] = "Circuit Disconnect";
  ...
  this["report.cb.Enterprise.speeding.20%.50%.5.10"] =
    "Speeding 20 (inclusive) -50% 5 (inclusive) -10 minutes";
  this["report.platform.timeLowSpeedAlarm"] =
    "Period of Low Speed Alarm (Platform)";
  ...
  this["Trip_statistics_report"] = "Trip Statistics RPT";
  this["report.cb.Enterprise.speeding.Overspeed.start"] =
    "report.cb.Enterprise.speeding.";
  this["OBDSpeed"] = "OBD Speed";
  this["terminal.pay.enable"] = "Enabled Payment";
  this["report.net_alarm_type_sb_l2_road_marking_over_limit"] =
    "Road Sign Overrun Alarm Level Two";
  this["taxi_transaction_have_time"] = "Taxi Time";
  ...
  this["account.state"] =
    "Status (0 for disabled, 1 for application, 2 for deletion)";
  ...
  this.alarm_name_139 = "Unclosed Cover of Heavy Car(139)";
  ...
  this.Del_Plan_reminder =
    "Options that already have an evaluation record will not be executed!";
  this.Monthly_report_on_online_rate = "Monthly report on online rate";
  this.Online_rate_description1 =
    "Online rate = If there is a GPS on the day, it is counted as 100%, otherwise it is 0%.";
  this.Online_rate_description2 =
    "On-line rate = vehicles on the line/total number of vehicles 100%.";
  ...
  this.checkLedgerExcelTitle =
    "Road transport vehicles dynamic monitoring daily control inspection registration ledger";

  this.delete_vehicle_role =
    "If the vehicle has been assigned the role, the corresponding role permissions will be removed!";
  ...
  this.Online_rate_description3 =
    "On the same day, the vehicle is online rate = 10 minutes as a time piece, divided into 144 time films one day; each time piece 10 minutes, there is a GPS, think that the time film is online; the number of time tablets online this day / 144 * 100%";

  this.companyNotAuthError = "No company operation authority";
  this.area_cannot_be_empty =
    "The pick-up area and the drop-off area cannot be empty at the same time";
  ...
  this.The_evaluation_result_was_not_found =
    "The evaluation result was not found";
  this.Driver_Credit_Information_Template =
    "The current driver is {0}, and the driver has an excellent credit rating";
  this.Corporate_Credit_Information_Template =
    "The current vehicle is operated by the {0} company, with an excellent corporate credit rating";
  this.after = "after";

  this.intelligent_risk_control_operation_report =
    "Intelligent risk control operation report";
  this.day_licheng_des =
    "The total mileage of this day is {0} KM, and the average mileage of vehicles is {1} KM.";
  ...
  this.statistics_illegal_vehicles_alarm =
    "Vehicle violation type alarm statistics";
  this.alarmhandlecount_ring = "Loop comparison of alarm processing number";
  this.illegal_vehicles_alarm_des =
    "There are {0} times of minor violation, general violation and serious violation (respectively) alarms triggered during driving, which is {1}% compared with the number of alarms yesterday.";
  this.illegal_vehicles_alarm_des2 =
    "Overspeed alarm is the main risk of vehicle operation. It is necessary to pay attention to and report the driver's driving status and driving time. When the risk occurs, timely intervention should be carried out.";
  this.illegal_vehicles_alarm_des3 =
    "The following table lists the top 10 vehicles with high risk of speeding violation (platform) on that day (Statistics of level and duration, priority of level)";
  this.illegal_vehicles_alarm_des4 =
    "The following table lists the top 10 vehicles with high risk of fatigue driving violation (platform) on the same day";
  this.illegal_vehicles_alarm_des5 =
    "The following table lists the top 10 vehicles with high risk of early morning operation violation (platform)";
  this.illegal_vehicles_alarm_des6 =
    "The following table lists the top 10 vehicles with high risk of offline displacement violation (platform) on that day";
  this.violation_level = "Violation level";
  this.alarm_duration = "Alarm duration";
  this.safe_assessment_summary =
    "Summary of active safety assessment indicators";
  ...
  this.safe_vehicle_alarm_rank = "Active safety vehicle alarm ranking";
  this.week_licheng_des =
    "The total mileage of this week is {0} KM, and the average mileage of vehicles is {1} KM.";
  this.week_illegal_vehicles_alarm_des =
    "There were {0} times of violation alarms triggered during driving, which was {1}% compared with the number of alarms in last week.";
  this.week_illegal_vehicles_alarm_analysis =
    "Trend analysis of vehicle violation type alarm in the week";
  this.monday = "Monday";
  ...
  this.week_classic_case_des1 =
    "The following table lists the top 10 vehicles with the most severe overspeed violation alarm (platform) this week";
  this.week_classic_case_des2 =
    "The following table lists the top 10 vehicles that reported the most serious violations of fatigue driving this week";
  this.week_classic_case_des3 =
    "The following table lists the top 10 vehicles with the most serious violations of operation alarm in the early hours of this week";
  this.week_classic_case_des4 =
    "The following table lists the top 10 vehicles with the most serious violations of offline displacement (platform) this week";
  this.region = "region";
  this.month_licheng_des =
    "The total mileage of this month is {0} KM, and the average mileage of vehicles is {1} KM.";
  ...
  this.satellite_positioning_driftrate = "Drift rate of satellite positioning";
  this.month_illegal_vehicles_alarm_analysis =
    "Trend analysis of vehicle violation type alarm in a month";
  this.month_illegal_vehicles_alarm_des =
    "There are {0} times of violation alarms triggered during driving, which is {1}% compared with the number of alarms in last month.";
  this.vehicle_speeding_analysis =
    "Analysis of speeding violation alarm: the peak of speeding violation alarm occurred in {0}, and the largest month on month increase occurred in {1}";
  this.vehicle_fatigue_analysis =
    "Analysis of fatigue driving violation alarm: the peak of fatigue driving violation alarm occurred in {0}, and the largest month on month increase occurred in {1}";
  this.vehicle_beforedown_analysis =
    "Analysis of early morning operation violation alarm: the peak of early morning operation violation alarm occurred in {0}, and the largest month on month increase occurred in {1}";
  this.vehicle_offline_analysis =
    "Analysis of off-line displacement violation alarm: the peak of off-line displacement violation alarm occurred in {0}, and the largest month on month increase occurred in {1}";
  ...
  this.danger_vehicle = "Dangerous goods transport vehicle";
  this.ordinary_vehicle = "General freight";
  this.month_area_alarm =
    "Summary of violation reports of all districts and counties in this month";
  this.high_risk_alarm_analysis = "Analysis of high risk alarm list";
  this.high_risk_alarm_analysis_des1 =
    "Summary of the number of transportation enterprises entering the weekly list of violation alarm in this month";
  this.high_risk_alarm_analysis_des2 =
    "Summary of the number of operating vehicles in the weekly violation alarm ranking list in this month";
  ...
  this.month_classic_case_des1 =
    "The following table lists the top 10 vehicles with the most serious speeding violation alarms (platforms) this month";
  this.month_classic_case_des2 =
    "The following table lists the top 10 vehicles that reported the most serious violations of fatigue driving this month";
  this.month_classic_case_des3 =
    "The following table lists the top 10 vehicles with the most serious violations of operation alarm in the early hours of this month";
  this.month_classic_case_des4 =
    "The following table lists the top 10 vehicles with the most serious violations of offline displacement (platform) this month";
  this.violation_vehi_alarmhandle_rate =
    "Handling rate of illegal vehicle alarm";
  ...
  this.driving_end_date_format =
    "Expiration time of driving license (Format: 2017-11-11)";
  ...
  this.multiple_para_verticalbars =
    "Multiple parameters are separated by vertical bars";
  this.Monthly_report_of_company_online_rate =
    "Monthly report of company online rate";
  this.Monthly_report_onvehicle_online_rate =
    "Monthly report on vehicle online rate";
  this.Monthly_report_on_the_company_online_rate =
    "Monthly report on the company's online rate";
  ...
  this.The_evaluation_resultwas_not_found =
    "The evaluation result was not found";
  ...
  this.import_company_template =
    "Import company EXCEL template (set cell format before entering data. Cell format>number settings>select text mode)";
  ...
  this.http_err = "Please start with http:// or https://";
  ...
  this.straight_curve_detail = "Straight/Curve Speeding Alarm Detail";
  ...
  this.import_team_template =
    "Import fleet EXCEL template (set cell format before entering data. Cell format>number settings>select text mode)";
  ...
  this.companyHasOtherInfo =
    "There are other information under the company that cannot be deleted";

  this.roleCannotAuth = "No role operation authority";
  this.paramRoleInfoNotExit =
    "Parameter error: role information does not exist";
  this.roleInfoIsExit = "Role name already exists";
  this.roleIdNotNullOrError =
    "Parameter error: the role ID cannot be empty, or the role ID is inaccurate";
  ...
  this.accountOnlyUpdateToParent =
    "User company changes can only be changed to the parent company";
  ...
  this.pleaseInputRoleInfo = "Please select role information";
  ...
  this.import_device_template =
    "Import device EXCEL template (set cell format before entering data. Cell format>number settings>select text mode)";
  this.device_type_des = "Device management type description";
  this.rangeErr = "The range is 0~16";

  this.password_is_simple =
    "The password is too simple, please change the password!";
  this.need_bind_phone =
    "The account password is too simple, the phone number verification has been activated, please contact the administrator to bind the phone number!";
  this.need_edit_authority =
    "The account password is too simple, and there is no modification authority, please contact the administrator to modify!";

  this.dangerous_section = "Dangerous Section";
  this.total_time = "Total time";
  this.total_licheng = "Total mileage (KM)";

  this.baidu_orc = "Baidu OCR";
  this.comma_separat = "Multiple parameters are separated by commas";
  this.baidu_orc_same_num =
    "The number of Baidu OCR separated by commas must be the same";
  ...
  this.vehi_dynamic_info_reissue =
    "Vehicle Dynamic Information Reissue Request";
  this.exchange_vehi_info =
    "Request for Exchange of Vehicle Positioning Information";
  this.reissue_vehi_info = "Reissue vehicle positioning information";
  this.cancel_vehi_info =
    "Cancel the exchange of vehicle positioning information request";
  this.starttime_more_endtime = "The start time must be less than the end time";
  this.Offline_number = "Offline number";
  this.Number_of_vehicles_online_offline = "Number of vehicles online/offline";
  this.NoLoad_heavyLoad_number_of_vehicles =
    "empty-load/heavy-load number of vehicles";
  this.Abnormal_clustering_monitoring_in_non_key_areas =
    "Abnormal clustering monitoring in non key areas";
  ...
  this.Report_of_abnormal_aggregation_alarm_in_non_key_areas =
    "Report of abnormal aggregation alarm in non key areas";
  this.Cross_regional_operations = "Cross-regional operations";
  this.Cross_regional_operating_rules = "Cross-regional operating rules";
  ...
  this.device_mac_check = "Equipment MAC RPT";
  ...
  this.passenger_transportation = "Passenger Transportation";
  this.ride_hailing = "Ride-hailing";
  this.alarm_statistical_analysis = "Alarm Statistical Analysis";
  this.enterprise_alarm_processing_analysis =
    "Enterprise Alarm Processing Analysis";
  this.enterprise_operation_management_score =
    "Enterprise Operation Management Score";
  this.enterprise_and_vehicle_spot_check = "Enterprise And Vehicle Spot Check";
  this.vehicle_alarm_statistical_analysis = "Vehicle Analysis";
  this.regional_industry_alarm_statistical_analysis =
  ...
  this.company_alarm_processing_analysis = "Enterprise Alarm Analysis";
  this.company_alarm_leave_processing_analysis =
    "Enterprise Alarm Level Analysis";
  this.company_vehicle_type_alarm_processing_analysis =
    "Enterprise Vehicle Types Analysis";
  this.company_alarm_type_processing_analysis =
    "Enterprise Alarm Type Analysis";
  this.company_company_type_processing_analysis =
    "Company Type Processing Analysis";
  this.company_operation_management_score = "Enterprise Management Score RPT";
  ...
  this.industry_type_1 = "Cargo Freight"; // logistics_transportation
  this.industry_type_3 = "Passenger Transport"; // bus_passenger
  this.industry_type_10 = "Dangerous Transportation"; // dangerousGoodsTransportation
  this.industry_type_11 = "Passenger Transportation"; // passenger_transportation
  this.gx_vehicle_type_1 = "Passenger"; // 2,3
  this.gx_vehicle_type_2 = "Travel"; // 12,13
  this.gx_vehicle_type_3 = "Dangerous"; // 1
  this.gx_vehicle_type_4 = "Freight"; // 5
  this.average_response_time = "Average Response Time";
  this.rank_type = "Ranking Type";
  this.rank_label = "Ranking Method";
  this.rank_asc = "Asc";
  this.rank_desc = "Desc";
  this.dbclickEchartsTips =
    "Double-click the table to query the data of a single chart";
  ...
  this.busLedgerExcelData = "Road Bus Ledger Monitor Report";
  this.truckLedgerExcelData = "Road Truck Ledger Monitor Report";

  this.information_management = "Information Mgt";
  this.person_mangement = "Police Mangement";

  this.inspectAutoReplyPrompt =
    "Inspect AutoReply (1 is enabled, 0 is not enabled)";
  this.function_config_prompt =
    "Function configuration (smart muck 1, school bus management 2, smart car hire 3)";
  this.password_error =
    "The password length is 8-12 digits and must contain numbers, uppercase letters and lowercase letters";

  this.supervision_daily_weekly_monthly_report =
    "Supervision (daily/weekly/monthly)";
  ...
  this.visual_command_console = "Visualization Screen";
  ...
  this.noSupportIE =
    "Not compatible with IE, advanced browsers such as Chrome are recommended";
  this.channelNumber20Length = "The channel number must be 20 digits";

  this.import_driver_template =
    "Batch import and modify the driver information EXCEL template (set the cell format before entering the data. Cell format>number settings>select text mode)";
  this.driver_type_des = "Driver Information Type Description";
  this.must_big_starttime =
    "It cannot be less than the start time of the validity period of the driver's license";
  this.must_big_onlinevalidity =
    "Must be greater than the start time of the validity period of the online car-hailing driver's license";
  this.date_of_birth_format = "Date of Birth (format 2017-11-11)";
  this.rushDate_format =
    "Date of issuance of driver's license (format 2017-11-11)";
  this.startTime_of_drivers_license_format =
    "The start time of the validity period of the driver's license (format 2017-11-11)";
  this.validity_of_drivers_license_format =
    "The expiration time of the validity of the driver's license (format 2017-11-11)";
  this.validity_start_time_format =
    "The start time of the validity period of the online car-hailing driver's license (format 2017-11-11)";
  this.validity_end_time_format =
    "The end time of the validity period of the online car-hailing driver's license (format 2017-11-11)";
  this.supervisionCardReviewTime_format =
    "Supervision Card Validity Period (Format 2017-11-11)";

  this.networked_joint_control_statistics = "Networked Joint Statistics";
  this.networked_joint_control_assessment =
    "Networked Joint Supervision Assessment";
  this.active_safety_statistics = "Active Safety Statistics";
  this.dynamic_supervision_assessment = "Dynamic Supervision Assessment";
  this.trajectory_integrity_rate = "Trajectory Integrity Rate";
  this.continuous_mileage = "Continuous Mileage";
  this.pageTypeArea = "Area";
  this.pageTypeComapny = "Company";
  ...
  this.networked_enterprise_alarm_ranking =
    "Networked Enterprise Alarm Ranking";
  ...
  this.summary_safety_assessment_indicators =
    "Summary Safety Assessment Indicators";
  this.active_security_enterprise_ranking =
    "Active Security Enterprise Ranking";
  this.active_security_enterprise_alarm_ranking =
    "Active Security Enterprise Alarm Ranking";
  this.active_alarm_vehicle_safety_ranking =
    "Active Alarm Vehicle Safety Ranking";
  ...
  this.report_tip13 =
    " It is the main risk of vehicle operation. It is necessary to pay attention to and inform the driver's driving status. When a risk occurs, it should be intervened in time ";
  this.rise = "Rise";
  this.decline = "Decline";

  this.admin_recv_platform_type1 =
    "The type of the admin receiving check post is the current connected sub-platform";
  ...
  this.map_pop_item_runStatus = "Operational Status";
  ...
  this.accorde_company = "According to Company";
  this.accorde_device = "accorde device";

  this.network_operators = "Network operators";
  this.alarm_name_384 = "Timeout Unhandled (platform)";

  this.job_number_reference =
    "Qualification certificate code (modify data according to this column)";
  this.vehicleidno_reference =
    "License plate number (modify data according to this column)";
  this.device_number_reference =
    "Device number (modify data according to this column)";
  ...
  this.On_board_terminal_maintenance_ledger =
    "On board terminal maintenance ledger";
  ...
  this.Person_in_charge_of_monitoring = "Person in charge of monitoring";
  this.Not_participating_in_the_operation_account =
    "Not participating in the operation account";
  this.Reasons_for_not_participating_in_the_operation =
    "Reasons for not participating in the operation";
  this.Investigation_time = "Investigation time";
  this.Whether_the_terminal_equipment_is_in_good_condition =
    "Whether the terminal equipment is in good condition";
  ...
  this.Early_warning_information_record = "Early warning information record";
  this.Not_in_operation = "Not in operation";

  this.map_style_select_error =
    "Satellite map does not support theme switching";

  this.otherExtraParametersControlTips =
    "0 or no parameter means a fixed duration of wake-up; the maximum value is 11 digits!";
  this.dialog_close_return =
    "The window was closed early and the status update failed";
  ...
  this.interruption_center_allowed_operating_hours =
    "Interruption Center Allowed Operating Hours";
  this.meter_device_number = "Meter Device Number";
  this.sign_in_mode_remote_setting = "Sign-in Mode Remote Setting";
  this.interruption_center_allowed_operating_hours_tips =
    "Unit: hour, all 0 means no time limit.";
  ...
  this.risk_level_company_label = "Company";
  ...
  this.risk_level_chemicalInflammable_2 = "Die";
  ...
  this.blind_zone_right = "Right Blind Spot Alarm";
  this.rear_approach = "Rear Approach Alarm";
  this.look_ahead_leave1 = "Don't Look Ahead Long Time Level One";
  this.look_ahead_leave2 = "Don't Look Ahead Long Time Level Two";
  this.no_work_leave1 = "System Not Operation Level One";
  this.no_work_leave2 = "System Not Operation Level Two";
  this.no_belt_leave1 = "Unfastened Seat Belt Level One";
  ...
  this.lca_number_tips = "Change lane number 3~10";
  ...
  this.curved_speed_leave_threshold =
    "Curved Road Speed Grading Speed Threshold";
  ...
  this.tired_close_eye_tips =
    "The unit is 100ms, and the value ranges from 5-40.";
  this.tired_yawn = "Fatigue Driving-Yawn Sensitivity";
  this.tired_blink = "Fatigue Driving Alarm-Continuous Blink Sensitivity ";
  this.tired_Blood_Oxygen =
    "Fatigue Driving Alarm-Blood Oxygen Concentration Threshold";
  this.tired_heart_Rate = "Fatigue Driving Alarm-Heart Rate Threshold ";
  this.tired_yawn_tips =
    "1-10, the number of occurrences in the past 5 minutes.";
  ...
  this.driver_position_leave_speed =
    "Driver Not In Seat Grading Speed Threshold";
  ...
  this.car_distance_left_tips = "Range 1~10 (seconds)";
  this.car_distance_rear = "Rear Approach Time Threshold";
  this.car_distance_rear_tips = "Range 1~10 (seconds)";
  this.lca_enable = "Lane Change Aid Alarm Enable";
  this.Relative_Speed_Threshold =
    "Relative Vehicle Speed Threshold Assisted by Lane Change Decision";
  this.Alarm_suppression_time =
    "Suppression time of auxiliary alarm for diversion decision-making";
  this.lca_enable_tips =
    "The range is 0~100 (m/s).When the relative speed of the two cars is greater than the alarm";
  ...
  this.sunglass_fail_tip =
    "Only a alarm is triggered during this time interval.";
  this.req_error = "Request parameter exception!";
  this.req_fail = "Gain parameter failure!";
  this.no_open = "Not Open";
  this.photo_ontime = "Camera Timer";
  this.photo_distance = "Active Timing Photograph Distance Interval";
  ...
  this.alarm_road_speed = "Overrun Alarm For Road Signs";
  ...
  this.driver_fatigue_speed_tip_xx =
    "Alarm when range 0 ~ 220(km/h) is lower than this value, turned off when higher than this value";
  this.driver_fatigue_speed_tip =
    "Range 0~220 (km/h) when the speed is higher than the threshold is two level, otherwise first level.";
  ...
  this.photo_graph_tip = "Unit 100ms range 1~5";
  ...
  this.driver_speed_judge_tip =
    "Range 0~60 (km/h)  road offset, forward collision, vehicle distance and frequent lane change.";
  ...
  this.adas_distance_vedio_tip = "Range 0-60 (SEC) 0 means no video";
  this.adas_distance_speed =
    "Vehicle Distance Monitoring Grading Speed Threshold";
  this.adas_distance_distance =
    "Vehicle Distance Monitoring Distance Threshold ";
  this.adas_distance_distance_tip = "Unit 100ms range 10-50";
  ...
  this.adas_pedestrian_vedio_tip =
    "If the range 0-220 (km/h) is lower than the value, the alarm function is higher than the value. ";
  ...
  this.adas_collision_time_tip =
    "Unit 100ms range 10~50 uses international standard set value 27";
  ...
  this.file_img = "picture";
  this.file_rec = "video";
  this.file_audio = "audio";
  this.file_text = "text";
  this.file_type_label = "File Type";
  this.file_path_label = "File path";
  this.file_task_status_p1 = "tasking";
  this.file_task_status_p2 = "complete";
  this.file_task_status_p3 = "failure";
  ...
  this.selectTime = "Choose time:";
  this.startTime = "Starting time:";
  this.endTime = "End Time:";
  this.bitType = "Stream Type:";
  this.selectVehi = "Choose vehicle:";
  this.dateSelectTip = "The start date must not exceed the end date";
  this.vehIdno = "number plate";
  this.vehColor = "License plate color";
  this.belongCom = "Affiliated company";
  this.chnName = "Channel";
  this.beginTime = "Starting time";
  this.storePlace = "storage location";
  this.mediaTab = "media type";
  this.bitTab = "Stream type";
  this.selectVehiTip = "Please select the vehicle";
  this.vehicSelect = "Choose a vehicle";
  this.selected = "chosen:";
  this.talfileTime = "The total length of the file is long";
  this.talfileSize = "The total file size";
  this.yinshipin = "Audio and video";
  this.yinpin = "Audio";
  this.shipin = "video";
  this.yinshi = "Video or audio and video";
  this.zhuMa = "Main stream";
  this.zhiMa = "Sub-stream";
  this.zhuZHi = "Main or sub-stream";
  this.mainStore = "Main memory";
  this.zbStore = "Disaster recovery memory";
  this.zhuZbStore = "Main or disaster recovery memory";
  this.alarm1 = "Emergency alarm";
  this.alarm2 = "Speed alarm";
  this.alarm3 = "Fatigue driving";
  this.alarm4 = "Early warning";
  this.alarm5 = "The GNSS module has failed";
  this.alarm6 = "The GNSS module is not connected or cut";
  this.alarm7 = "GNSS antenna short circuit";
  this.alarm8 = "Terminal mains power undervoltage";
  this.alarm9 = "Terminal mains power down";
  this.alarm10 = "Terminal LCD or monitor failure";
  this.alarm11 = "TTS module failure";
  this.alarm12 = "Camera failure";
  this.alarm13 = "The same day driving overtime";
  this.alarm14 = "Overtime parking";
  this.alarm15 = "Access area";
  this.alarm16 = "Access line";
  this.alarm17 = "Poor travel time / too long";
  this.alarm18 = "Route deviation from alarm";
  this.alarm19 = "Vehicle VSS failure";
  this.alarm20 = "Vehicle oil is abnormal";
  this.alarm21 = "The vehicle was stolen";
  this.alarm22 = "Illegal ignition of vehicles";
  this.alarm23 = "Illegal displacement of vehicles";
  this.alarm24 = "Collision rollover alarm";
  this.alarm25 = "Video signal loss alarm";
  this.alarm26 = "Video signal block alarm";
  this.alarm27 = "Storage unit fault alarm";
  this.alarm28 = "Other video equipment failure alarm";
  this.alarm29 = "Bus overrun alarm";
  ...
  this.resolution = "Resolution Ratio";
  this.frameRateLabel = "Rrame Rate";
  this.streamLabel = "Bit Rate";
  this.ssidLabel = "SSID";
  this.passwordLabel = "Password";
  this.netTypeLabel = "Net Type";
  this.sendError = "Send request error";
  this.liveParamSubmitTip =
    "Submit parameters for the current channel configuration.";
  this.liveParamSubmit = "Save";
  this.sendTips = "Failed to send Ajax request";
  this.loadSuccess = "Load successfully";
  this.loadFail = "Load failed";
  this.setSuccess = "Set successfully";
  this.setFail = "Set failed";
  ...
  this.wifiParamSubmitTip =
    "Network switch will cause prompt setting to fail. Whether the Wifi is successful switching, you can manually refresh the network status in the network parameter to determine.";

  this.driver_comparison_parameter_configuration =
    "Driver Comparison Parameters";
  ...
  this.success_threshold_tip =
    "Driver comparison threshold percentage of success similarity; range 0%~100%. The unit is 1%";
  this.saveToOther_tip = "Save To Others";
  this.saveToOther_mutiply = "Batch Save";
  this.select_frist = "Please choose";
  this.sunglass_fail_remind =
    "Infrared blocking sunglasses failure notification";
  ...
  this.IntelligentRecognition_title =
    "Parameters of Intelligent Recognition System";
  this.accelerate_Alarm_Time = "Accelerated alarm time threshold";
  this.gravity_Acceler_ation =
    "Gravity Acceleration Threshold of Acceleration Alarm";
  this.sudden_Deceleration_action =
    "Threshold of alarm time for rapid deceleration";
  this.sudden_Deceleration_action_alarm =
    "Acceleration threshold of gravity for rapid deceleration alarm";
  this.A_Sharp_Turn_Alarm_Time = "Threshold of alarm time for sharp turn";
  this.A_Sharp_Turn_Gravity_Acceleration =
    "Gravity Acceleration Threshold for Rapid Turn Alarm";
  ...
  this.Abnormal_Flameout_AlarmTime =
    "Threshold of alarm time for abnormal extinction";
  this.Abnormal_Flameout_AlarmSpeed =
    "Speed Threshold of Abnormal Flameout Alarm";
  this.Abnormal_Flameout_AlarmEngineSpeed =
    "Speed Threshold of Abnormal Flameout Alarm";
  this.Coasting_AlarmTime = "Alarm time for neutral sliding";
  this.Coasting_AlarmSpeed = "Speed threshold of idle taxiing alarm";
  this.Coasting_AlarmEngineSpeed =
    "Threshold of Engine Speed for Clearance Sliding Alarm";
  ...
  this.Engine_Overturn_AlarmEngineSpeed =
    "Threshold of engine speed for engine overshoot alarm";
  ...
  this.alarm_deviate_now = "Lane departure alarm";
  this.alarm_forward_early = "Early Warning of Forward collision";
  this.alarm_forward_now = "Forward collision alarm ";
  this.alarm_goer_early = "Early Warning of Pedestrian collision";
  this.alarm_goer_now = "Pedestrian Collision Alarm";
  this.alarm_vehicle_early = "Early Warning of Vehicle Distance Too Close";
  this.alarm_vehicle_now = "Alarm for vehicle proximity";
  this.Quick_passage_early = "Early Warning of Fast Passing at Intersection";
  this.Quick_passage_now = "Fast Passing Alarm at Intersection";
  this.Default_path = "Default path";
  this.Custom_path = "Custom path";
  this.alarm_Aisle_overload = "Overload alarm in corridor";
  this.alarm_Off_site_visitors = "Off-station Passenger alarm";
  this.Crossing_speed_alarm = "Crossing speed alarm";
  this.alarm_Not_looking_ahead_one = "Long time no visual front level alarm";
  this.alarm_Not_looking_ahead_two =
    "Long time no visual front secondary alarm";
  this.alarm_Driver_Leave_steering_wheel_one =
    "One-stage alarm for driver's hands off steering wheel";
  this.alarm_Driver_Leave_steering_wheel_two =
    "Two-stage alarm for driver's hands off steering wheel";
  ...
  this.alarm_no_seat_belt_two = "Second-level alarm without seat belt";
  this.alarm_Leave_steering_wheel_one =
    "First-level alarm with hands off steering wheel";
  this.alarm_Leave_steering_wheel_two =
    "Second-level alarm with hands off steering wheel";
  this.alarm_Equipments_Occlusion_Failure =
    "Equipments Occlusion Failure Alarm ";
  this.remind_Equipments_Occlusion_Failure = "Device blocking failure reminder";
  this.alarm_Failure_Infrared_Blocking_Sunglasses =
    "Infrared Blocking Sunglasses Failure Alarm ";
  this.alarm_Substitution_driving = "Alarm for changing driver";
  this.alarm_driver_Failure_Infrared_Blocking_Sunglasses =
    "Failure Alarm of Driving Infrared Blocking Sunglasses";
  this.Drivers_dont_wear_seat_belts = "Drivers don't wear seat belts to alarm";
  this.alarm_tired_early = "Early warning of fatigue driving";
  this.alarm_tired_now = "Fatigue driving alarm";
  ...
  this.alarm_smoke_now = "Smoking alarm";
  this.alarm_distracted_early = "Early warning of Distracted driving";
  this.alarm_distracted_now = "Distracted driving alarm";
  this.alarm_driver_early = "Early warning of Driver Abnormal";
  this.alarm_driver_now = "Driver Abnormal Alarm";
  this.alarm_Occlusion_camera = "Probe occlusion alarm";
  this.Time_out_alarm = "Time-out alarm";
  this.Hands_off_the_steering_wheel = "Hands off the steering wheel";
  this.Infrared_blocking_sunglasses_failure_alarm =
    "Infrared blocking sunglasses failure alarm";
  this.Driver_identification_event = "Driver identification event";
  this.alarm_Overtime_driving = "Overtime driving alarm";
  ...
  this.driver_abnormal_number_showChuan =
    "No number of driver photos detected ";
  this.driver_abnormal_vedio_showChuan =
    "Driver Video Recording Time Not Detected ";
  this.driver_abnormal_speed_showChuan =
    "No driver grading speed threshold was detected ";
  this.driver_distracted_face_showChuan =
    "Interval of driver's facial feature photographs taken without looking forward for a long time ";
  this.driver_distracted_number_showChuan =
    "Number of photos of driver's facial features taken without looking forward for a long time ";
  this.driver_distracted_vedio_showChuan =
    "Hierarchical Speed Threshold of Long-time Non-visual Front Alarm";
  this.driver_distracted_speed_showChuan =
    "Hierarchical Speed Threshold of Long-time Non-visual Front Alarm";
  this.driver_fatigue_speed_tip_zb =
    "Range 0~220(km/h) When the alarm is triggered, the speed is higher than the threshold";
  this.driver_fatigue_number_tip_zb = "Range 1-10 (0 for no capture)";
  this.photo_graph_tip_five = "Unit 100ms range 1~5";
  this.Continuous_Driving_Tip =
    "Unit hour, value range 0-24, indicating that over night continuous driving time threshold will trigger overtime driving alarm ";
  this.Minimum_Parking_Rest__Tip =
    "Unit minute, value range 0-24, indicating that parking rest time exceeds the minimum parking rest time threshold";
  this.Nighttime_Definition_Period_Tip =
    "Unit hour, range 0:00-24:00, default value 22:00~6:00。";
  this.Day_hour_Cumulative_DrivingTip =
    "Unit hour, range 0-24, indicating that the same driver over 24 hours cumulative driving time threshold will trigger the timeout alarm";
  this.Units_range_70 = "The unit is one, the range is 0 ~ 70";
  this.Channel_Parameters =
    "Each BIT bit represents a channel, such as BIT0 for channel 1 and BIT1 for channel 2.";
  ...
  this.alarm_Acceleration = "Accelerate alarm";
  this.alarm_Accelerated_deceleration = "Accelerated deceleration alarm";
  this.alarm_sharp_turn = "Alarm for sharp turn";
  this.alarm_idling = "Idle alarm";
  this.alarm_Abnormal_flameout = "Abnormal flameout alarm";
  this.alarm_Coasting = "Skiing alarm in neutral gear";
  this.alarm_Engine_Overturn = "Engine Overturn Alarm";
  this.Master_Server_Address_Tip =
    "Used for image file upload. Format: ftp address, port number, username, password, path (including root path identifier)";
  this.PathWarning =
    "It is recommended to use the default path. If you use a custom path, it will affect the display of reported pictures.";
  this.Un_Seat_Belt_SpeedLabel =
    "Classified Speed Threshold for Driving Alarm without Seatbelt";
  this.Un_Seat_Belt_TimeLabel =
    "Video recording time before and after driving alarm without seat belt";
  this.Un_Seat_Belt_Face_Number_Label =
    "Number of photos taken without seat belt driving alarm ";
  this.Un_Seat_Belt_Face_Time_Label =
    "Time interval for driving alarm photography without seat belt ";
  this.Hands_Off_Steering_Wheel_Speed_Label =
    "Graded Speed Threshold for Hand-off Steering Wheel Alarm ";
  this.Hands_Off_Steering_Wheel_Time_Label =
    "Video recording time before and after hand leaving steering wheel alarm ";
  this.Hands_Off_Steering_Wheel_Face_Number_Label =
    "Number of Alarm Photos of Hands Leaving the Steering Wheel ";
  this.Hands_Off_Steering_Wheel_Face_Time_Label =
    "Time interval between alarm and photograph of hands leaving steering wheel ";
  this.Fatigue_Driving_Up_Main_Channel_Label =
    "Fatigue Driving Alarm Linkage Upload Main Bit Stream Video Channel ";
  this.Fatigue_Driving_Up_Substream_Channel_Label =
    "Fatigue Driving Alarm Linkage Upload Substream Video Channel ";
  this.Fatigue_Driving_Up_Capture_Channel_Label =
    "Fatigue Driving Alarm Linkage Upload Capture Channel ";
  this.Answer_Phone_Up_Main_Channel_Label =
    "Call handheld telephone alarm linkage upload main stream video channel ";
  this.Answer_Phone_Up_Substream_Channel_Label =
    "Handheld Phone Alarm Linkage Upload Substream Video Channel";
  this.Answer_Phone_Up_Capture_Channel_Label =
    "Hand-held telephone call alarm linkage upload snapshot channel ";
  this.Smoking_Up_Main_Channel_Label =
    "Smoking Alarm Linkage Upload Main Bit Stream Video Channel ";
  this.Smoking_Up_Substream_Channel_Label =
    "Smoking Alarm Linkage Upload Substream Video Channel ";
  this.Smoking_Up_Capture_Channel_Label =
    "Smoking Alarm Linkage Upload Capture Channel ";
  this.Decentralized_Attention_UpMain_Channel_Label =
    "Attention Dispersion Linkage Upload Main Bit Stream Video Channel";
  this.Decentralized_Attention_Substream_Channel_Label =
    "Attention Dispersion Linkage Upload Substream Video Channel";
  this.Decentralized_Attention_Capture_Channel_Label =
    "Attention Dispersion Linkage Upload Capture Channel ";
  this.Driver_Not_Monitored_Up_Main_Channel_Label =
    "Driver is not in driving position to upload main stream video channel ";
  this.Driver_Not_Monitored_Up_Substream_Channel_Label =
    "Driver not in driving position linkage upload sub-stream video channel ";
  this.Driver_Not_Monitored_Up_Capture_Channel_Label =
    "Driver not in driving position linkage upload capture channel ";
  this.Unfastened_Seat_Belt_Up_Main_Channel_Label =
    "Unfastened Seatbelt Linked Upload Main Bit Stream Video Channel ";
  this.Unfastened_Seat_Belt_Up_Substream_Channel_Label =
    "Unfastened Seatbelt Linked Upload Substream Video Channel ";
  this.Unfastened_Seat_Belt_Up_Capture_Channel_Label =
    "Unfastened Seatbelt Linked Upload Capture Channel ";
  this.Hands_Off_The_SteeringWheel_UpMain_Channel_Label =
    "Upload main stream video channel with two hands off-handle linkage ";
  this.Hands_Off_The_SteeringWheel_Up_Substream_Channel_Label =
    "Upload Substream Video Channel with Hand-off Linkage ";
  this.Hands_Off_The_SteeringWheel_Up_Capture_Channel_Label =
    "Hand-to-Hand Linkage Upload Capture Channel ";
  this.Substitution_Driving_Speed_Label =
    "Driving Alarm Triggered Vehicle Speed Threshold";
  this.Substitution_Driving_Time_Label =
    "Video recording time before and after driver change alarm";
  this.Substitution_Driving_FaceNumber_Label =
    "Number of photos of driver changing alarm";
  this.Substitution_Driving_FaceTime_Label =
    "Alarm interval for changing driver";
  this.Overtime_Driving_Speed_Label =
    "Overtime Driving Alarm Triggered Vehicle Speed Threshold";
  this.Overtime_Driving_Time_Label =
    "Video recording time before and after overtime driving alarm";
  ...
  this.Continuous_Daytime_Driving_Time_Label =
    "Daytime Continuous Driving Time Threshold";
  this.Continuous_Driving_Night_Time_Label =
    "Night Continuous Driving Time Threshold";
  ...
  this.hour_Cumulative_Driving_Time_Label =
    "24-hour cumulative driving time threshold";
  this.Driver_Hands_Off_Steering_WheelSpeed_Label =
    "Graded Speed Threshold for Driver's Hands Leaving Steering Wheel";
  this.Driver_Hands_Off_Steering_WheelTime_Label =
    "Video recording time of driver's hands off steering wheel";
  this.Driver_Hands_Off_Steering_WheelFaceNumber_Label =
    "Number of photos taken by the driver with both hands off the steering wheel";
  this.Driver_Hands_Off_Steering_WheelFaceTime_Label =
    "Pilot's hands off the steering wheel to take photos at intervals";
  this.Drivers_Dont_Wear_Seat_Belts_Speed_Label =
    "Driver's Speed Threshold Without Seatbelt";
  this.Drivers_Dont_Wear_Seat_Belts_Time_Label =
    " Video recording time of driver without seat belt ";
  this.Drivers_Dont_Wear_Seat_Belts_FaceNumber_Label =
    "Number of photos taken by drivers without seat belts";
  this.Drivers_Dont_Wear_Seat_Belts_FaceTime_Label =
    "Driver without seat belt interval";
  this.Device_Blocking_Failure_Reminder_Speed_Label =
    "Device blocking failure reminder grading speed threshold";
  this.Device_blocking_failure_reminder_video_recording_time =
    "Device blocking failure reminder video recording time";
  this.Device_Blocking_Failure_Reminder_Capture_Photos_Label =
    "Device blocking failure reminder to capture photos";
  this.Device_Blocking_Failure_Reminding_Photo_Interval_Label =
    "Device blocking failure reminding photo interval";
  this.Infrared_Sunglasses_Failure_Reminder_Speed_Label =
    "Infrared blocking sunglasses failure reminder grading speed threshold";
  this.Infrared_Sunglasses_Failure_Reminder_video_Time_Label =
    "Infrared blocking sunglasses failure reminder video recording time";
  this.Infrared_Sunglasses_Failure_Reminder_Capture_Photos_Label =
    "Infrared blocking sunglasses failure reminder to capture photos";
  this.Infrared_Sunglasses_Failure_Reminder_Photo_Interval_Label =
    "Infrared-blocking sunglasses fail reminding photo interval";
  this.Overcrowding_Alarm_Speed_Threshold_Label =
    "Overcrowding alarm speed threshold";
  this.Overcrowding_Alarm_Video_Recording_Time_Label =
    "Superman alarm video recording time";
  this.Overcrowding_Alarm_Capture_Photos_Label =
    "Number of Snapshots of Superman Alarm";
  this.Overcrowding_Alarm_Photo_Interval_Label =
    "Superman alarm photo interval";
  this.Number_Of_NuclearLoad_Label = "Number of nuclear load";
  this.Aisle_Over_load_Alarm_Speed_Label =
    "Graded Vehicle Speed Threshold for Overload Alarm in Passage";
  this.Aisle_Over_load_Alarm_Time_Label =
    "Video recording time before and after alarm of corridor overload";
  this.Aisle_Over_load_Alarm_FaceNumber_Label =
    " Number of Overload Alarm Photos in Passage ";
  this.Aisle_Over_load_Alarm_FaceTime_Label =
    "Interval time of overload photography in corridor";
  this.Off_Site_Visitors_Alarm_Speed_Label =
    "Speed threshold of Passenger alarm outside station";
  this.Off_Site_Visitors_Alarm_Time_Label =
    "Video recording time before and after Passenger alarm outside station";
  this.Off_Site_Visitors_Alarm_FaceNumber_Label =
    "Number of alarm photos taken by passengers outside the station";
  this.Off_Site_Visitors_Alarm_FaceTime_Label =
    "Time interval between alarm and photography of passengers outside the station";
  this.Aisle_Over_load_Up_Main_Channel_Label =
    "Overload Linkage Upload Main Bit Stream Video Channel";
  this.Aisle_Over_load_Up_Substream_Channel_Label =
    "Passage Overload Linkage Upload Substream Video Channel";
  this.Aisle_Over_load_Up_Capture_Channel_Label =
    "Passage overload linkage upload capture channel";
  this.Off_Site_Visitors_Up_Main_Channel_Lable =
    "Out-of-Station Upload-Passenger Linkage Upload Main Bit Stream Video Channel";
  this.Off_Site_Visitors_Up_Substream_Channel =
    "Outside Station Passenger Linkage Upload Substream Video Channel";
  this.Off_Site_Visitors_Up_Capture_Channel =
    "Outside Station Passenger Linkage Upload Capture Channel";
  ...
  this.real_LineLane_Change_Speed_Label =
    "Classified Speed Threshold for Real-Line Channel Alarm";
  this.real_LineLane_Change_Time_Label =
    "Video recording time before and after alarm of real line diversion ";
  this.real_LineLane_Change_Photo_Label =
    "Number of Alarm Photographs for Real Line Change ";
  this.real_LineLane_Change_Photo_Interval_Label =
    "Photo interval of alarm with real line changing lane ";
  this.Barrier_Up_Main_Channel_Label =
    "Barrier Alarm Linkage Upload Main Bit Stream Video Channel ";
  this.Barrier_Up_Substream_Channel_Label =
    "Barrier Alarm Linkage Upload Substream Video Channel";
  this.Obstacle_Alarm_Linkage_Up_Capture_Channel_Label =
    "Obstacle alarm linkage upload capture channel ";
  this.Frequent_Lane_Change_UpMain_Channel_Label =
    "Frequent lane change alarm linkage upload main stream video channel ";
  this.Frequent_Lane_Change_UpSubstream_Channel_Label =
    "Frequent Channel Change Alarm Linkage Upload Substream Video Channel";
  this.Frequent_Lane_Change_UpCapture_Channel_Label =
    "Frequent Channel Change Alarm Linkage Upload Capture Channel";
  this.Lane_Departure_Up_Main_Channel_Label =
    "Lane Departure Alarm Linkage Upload Main Bit Stream Video Channel ";
  this.Lane_Departure_Up_Substream_Channel_Label =
    "Lane Departure Alarm Linkage Upload Substream Video Channel";
  this.Lane_Departure_Up_Capture_Channel_Label =
    "Lane departure alarm linkage upload capture channel ";
  this.Forward_Collision_Up_Main_Channel_Label =
    "Forward Collision Early Warning Linkage Upload Main Bit Stream Video Channel ";
  this.Forward_Collision_Up_Substream_Channel_Label =
    "Forward Collision Early Warning Linkage Upload Substream Video Channel";
  this.Forward_Collision_Up_Capture_Channel_Label =
    "Forward Collision Early Warning Linkage Upload Capture Channel ";
  this.Pedestrian_Collision_Up_Main_Channel_Label =
    "Pedestrian Collision Early Warning Linkage Upload Main Bit Stream Video Channel ";
  this.Pedestrian_Collision_Up_Substream_Channel_Label =
    "Pedestrian Collision Early Warning Linkage Upload Substream Video Channel";
  this.Pedestrian_Collision_Up_Capture_Channel_Label =
    "Pedestrian Collision Early Warning Linkage Upload Capture Channel ";
  this.Vehicle_Distance_Up_Main_Channel_Label =
    "Alarm Linkage Upload Main Code Stream Video Channel ";
  this.Vehicle_Distance_Up_Substream_Channel_Label =
    "Alarm Linkage Upload Substream Video Channel for Vehicle Distance Over-proximity";
  this.Vehicle_Distance_Up_Capture_Channel_Label =
    "Overproximity alarm linkage upload capture channel ";
  ...
  this.beginTimeLabel = "Starting time";
  ...
  this.plateColorTip =
    "The license plate type is entered incorrectly. Please enter a number.";
  this.plateColorTip1 =
    "The license plate type is entered incorrectly and currently only supports yellow and blue cards.";
  this.keyErrorTips =
    "The Key value is incorrect. Please confirm the correct Key value.";
  this.disableStatus = "The device has been disabled.";
  this.errorColor =
    "The car does not have a corresponding license plate color, please check if the license plate color input is wrong.";
  this.chnTips =
    "The channel parameter cannot be greater than the existing channel number. Please enter the correct channel parameter.";

  this.nullMic =
    "On your computer does not have a microphone, you can not start speaking";
  ...
  this.videoDesc =
    "This example can support IE/Chrome at the same time, Chrome uses h5 plug-in, IE uses Flash. If you don’t need to be compatible with IE, please refer to videoExampleH5.html";
  ...
  this.bufferTimeDesc =
    "Description:It's mainly used for the adjustment of video lazy load. When the video buffers the minimum buffer time(defaults to 2 seconds) of video, then it will play the video. When the video buffers the maximum buffer time(defaults to 6 seconds) of video, then it will play the video fast-forward.";
  ...
  this.vedioNoPlay =
    "There is no video playback in the current selected window";
  this.talkbackDesc =
    "h5 player, https can talk directly; for http talk, you need to download and install the PCM audio collection tool. The h5 player judges by the onTtxVideoMsg message callback. type=isTalking means the intercom is in progress, type=showDownLoadDialog means the pcm collection tool needs to be downloaded";
  ...
  this.loadSuc = "Load successfully";
  this.codeSet = "Code Settings";
  this.codeIoSet = "Bitstream Setting";
  this.qualityTips = "The lower the value, the better the quality";
  ...
  this.vioceSwitch = "Video Sound";
  this.vedioSwitch = "Video Switch";
  ...
  this.notOnline = "device  not  online";
  this.plateTypeErr = "License plate color does not match!";
  this.downPcm = "Are you sure to down PCM?";

  this.device_empty =
    "Device number or license plate number cannot be empty at the same time!";
  this.unknown_error = "unknown mistake";
  this.load_success = "Loaded successfully";
  ...
  this.reflash = "Refresh";
  this.delete_tip = "Delete";
  this.gps_time = "Receiving Time";
  ...
  this.error_time =
    "The time format is wrong or the range is abnormal (only the same day query is supported)!";
  ...
  this.engine_status = "Engine Status";
  this.remaining_oil = "Remaining Oil";
  this.engine_status_travel = "Travel";
  this.engine_status_idle_speed = "Idle Speed";
  this.engine_status_flameout = "Flameout";
  ...
  this.tire = "Tire Pressure Monitoring";
  this.blind = "Blind-Spot Detection";
  this.info = "Information Query";
  this.work = "Work State";
  this.alarm = "Alarm State";
  this.company = "Company";
  this.model = "Product Model";
  this.version_hard = "Hardware Version";
  this.version_soft = "Software Version";
  ...
  this.alarm_storage = "Main Memory Anomaly;";
  ...
  this.Alarm_statistics_of_speeding_vehicles =
    "Alarm statistics of speeding vehicles";
  this.Fatigue_driving_vehicle_alarm_statistics =
    "Fatigue driving vehicle alarm statistics";
  this.Offline_vehicle_alarm_statistics1 = "Offline vehicle alarm statistics";
  this.Traffic_prohibition_alarm_statistics_at_night =
    "Traffic prohibition alarm statistics at night";
  ...
  this.day_running_info_overspeed = "Accumulated Overspeed Times";
  this.day_running_info_park = "Accumulated Parking Times";
  this.day_running_info_parkTime = "Accumulated Parking Time";
  this.day_running_info_runTime = "Driving Time";
  ...
  this.cmsv6Play212Tip = "Nnknown mistake";
  ...
  this.cmsv6Play216Tip =
    "The terminal is talking, and the forced pull or demolish will fail";
  ...
  this.pleaseInputMenuGroupName =
    "Please fill in the name of the custom menu group";
  ...
  this.image_upload_unsuccess =
    "The image upload server has not been completed";

  this.modify_mile_date = "Opening Hours";
  this.modify_mile_begin_time = "Starting Time";
  this.modify_mile_end_time = "End Time";
  this.modify_mile_begin_mile = "Starting Mileage";
  this.modify_mile_end_mile = "End Mileage";
  this.modify_mile_run_mile = "Opening Mileage";
  this.modify_mile_read = "(Read Only)";
  this.modify_mile_import_date =
    "The date format is not standardized (1. Is the time format correct 2. Is the date the same day 3. Is the end time greater than the start time)";
  this.modify_mile_import_mile =
    "The mileage data format is wrong (1. Can not be empty 2. Must be an integer, preferably in text format)";
  ...
  this.taxi_driver_required =
    "The driver’s qualification certificate number or business license number cannot be empty";

  this.operate_days = "Operation Days";
  this.day_running_info_driverTime = "Day Cumulative Driving Time";
  ...
  this.auth_delete_vehicle_account_info =
    "User Vehicle Authorization Cancellation";
  ...
  this.The_notification_event_cannot_operation =
    "The notification event cannot perform the operation";
  this.Account_category = "Account category";
  this.Call_seat = "Call seat";
  this.Emergency_dispatch_plan_management =
    "Emergency dispatch plan management";
  ...
  this.add_server_info = "Add Server";
  ...
  this.edit_alarm_name_customize_info = "Active Security Name Customization";
  this.delete_alarm_name_customize_info =
    "Delete Active Security Name Customization";
  this.edit_alarm_summary_customize_info =
    "Custom Alarm Statistics Configuration";
  this.edit_alarm_push_customize_info = "Alarm Push Configuration";
  this.edit_alarm_key_customize_info =
    "Security Report Key Alarm Custom Configuration";
  this.edit_map_key_customize_info = "Map KEY Configuration";
  this.edit_map_shield_customize_info = "Map Shielding Configuration";
  this.edit_param_customize_info = "Server Parameter Configuration";
  this.edit_function_customize_info = "Server Function Settings";
  this.edit_rule_customize_info = "Custom Rule Management";
  ...
  this.edit_screen_alarm_customize_info =
    "Smart Cloud Screen Alarm Customization";
  ...
  this.official_carEx = "Official";
  this.choose_at_least_one = "Choose at least one";

  this.driver_max_byte =
    "The driver’s qualification certificate number cannot exceed 19 bytes!";
  ...
  this.No_operation_troubleshooting_account =
    "No operation troubleshooting account";
  ...
  this.personLibary = "Portrait Library";
  ...
  this.policeNumber = "Police Number";
  ...
  this.driverNameLabel = "Driver Name";
  ...
  this.dynamic_complex_ledger = "Dynamic Monitoring Ledger";
  ...
  this.ledger_summary_smoke = "smoke";
  this.ledger_summary_driver_exception = "Driver exception";
  ...
  this.param_command_edit_confirm =
    "Modifying the command operation will cause the task to be reissued!";
  ...
  this.task_add = "Add";
  this.param_task_label = "Param Task Configuration";
  ...
  this.intercomTempGroupTip =
    "The terminal is already in a temporary group or the group intercom function is not enabled";
  this.notify_vehicle_contact = "Notify Vehicle Contact";

  this.operateScreenLabel = "Operational Data Monitoring Large Screen";
  ...
  this.todayAlarmTotal = "Total Number Of Alarms On The Day";
  this.todayAlarmHanleTotal = "Number Of Alarms Handled On The Day";
  this.realTimeOnlineNum = "Real-time Online Quantity";
  this.yesterdayOnlineNum = "Number Of Online Yesterday";
  ...
  this.safeTyVehiOnlineNum = "Active Safety Online";
  this.todayAlarmHandleCount = "Today's Alarm Processing Number";
  this.todayAlarmNotHandleCount = "Today's Alarm Is Not Processed";
  this.first_two_weeks_analysis =
    "Analysis Of Active Safety In The First Two Weeks";
  this.today_alarm_vehicle_rank = "Today's Vehicle Alarm Ranking TOP10";
  this.near7_safety_alarm_thread =
    "Trend Of Active Safety Alarms In The Past 7 Days";
  this.today_total_alarm = "Total Number Of Alarms Today";
  this.today_safety_alarm_distribution =
    "Distribution Of Active Safety Alarm Types Today";
  ...
  this.param_config_sb_driver_issued =
    "The Enterprise Platform Proactively Issues Driver Identity Info";
  this.param_config_sb_driver_inspection =
    "Platform Inspection Driver Identity Info";
  this.select_dirver_face_info = "Issued Face Database";
  this.selectDriver = "Select Driver";
  ...
  this.disable_admin_recv_platform_type1 =
    "(Disabled) The type of the admin receiving check post is the current connected sub-platform";
  ...
  this.blind_rpt_desc =
    "The alarm is generated by statistics on the next day, and it is judged that the ACC is on, but the GPS has not positioned the data";
  ...
  // 2017年7月10日14:42:22
  this.departmentuser_management = "Department Management";
  this.department_companyTeamTree = "List Company Departments";
  this.label_search_department = "Find Department";
  this.department_labelSearchVehi = "Find People";
  this.department_drag_tip =
    "You can use the drag method to move the department, and the company's subordinate departments can move each other;";
  this.department_move_tip =
    "Click the company to refresh the unassigned personnel; click the department to refresh the assigned personnel; the personnel must be removed from the department before they can be assigned to other departments; the personnel can only be assigned to the departments under the company;";
  this.department_userList = "Assigned Personnel";
  this.department_freeUserList = "Unassigned Personnel";
  this.department_moveUser = "&lt;&lt;Move To";
  this.department_removeUser = "Move Out&gt;&gt;";
  this.department_add = "Add";
  this.department_edit = "Modify";
  this.department_del = "Delete";
  this.department_move = "Move";
  this.all_department = "All Organizations";
  this.higher_department = "Parent Organization:";
  this.department_selectGroupNode =
    "Please select a company or department node!";
  this.department_editNotCompanyNode =
    "The company information cannot be modified, please select the department node!";
  this.department_selectTeamNode = "Please select department node!";
  this.department_groupHasChild =
    "There are sub-departments in this department, which cannot be deleted!";
  this.department_selectFreeVehi = "Please select unassigned personnel";
  this.department_selectGroupVehi = "Please select the assigned person";
  this.department_exist = "Department information does not exist";
  this.department_have_people =
    "There are also assigned personnel under the department";
  this.department_name_exist = "Department name already exists";
  this.wayBill = "Electronic Waybill";
  this.waybill_user_car = "Car Application";
  this.waybill_examine = "Approval Management";
  this.waybill_allot_car = "Dispatch Management";
  this.approval_process = "Approval Process";
  this.department_management = "Department Management";
  this.approval_process_management = "Approval Process Management";
  this.approval_type = "Approval Type";
  this.add_approval_type = "New Approval Type:";
  this.approval_type_name = "Approval Type Name";
  this.user_list = "User List";
  this.mission_push = "Task completion push message";
  this.please_choose_department =
    "Please select department or department sub-node!";
  this.approval_null_error = "The approval type cannot be empty!";
  this.sure_delete_this_approval_type =
    "Confirm to delete this approval type, the deletion cannot be revoked!";
  this.sure_push_all_info =
    "Do you want to push all process information under this approval type?";
  this.sure_cancel_push_all_info =
    "Do you want to cancel the push of all process information under this approval type?";
  this.push_info = "Push Approval Information";
  this.approval_flow_management = "Approval Process";
  this.mission_type = "Task Type";
  this.mission_detail = "Task Details";
  this.punch_card_num = "Check-in Times";
  this.punch_card_count = "Total Punch Cards";
  this.punch_card_position = "Check-in Location";
  this.first_punch_card_position = "First Punching Position";
  this.last_punch_card_position = "Last Punch-in Position";
  this.road_type = "Waybill Type";
  this.move_to_approval = "Move To";
  this.move_out_to_approval = "Move Out";
  this.process_tip_drag =
    "First select the department in the department list, load the approval type, and then select the approval type, load the user and user list in the approval process;";
  this.process_tip_move =
    "The approval type can be selected to move up and down; each approval type corresponds to an approval process; users in the same department can be assigned to different approval processes; deleting an approval type will delete the corresponding approval process.";
  this.department_list = "Department";
  this.normal_approval = "Normal";
  this.upgrade_approval = "Upgrade";
  this.move_to_dispatch = "Move To";
  this.move_out_of_dispatch = "Move Out";
  this.dispatch_process_management = "Dispatch Process Management";
  this.dispatch_process = "Dispatch Process";
  this.vehicle_dynamics = "Vehicle Dynamics";
  this.completeNumberTip = "Completed:";
  this.executingNumberTip = "Execution:";
  this.timeOutNumberTip = "Execution (timeout):";
  this.unexecutedNumberTip = "Not Performed:";
  this.countPeopleNumberTip = "Riders:";
  this.labelRefresh = "Refresh Frequency:";
  this.companyIdno = "Application No./User/Car Unit/License Plate Number";
  this.selectRefresh = "Refresh Frequency";
  this.unit_name = "Company Name";
  this.startLocation = "Mission Starting Point";
  this.endLocation = "Mission Destination";
  this.expected_time = "Estimated Time";
  this.task_progress = "Current Task Progress";
  this.finalTime = "Last Check-in Time";
  this.finalLocation = "Last Check-in Location";
  this.select_unit = "Select Unit:";
  this.route_order_execution = "Route Order Execution (timeout)";
  this.route_order_not_execution = "Route Order Not Executed";
  this.route_order_in_execution = "Route Order Execution";
  this.end_road_order = "Road Order End";
  this.approval_failed = "Approval Failed";
  this.no_car_dispatched = "No Car Dispatched";
  this.abolished = "Abolished";
  this.not_approved = "Not Approved";
  this.car_dispatched = "Car Dispatched";
  this.unfinished_approval = "Approval Not Completed";
  this.currently_clocked_in = "Currently Clocked";
  this.choose_approval_type = "Choose Approval Type";
  this.companyIdnoUseCar = "Application number/approval code/user/unit";
  this.apply_for_car = "Apply Car";
  this.approval_code = "Approval Code";
  this.application_time = "Application Time";
  this.applicant = "Applicant";
  this.user_person_charge = "User/person in charge";
  this.reasons_using_car = "Use Car Reasons";
  this.car_unit = "Car Unit";
  this.approval_status1 = "Approval Status";
  this.next_approver = "Next Approver";
  this.approval_fail = "Approval Failed";
  this.cars_accept = "Cars Sent Accept";
  this.task_completed = "Task Completed";
  this.approved_succ = "Approved";
  this.write_requisition = "Fill Application Form";
  this.confirm_dele_requisition =
    "Please confirm to delete the car application form!";
  this.approved_final = "Approval Completed";
  this.examine_mydriver =
    "Application number/approval code/application type/applicant";
  this.approval_error = "Approval Failed";
  this.approval_operate = "Approval Operation";
  this.application_type = "Application Type";
  this.application_date = "Application Date";
  this.unfinished_approvals_number = "Unfinished Approvals Number";
  this.completed_approvals_number = "Completed Approvals Number";
  this.upgrade_management = "Upgrade Management";
  this.allotcar_serchIdno =
    "License plate number/approval code/dispatcher/driver/user/dispatch number/unit name";
  this.create_dispatch = "Create Dispatch";
  this.driver_type_selection = "Driver Type Selection";
  this.not_dispatching_application = "Application Form Not Dispatching Car";
  this.ispatching_application = "Application Form Dispatched Car";
  this.input_content_error = "Input error";
  this.use_car_time = "Use Car Time";
  this.pick_up_location = "Pick Up Location";
  this.additional_information = "Additional Information";
  this.confirm_department = "Department Confirmation";
  this.select_department = "Select Department";
  ...
  this.select_department_sub_department =
    "Please select the user's department or sub-department";
  this.confirm_select = "Confirm";
  this.select_driver_type = "Driver Type Selection";
  this.select_type = "Type Selection";
  this.more_car = "Multi-vehicle";
  this.waybilltype_tip_1 =
    "Only one driver/vehicle can be selected in the single selection, and the application number can only be the number that has not been uploaded.";
  this.waybilltype_tip_2 =
    "Multiple selection allows multiple drivers/vehicles to be selected, and the application number can only be the number of the uploaded file.";
  this.please_select_type = "Please choose the type";
  this.notice = "Notice";
  this.select_devIdno = "Application number/approval code/user";
  this.car_user = "Car User";
  this.car_user_phone = "Car User Phone";
  this.passenger_1 = "Passenger";
  this.car_application_details = "Car Application Details";
  ...
  this.zsy_journey_report = "Journey RPT";
  this.zsy_file_update = "Upload file cannot be larger than 50M";
  this.zsy_use_reason_tips =
    "[The Reason] is sent to the approver's short message, and the approver judges whether to dispatch a car based on this message. Please fill in it carefully!";
  ...
  this.zsy_edit_line = "Edit Line";
  this.zsy_health_status_healthy = "Healthy";
  this.zsy_health_status_generally = "Generally";
  ...
  this.zsy_department_move_tips =
    "Department does not support cross-company mobility";
  this.zsy_select_application = "Select application form";
  this.zsy_detail_application = "Application Form Info.";
  this.zsy_append_info =
    "[Additional information] It is added to the SMS to the driver, please fill in carefully";
  this.zsy_send_tips =
    "The newly-built dispatch form is used for the trains in the urban area, and the vehicle management personnel can dispatch the vehicles directly without selecting the application form.";
  this.zsy_load_vehicle_tips =
    "Failed to load the vehicle, please click the current company again!";
  this.zsy_load_driver_tips =
    "Failed to load the driver, please click the current company again!";
  this.zsy_vehicle_driver_tips =
    "In the case of multiple vehicles, the number of drivers and vehicles needs to be the same";
  this.zsy_line_one_start =
    "Please ensure that the route can only have one starting point";
  ...
  this.Handling_of_night_travel_ban_alarm =
    "Handling of night travel ban alarm";
  ...
  this.driver_vehicle_unfinished_tasks =
    "The driver or vehicle still has unfinished tasks";
  ...
  this.application_account_cannot_deleted =
    "Application for route orders other than this account cannot be deleted";
  ...
  this.task_send_first =
    "Failed, wait for the second delivery, more than 5 minutes apart";
  this.task_send_second =
    "Failed, wait for the third delivery, more than 15 minutes apart";
  this.task_send_third = "Failed";

  this.smart_residue_application_system =
    "Pingxiang City Smart Residue Application System";
  ...
  this.alarm_information = "Alarm Information";
  ...
  this.vehicle_violation = "Vehicle Violation";
  ...
  this.road_info_config_error =
    "Road information query configuration is incomplete";
  ...
  this.speed_imit_config_error =
    "The speed limit flag parameter configuration is incomplete";
  ...
  this.dispatch_cloud_platform = "dispatch cloud platform";
  this.mismatch = " Mismatch";
  this.label_departmentName = "Company";
  this.overspeed_threshold_summary_report = "Overspeed Threshold Summary RPT";
  ...
  this.alarm_name_1412 = "Threshold Speed Alarm Exceeded Ended";
  this.alarm_name_1412_default = "Threshold Speed Alarm Exceeded Ended";
  this.alarm_name_1413 = "Exceeding The Road Speed Limit Alarm Ended";
  this.alarm_name_1413_default = "Exceeding The Road Speed Limit Alarm Ended";
  ...
  this.complete_education = "Safety Education";
  ...
  this.alarm_handle_rate = "Alarm Handling Rate";
  ...
  this.subiao_vehicleTypeSummary = "Vehicle Type Alarm Analysis";
  this.play_video_chn_repeat =
    "The video information of this channel has been previewed on the video window index!";
  this.muck_data_cloud_screen =
    "Data Cloud Screen of Smart Waste Application System";
  ...
  this.sure_delete_this_approval_leave_type =
    "Confirm to delete this approval process, the deletion cannot be revoked!";
  this.earliest_time = "earliest time";
  this.latest_time = "latest time";
  this.hasReachedGpsHome =
    "The first picture of the picture associated with the GPS time has been reached";
  this.hasReachedGpsEnd =
    "The last picture of the picture associated with GPS time has been reached";
  ...
  this.collect_protocol_2003_bit4 =
    "Vehicle Characteristic Coefficients In The Recorder";
  this.collect_protocol_2003_bit5 = "Driving Speed Data In The Last 360 h";
  this.collect_protocol_2003_bit6 =
    "Vehicle VIN Number, License Plate Number, License Plate Classification";
  this.collect_protocol_2003_bit7 = "Suspicious Point Data In The Recorder";
  this.collect_protocol_2003_bit8 =
    "Cumulative Mileage In The Last 2 Calendar Days";
  this.collect_protocol_2003_bit9 =
    "Driving Speed Data In The Last 2 Calendar Days";
  this.collect_protocol_2003_bit17 =
    "Driving Timeout Data In The Last 2 Calendar Days";
  this.collect_protocol_2012_bit0 =
    "The Recorder Implements The Standard Version";
  ...
  this.report_roadLvlOverSpeedWarning_platform =
    "Road Level Speeding Warning (Platform)";
  this.alarm_name_1333 = "Road Level Speeding Warning (Platform)";

  this.safe_education = "Safety Education";
  ...
  this.finished_order_confirm =
    "This operation will force the completion of the task ticket, whether to confirm?";
  ...
  this.night_time_warning =
    "The night time range must be within the regular time range";
  this.alarm_name_1121 = "Cumulative fatigue (platform)";
  this.Overtime_driving_time = "Overtime driving time(Minute)";
  this.Vehicle_running_timeout_rule_daily =
    "Vehicle running timeout rule every day";
  ...
  this.remote_upgrade_task_delete_confirm =
    "Confirm to delete the remote upgrade task information?";
  ...
  this.edu_student_management = "Training Student Management";
  this.edu_course_management = "Training Course Management";
  ...
  this.is_no_disable_confirm =
    "Are you sure you want to undisable this student?";
  this.already_disable = "Disabled";
  this.driver_info = "Driver Information";
  this.select_uninstall_security_officer =
    "Please select an unassociated security officer!";
  this.uninstall_security_officer_delete_tips =
    "Do you want to delete unassociated security officers?";
  this.edu_course_name = "Course Name";
  this.edu_course_duration = "Course Duration";
  this.edu_course_type = "Course Type";
  this.is_release = "Whether to release";
  ...
  this.undone_num = "Unfinished Number of People";
  ...
  this.not_start = "Not Started";
  this.learning = "Learning";
  this.completed = "Completed";
  this.not_completed = "Not completed";
  ...
  this.revoke_publish_need_dismiss_bind =
    "To revoke the publication, you must first unbind all plans";
  ...
  this.zhanjiang_ledger_speeding_warning = "Road Speeding Warning Ledger";
  this.zhanjiang_ledger_location_video =
    "Positioning, Video Equipment Fault Ledger";
  this.zhanjiang_ledger_smart_video =
    "Monthly Vehicle Intelligent Video Surveillance";
  this.zhanjiang_ledger_daily_smart_video =
    "Daily Vehicle Intelligent Video Surveillance";
  this.zhanjiang_ledger_park = "Parking Records";
  this.zhanjiang_ledger_fatigue = "Fatigue Driving Alarm Ledger";
  this.zhanjiang_ledger_location_device = "Positioning Device Troubleshooting";
  this.zhanjiang_ledger_troubleshooting =
    "Daily In-vehicle Video Troubleshooting";
  this.zhanjiang_ledger_violations = "Follow-up Handling Of Violations Ledger";
  this.zhanjiang_ledger_vehicle_dynamic =
    "Enterprise Vehicle Dynamic Monitoring Record";
  this.zhanjiang_ledger_satellite_dynamic =
    "Vehicle Satellite Positioning Dynamic Monitoring Record";
  this.zhanjiang_ledger_video_dynamic =
    "Vehicle Intelligent Video Dynamic Monitoring Record";
  ...
  this.whether_suspicious_device_installed =
    "Whether Suspicious Device Installed";
  ...
  this.vehicle_terminal_working_normally =
    "Whether Vehicle Terminal Working Normally";
  ...
  this.select_paper_tip =
    "Tick the test papers randomly to select multiple test papers";
  this.start_before_now_30min = "Start time needs to be 30 minutes later";
  this.exam_relation_paper = "Test-related papers";
  this.question_order_random = "Random Order Of Test Questions";
  this.paper_random = "Random Test Paper";
  this.bound_learners = "Bound Learners";
  ...
  this.paper_tip1 =
    "The test paper has been published, operation is prohibited";
  this.exam_not_exist = "Exam does not exist";
  this.exam_tip1 = "Exam has started, operation is prohibited";
  this.exam_paper_stu_relation_not_exist =
    "Examination paper student association does not exist";
  this.question_tip1 =
    "The test questions have been bound to the test paper, and operation is prohibited";
  this.paper_tip2 =
    "The test paper is bound to the test, and operation is prohibited";
  this.examination_paper = "Related Test Papers";
  ...
  this.answer_time_long_exam_time =
    "The answer time cannot be longer than the test time";
  this.participation_details = "Participation Details";
  this.study_class = "Study Class";
  ...
  this.plan_course_stu_relation_not_exist =
    "Scheduled course student association does not exist";
  ...
  this.total_not_same =
    "Inconsistency in the total score or passing score of the test paper";
  ...
  this.excel_operator_notexist_error =
    "The operator of this line does not exist in the background, please contact the administrator to add it";
  this.weChatPushGroup_information =
    "Enterprise WeChat Alarm Push Configuration";
  this.robot_information = "Enterprise WeChat Alarm Push Robot";
  this.show_all_groups = "All Group";
  this.weChatPushGroup_login =
    "Enterprise WeChat alarm push group login is not supported";
  ...
  this.edu_import_driver_template =
    "Batch import and modify driver information EXCEL template (set the cell format before inputting data. Cell format>Number settings>Select text mode)";
  this.edu_driver_info = "Driver Info";
  ...
  this.course_must_input_minute =
    "The course duration must be entered in minutes";
  ...
  this.comfirm_delete_class =
    "Are you sure you want to delete this study class?";
  ...
  this.companyHasUserInfo =
    "User information still exists under the company and cannot be deleted";
  this.companyHasDeviceInfo =
    "Device information still exists under the company and cannot be deleted";
  this.companyHasGroupInfo =
    "There is still collaborative group information under the company, which cannot be deleted";
  this.companyHasSimInfo =
    "There is still sim card information under the company and cannot be deleted";
  this.companyHasVehicleInfo =
    "Vehicle information still exists under the company and cannot be deleted";
  this.companyHasRoleInfo =
    "The role information still exists under the company and cannot be deleted";
  this.companyHasDriverInfo =
    "The driver information still exists under the company and cannot be deleted";
  this.companyHasIcCardInfo =
    "The IC card information still exists under the company and cannot be deleted";
  this.companyHasRuleInfo =
    "There is still rule information under the company and cannot be deleted";
  this.companyHasProjectInfo =
    "There is still project filing information under the company, which cannot be deleted";
  this.companyHasComapnyInfo =
    "Sub-department information (subsidiaries, fleets, etc.) still exists under the company, which cannot be deleted";
  ...
  this.operator_time = "Operation time";
  ...
  this.errClassificationNotExists =
    "There is no corresponding value in the classification list";
  ...
  this.alarm_name_1002 = "Abnormal temperature alarm";
  ...
  this.infrared_blocking_sunglasses_identification =
    "Infrared Blocking Sunglasses Identification";
  ...
  this.appeal = "Appeal";
  this.safe_alarm_appeal = "Active Safety Alarm Appeal";
  this.safe_alarm_appeal_audit = "Active Safety Alarm Appeal Audit";
  ...
  this.pend_review = "Pending review";
  ...
  this.audit_time = "Audit Time";
  this.label_appeal_time = "Appeal Time:";
  this.alarm_appeal = "Alarm Appeal";
  this.alarm_audit = "Alarm Audit";
  this.not_select_appeal_audit =
    "Cannot check both the alarm appeal and the alarm audit";
  this.alarm_exceed_48hour =
    "The alarm cannot be appealed for more than 48 hours";
  ...
  this.safe_product = "Safety Standardization";
  this.today_incoming_alarm_information =
    "Today's incoming and outgoing storage yard alarm information";
  this.plan_start_not_unbind_trainees =
    "Plan has started, cannot unbind trainees";
  this.plan_start_not_unbindorbind_course =
    "Plan has started, cannot bind and unbind courses";
  ...
  this.main_defense_belongs_video =
    "The main defense equipment also belongs to the video equipment";

  this.upload_user = "Upload User";
  this.upload_time = "Upload Time";
  this.alarm_name_1128 = "Day Fatigue (Platform) Ends";
  this.alarm_name_1129 = "Night Fatigue (Platform) Ends";
  ...
  this.general_cargo_vehicle_registration_certificate =
  ...
  this.general_cargo_vehicle_type_23 =
    "Heavy-duty Non-cargo Special Operation Vehicle";
  ...
  this.general_cargo_vehicle_type_26 =
    "Heavy-duty Cargo Special Operation Vehicle";
  ...
  this.general_cargo_vehicle_type_30 =
    "Medium-sized Cargo Special Operation Vehicle";
  ...
  this.general_cargo_vehicle_type_36 =
    "Medium-sized Non-cargo Special Operation Vehicle";
  ...
  this.general_cargo_vehicle_type_47 =
    "Light Non-cargo Special Operation Vehicle";
  ...
  this.general_cargo_vehicle_type_65 =
    "Large Non-cargo Special Operation Vehicle";
  ...
  this.data_downlink_transparent_transmission =
  ...
  this.not_have_shensu_shenhe =
    "Cannot have both appeal and review permissions";
  ...
  this.upgrade_failed_device_not_peripherals =
    "Upgrade Failed,Device Not Peripheral";
  ...
  this.number_of_cycle_vehicles_on_enterprise_platform =
    "Number Of Cycle Vehicles On The Enterprise Platform";
  this.number_of_current_cycle_vehicles_on_enterprise_platform =
    "Number Of Current Cycle Vehicles On The Enterprise Platform";
  ...
  this.upgrade_failed_device_match =
    "Upgrade Failed (Hardware model not supported)";
  this.upgrade_failed_device_same = "Upgrade Failed (same software version)";
  this.upgrade_failed_device_soft =
    "Upgrade Failed (the software version is not supported)";
  ...
  this.batch_register_install_prove = "Batch Registration Installation Prove";
  this.not_register_install_prove =
    "No registration and installation proof information found";
  this.zhejiang_standard_install_prove = "Zhejiang Standard Installation Prove";

  this.appeal_is_exist =
    "Appeal has been submitted for this alarm, please do not submit it again";
  ...
  this.course_time_big_plan =
    "The total duration of the course bound to the plan cannot be greater than the planned duration";
  this.all_course_time = "Total course duration";

  this.starttime_big30_endtime =
    "Start time must be half an hour greater than current time";
  this.plantime_big_coursetime =
    "The plan time cannot be less than the course time";
  this.fleet = "Fleet";

  this.authorCompanyError =
    "(The user does not have the permission of the company to which the vehicle belongs, and it is not supported to modify the company to which the vehicle belongs.)";

  this.car_price = "Car Price";
  this.car_bill = "Car Bill";
  this.alarm_is_handle = "The alarm has been handled and cannot be appealed";

  this.please_remove_tranner_course =
    "Please unbind trainees and courses first";

  this.checkInternetPortVaild =
    "Please fill in the correct port range (0~65535)";
  this.alarm_areade_shensu =
    "The alarm has been appealed and cannot be processed";
  ...
  this.lock_switch_rpt = "Electronic Lock Switch Rpt";
  ...
  this.geo_coder_type = "Location Resolution Type";
  this.geo_coder_config_error =
    "The location resolution configuration is incomplete";

  this.custom_baidu_coder = "Custom location resolution";
  ...
  this.baidu_orc_code_216202 = "input oversize";
  ...
  this.baidu_orc_code_282003 = "missing parameters: {参数名}";
  ...
  this.qualification_certificate_img_url =
    "Picture Of Professional Qualification Certificate";
  this.operating_certificate_img_url = "Photo Of Operating Certificate";
  this.fingerprint_img_url = "Fingerprint Image";
  this.driver_bank_card_number = "Driver's Bank Card Number";
  ...
  this.vehicle_been_to_line =
    "The vehicle has been assigned to the line, the vehicle type cannot be modified! ";
  this.unable_recognize_face =
    "Unable to recognize the facial information in the ID photo";
  ...
  this.types_of_Qualification_Certificates =
    "types_of_Qualification_Certificates";
  ...
  this.Policyholder_name = "Policyholder's name";
  ...
  this.Breakdown_of_Average_Speeding_Times =
    "Breakdown of Average Speeding Times";
  this.Average_speed_statistics_table = "Average speed statistics table";
  this.Average_speed = "Average speed";
  this.Breakdown_of_Average_Fatigue_Driving_Hours =
    "Breakdown of Average Fatigue Driving Hours";
  this.Summary_table_of_average_fatigue_driving_time =
    "Summary table of average fatigue driving time";
  ...
  this.Fatigue_driving_times = "Fatigue driving times";
  this.Average_number_of_fatigued_driving =
    "Average number of fatigued driving";
  ...
  this.Secondary_alarm_processing_timeout =
    "Secondary alarm processing timeout";
  this.method_to_informe = "method to informe";
  this.SMS_notification = "SMS notification";
  this.Notify_the_city_road_transport_management_agency =
    "Notify the city road transport management agency";
  this.Only_a_single_alarm_type_can_be_selected =
    "Only a single alarm type can be selected";
  ...
  this.Number_of_prohibited_passenger_vehicles =
    "Number of prohibited passenger vehicles";
  ...
  this.Sichuan_Regulatory_Statement = "Sichuan Regulatory Statement";
  ...
  this.Enterprise_Line_Offset_Summary_Table =
    "Enterprise Line Offset Summary Table";
  ...
  this.chagang_question = "chagang content";
  this.chagang_answer = "chagang reply content";
  this.chagang_company = "chagang company";
  this.check_question_answer =
    "Check post content and post check reply content must fill in both values, or neither";
  this.check_company = "Checked company";
  this.check_company_license_number =
    "Checked company operating license number";
  this.higher = "Higher";
  ...
  this.subdirectories_exist =
    "There are subdirectories in the directory and cannot be deleted";
  ...
  this.comfirm_delete_vehi_certificate =
    "Are you sure you want to delete this vehicle permit?";
  this.export_success = "Export success";
  this.not_relate_vehi = "No related vehicles";

  this.obd_error_code_P0000 = "No Fault";
  this.obd_error_code_P0100 = "Bad air flow meter wiring";
  ...
  this.obd_error_code_P0105 = "Intake pressure sensor wiring is bad";
  ...
  this.obd_error_code_P0108 =
    "Intake pressure sensor input voltage is too high";
  this.obd_error_code_P0109 =
    "Defective intake air temperature sensor circuit or intermittent poor intake air pressure sensor circuit";
  this.obd_error_code_P0110 =
    "Intermittent failure of intake air temperature sensor circuit";
  this.obd_error_code_P0111 =
    "Defective wiring of intake air temperature sensor";
  ...
  this.belong_organize = "Belong to the organization";
  this.max_connection = "Maximum number of connections";
  this.digital = "digital";
  this.team_existchild_notMoveTeam =
    "It is not supported to carry sub-fleet to boast the company to move (there is also a sub-fleet, and the lowest-level team will be moved first)!";
  ...
  this.passwordModifyTimeRangeLimit =
    "Reminder days must not be greater than or equal to expiration days";
  this.password_expiry_tips = "Your password will expire in d% days (s%)";
  this.password_expired_tips =
    "Your password has expired d% days, expiry date(s%)";
  ...
  this.unused_capacity = "Remaining Capacity";
  ...
  this.parent_node_cannot_directory_node =
    "The parent node cannot be a directory node";

  this.select_company_num_300 =
    "There are too many companies to select, at most 300 companies can be selected at a time";
  ...
  this.cbTrip_travel = "Travel Passenger Itinerary Management";
  this.cbTrip_chemical = "Dangerous Goods Trip Management";
  ...
  this.cbOverspeed_summary_company =
    "Company Sustained Overspeed Summary Table";
  ...
  this.Populate_order_tips =
    "The current order can be filled from the driver's phone";
  this.Driver_phone_cannot_be_empty = "Driver phone cannot be empty";
  this.route_enquiry = "route enquiry";
  ...
  this.report_driving_abnormal_monthly = "Abnormal Driving Behavior (Monthly)";
  this.report_driving_abnormal_daily = "Abnormal Driving Behavior (Daily)";
  ...
  this.Delivery_status = "Delivery status";

  this.law_enforcement_number = "Enforcement Number";
  this.personnel_number = "personnel number";
  this.Failed_to_send_notification =
    "Tip:If the delivery fails,can check the resend below";
  ...
  this.average_fatigue_drive_time_report =
    "Average fatigue driving time report";
  this.average_speeding_number_report = "Average Speeding Report";
  this.Schedule_time = "Schedule time";

  this.zhanjiang_monitoring_ledger = "Monitoring ledger (Zhanjiang)";
  this.hubiao_monitoring_ledger = "Monitoring ledger (Shanghai standard)";
  this.chuanbiao_monitoring_report = "Monitoring report (Chuanbiao)";
  this.heibiao_monitoring_report = "Monitoring Report (Black Label)";
  this.jibiao_monitor_log = "Monitor log (jibiao)";
  this.jibiao_operational_data = "Operational data (jibiao)";
  this.jibiao_company_reporting_violations =
    "Company Violation Reporting (Jibiao)";
  this.passenger_statistics_report = "Passenger Statistics Report";

  this.passenger_detail_1078 = "Passenger Statistics Details (1078)";
  this.passenger_summary_1078 = "Passenger Statistics Summary Table (1078)";
  this.comprehensiveKeyAlarmReport = "Comprehensive Key Alarm RPT";
  this.keyActiveSafetyAlarmStatistics =
    "Key Active Safety Alarm Statistics RPT";
  ...
  this.vehicleOperatingLicense = "Operating License Number";
  this.vehicleStopwatchMileage = "Stopwatch Mileage";
  this.vehicleExpiryBusinessPeriod = "Expiry Time Business Period";
  ...
  this.import_vehicleExpiryBusinessPeriod =
    "Expiry Time Business Period(2017-11-11)";

  this.hava_lower_level_region =
    "There are lower administrative regions, which cannot be deleted";
  this.comfirm_delete_region =
    "Are you sure you want to delete this administrative region?";
  this.parent_region_name = "Name of the superior administrative region";
  ...
  this.speed20_10up =
    "Under 20% overspeed for more than 10 (inclusive) minutes";
  this.speed20to50_5inside = "Overspeed 20 (inclusive)-50% within 5 minutes";
  this.speed20to50_5to10inside =
    "Overspeed 20 (inclusive)-50% 5 (inclusive)-10 minutes";
  this.speed20to50_10up =
    "Overspeed 20 (inclusive)-50% for 10 (inclusive) minutes or more";
  this.speed50_5inside = "50% overspeed (inclusive) within 5 minutes";
  this.speed50_5to10inside =
    "50% overspeed (inclusive) 5 (inclusive)-10 minutes";
  this.speed50_10up =
    "Overspeed 50% (inclusive) for more than 10 (inclusive) minutes";
  this.chain_same_radio = "Chain ratio, YoY";
  this.vehicle_schedule_info_month_report =
    "Vehicle scheduling information statistics monthly report";
  this.vehicle_schedule_info_company_month_report =
    "Vehicle Scheduling Information Road Transport Enterprise Statistics Monthly Report";
  this.online_time_range = "Online Time Range";
  this.time_range_position_num = "Number of time range positioning bars";
  this.company_online_time_month_report =
    "Company Online Time Statistics Monthly Report";
  this.user_online_time_month_report =
    "User Online Time Statistics Monthly Report";
  ...
  this.transport_num = "Quantity of transport items";
  this.transport_unit = "Transport Unit";
  ...
  this.query_position_info_vehicle =
    "View positioning information (number of vehicles)";
  this.query_history_track_vehicle =
    "View historical track (number of vehicles)";
  this.query_video_vehicle = "View video (number of vehicles)";
  this.illegal_handle_vehicle = "Illegal handling (number of vehicles)";
  this.query_position_info_percentage =
    "View Positioning Information (Percentage)";
  ...
  this.vehicle_inspections_statistical =
    "Statistical table of the number of vehicle inspections";
  this.company_inspections_statistical =
    "Company Vehicle Spot Inspection Statistical Report";
  this.on_job_time = "Job Time";
  this.user_inspections_vehicle_statistical =
    "Statistical report of user's random inspection of vehicles";
  ...
  this.Failed_to_deliver = "Failed to deliver";
  ...
  this.Department_speeding_assessment_report =
    "Speeding Assessment Report in Vehicle Department";
  ...
  this.Violation_Alarm_Type_Configuration_905 =
    "905 Violation Alarm Type Configuration";
  this.Capacity_Statistics_of_Key_Regions =
    "Capacity Statistics of Key Regions";
  this.Comparison_of_car_hailing_and_cruise_cars =
    "Comparison of car-hailing and cruise cars";
  ...
  this.Number_of_single_vehicle_violations =
    "Number of single vehicle violations";
  this.Number_of_single_vehicle_complaints =
    "Number of single vehicle complaints";
  ...
  this.storageConfig = "Object Storage Configuration";
  ...
  this.safetyEvaluationConfig = "Safety Evaluation";
  this.normalFunctionConfig = "General Function Configuration";
  this.wisdom_kanban = "Smart Kanban";

  this.comprehensiveKeyAlarmReportConfig =
    "Comprehensive Key Alarm Custom Configuration";
  this.edit_alarm_comprehens_key_customize_info =
    "COMPREHENSIVE KEY ALARM CUSTOM CONFIGURATION";
  this.confirm_alarm = "ACKNOWLEDGE ALARM";
  this.operation_result = "OPERATION RESULT";
  this.alarm_message_serial_number = "ALARM MESSAGE SERIAL NUMBER";
  this.manual_acknowledgment_of_alarm_types =
    "MANUAL ACKNOWLEDGMENT OF ALARM TYPES";
  this.acknowledge_emergency_alarm = "ACKNOWLEDGE EMERGENCY ALARM";
  this.acknowledge_hazard_alarm = "ACKNOWLEDGE HAZARD ALARMS";
  this.acknowledge_entry_and_exit_alarm =
    "ACKNOWLEDGING ENTRY AND EXIT ZONE ALARMS";
  this.acknowledge_in_and_out_alarm =
    "CONFIRM THE INCOMING AND OUTGOING ROUTE ALARM";
  this.acknowledge_travel_time_alarm =
    "Confirm that the driving time of the road section is insufficient and too long to alarm";
  this.acknowledge_vehicle_illegal_ignition_alarm =
    "CONFIRM THE VEHICLE ILLEGAL IGNITION ALARM";
  this.acknowledge_illegal_vehicle_displacement_alarm =
    "CONFIRMATION OF ILLEGAL VEHICLE DISPLACEMENT ALARM";
  this.confirm_alarm_tip =
    "Serial number of alarm messages that need manual confirmation, 0 means all messages of this alarm type";
  this.errCheckTheDay =
    "Check the start time of the day and set the end time to be the same";
  ...
  this.electric_fence_report = "Electric Fence Report";
  ...
  this.import_vehicle_template =
    "Batch import and modify vehicle information EXCEL template (set the cell format before inputting data. Cell format>Number settings>Select text mode)";
  ...
  this.errLogin_supper_expired =
    "The superior user has expired and the login failed!";
  ...
  this.dynamic_monitoring_ledger = "Dynamic monitoring ledger";
  this.please_select_statistics_time = "Please select the statistics time";
  this.device_terminal_num = "Number of device terminals";
  this.way_line_info =
    "Special weather, road conditions and measures along the road section of the relevant line";
  this.devices_online_num = "Number of devices online";
  this.monitor_staff = "Monitor";
  ...
  this.abnormal_situation_record =
    "Abnormal situation record found in real-time monitoring";
  ...
  this.content_measure_info =
    "When the speeding vehicle stops and rests, the phone will remind you to slow down; if you are fatigued and do not stop and rest for more than the specified time, the phone will remind you to ensure safety!";
  this.upload_max_tips = "Up to 6 files can be uploaded";
  this.hava_lower_level_company =
    "There are lower-level companies, which cannot be deleted";
  this.hava_lower_region_user =
    "There is still user information under the administrative region, which cannot be deleted";
  this.hava_lower_region_project =
    "There is still project report information under the administrative region, which cannot be deleted";
  this.hava_lower_region_role =
    "There is still role information under the administrative region, which cannot be deleted";
  this.edit_evaluation = "Edit Evaluation";

  this.Add_temporary_group = "Add temporary group";
  this.remove_temporary_grouping = "remove temporary grouping";
  this.temporary_grouping = "temporary grouping";
  ...
  this.exists_bind_lang =
    "Language type has been configured (language type + language entry = unique)";
  ...
  this.driver_vehicle_match =
    "The driver's binding vehicle company does not match, the driver can only bind the vehicle of the current company";
  this.lichengMaxCheckTip =
    "The database storage is out of bounds, and the mileage cannot be greater than 4294967295";

  this.view_right_answer = "See Correct Answer";

  this.standard1078JiangSu = "Ministry Standard Active Safety (Jiangsu)";
  ...
  this.Complaining_about_the_license_plate_number =
    "Complaining about the license plate number";
  this.Please_enter_the_reason_for_your_complaint =
  ...
  this.alarm_channel_plus_tips =
    "(1~255) 100: Control ADAS to take pictures; 101: Control DSM to take pictures; 103: Control the right blind spot to take pictures";

  this.mileage_of_the_day = "YesterdayS Mileage";
  this.mileage_of_the_month = "Mileage Last 30 Days";
  ...
  this.map_nav_tu_no_same =
    "The via point cannot be the same as the start or end point";
  ...
  this.No_travel_rules_chuan = "No travel rules(ChuanBiao)";
  this.No_travel_rules_hei = "No travel rules(HeiBiao)";
  this.No_travel_rules_Heibiao_tip =
    "Dangerous goods vehicles: No high-speed traffic from 0-6 o'clock. Passenger travel: 1-4 points of expressways and national highways in the province are prohibited, and 2-5 points of expressways and national highways outside the province are prohibited.";
  ...
  this.selThisAfterSelVideo =
    "After selecting the video attribute, you can select the intercom attribute and the monitoring attribute！";
  ...
  this.collection_station_code_already_exists =
    "Collection Station Code Already Exists";

  this.net_alarm_now_pressure = "pressure";
  this.net_alarm_now_voltage = "Voltage";
  ...
  this.Trajectory_abnormal = "abnormal trajectory";
  ...
  this.subiao_bsd = "Blind spot monitoring";
  this.operational_data_time_error =
    "Only data before the current day can be exported";
  ...
  this.alarm_name_identification = "Deployment control report";
  this.monitorer = "monitorer";
  this.maxVehicleNumErrorCode7 =
    "The limit number cannot exceed the authorized number";
  ...
  this["Corporate.violation.reporting"] = "Enterprise violation report";
  this["Forced.checkout"] = "Forced sign out";
  this["satellite_positioning_type_1"] = "satellite positioning";
  this["Taxi.summer.operation.statistics"] = "Taxi duty summary table";
  this["Order.Status6"] = "driver cancels";
  this["Order.Status5"] = "Center Cancellation";
  this["Order.Status4"] = "completed";
  this["Order.Status3"] = "in execution";
  this["Order.Status2"] = "Order received";
  this["Order.Status1"] = "has been issued";
  this["Order.Status0"] = "not issued";
  this["report.alarm.disposaa"] = "Alarm handling statistics report";
  this["fierce_driving_type_1"] = "driving hard";
  this["No.positioning.data"] = "No location data";
  this["Taxi.detail.operation.statistics"] = "Taxi schedule";
  this["Alarm.disposition.statistics.report"] =
    "Alarm handling statistics report";
  this["report.net_alarm_type_sb_l1_hit_pedestrian"] =
    "Pedestrian collision warning level 1";
  this["Overspeed.Threshold.Report"] = "Overspeed Threshold Report";
  this["znjc_1"] = "Intelligent detection";
  this["Operating.time"] = "Operation time";
  this["No.photo"] = "no photo";
  this["Normal.checkout"] = "normal checkout";
  this["Block.the.lens"] = "Block the lens";
  this["Twist.the.lens"] = "Twist the lens";
  this["Speeding"] = "Speeding";
  this["Black.screen"] = "black screen";
  this["report.deviceModify.report.detail"] = "Equipment Change Report";
  this["report__alarm_type_verify_through"] =
    "The driver's driving verification passed the alarm";
  this["Trajectory.abnormal"] = "abnormal trajectory";
  this["Offline.operation"] = "Offline operation";
  this["Speeding.duration"] = "Overspeed Duration";
  this["Taxi.month.operation.statistics"] = "Taxi Monthly Operation Statistics";
  this["Traffic.jam"] = "traffic jam";
  this["Overspeed.warning.difference"] = "Overspeed warning difference";
  this["Order.Type2"] = "vehicle assignment";
  this["Order.Type1"] = "Book a car";
  this["Order.Type0"] = "instant call";
  this.crud_demo = "CRUD";
  this.windowOnTop = "top";
  this.cancelWindowOnTop = "unpin";
  this.data_type = "data category";
  this.server_params = "server parameters";
  this.obd_error_code_P0112 =
    "Intake air temperature sensor line voltage too low";
  this.obd_error_code_P0113 =
    "Intake air temperature sensor line input voltage is too high";
  this.obd_error_code_P0114 =
    "Intake air temperature sensor circuit intermittent fault";
  ...
  this.obd_error_code_P0117 =
    "Engine water temperature sensor voltage is too low";
  this.obd_error_code_P0118 =
    "Engine water temperature sensor voltage is too high";
  this.label_already_exists = "Label already exists";
  this.exists_bind_report =
    "It has been bound by the report, please unbind it first";
  this.load_team_unfinish =
    "The fleet information reload has not been completed, please be patient!";
  ...
  this.one_student_max_three_parent =
    "A student can only bind up to three parents";
  ...
  this.Service_Expiration_Date_Modification =
    "Service Expiration Date Modification";

  this.param_config_hb_video_needle =
    "(Hebei) Video Frame Sampling Task Delivery";
  ...
  this.hb_video_needle_content_tips =
    "The format is: millisecond stamp|url suffix; millisecond stamp|url suffix";
  ...
  this.large_screen_auto_previews_main_stream =
    "Large screen automatically previews the main stream";

  this.account_vehicle_import =
    "Import EXCEL template of user vehicle authorization (recommended cell format>number setting>select text mode)";
  ...
  this.excel_account_permit_error =
    "The user has no login account operation permission";
  this.excel_account_type_error =
    "The login account cannot be the company's main account or admin";
  this.excel_vehicle_not_exist_error =
    "The license plate number does not exist";
  this.excel_vehicle_permit_error =
    "User operates without license plate number";
  this.vehiIdnoCompanyError =
    "The company to which the license plate number belongs does not exist";
  this.accountCompanyError = "The company of the login account does not exist";
  this.accountVehiIdnoCompanyError =
    "The company of login account and license plate number does not match";
  this.accountVehiIdnoPermitError =
    "Login account and license plate number have been associated with authorization";
  ...
  this.huaBaoHead_deviceId = "Device ID";
  this.huaBaoHead_driver = "Driver Name";
  this.huaBaoHead_trip = "Trip";
  this.huaBaoHead_beginTime = "Start Time/Date";
  this.huaBaoHead_endTime = " End Time/Date";
  this.huaBaoHead_length = "Total (HH:MM)";
  this.huaBaoHead_mile = "Odometer (KM)";
  this.huaBaoHead_startLiCheng = "Start Mileage";
  this.huaBaoHead_endLiCheng = "End Mileage";
  this.huaBaoHead_liCheng = "Total Mileage";
  this.huaBaoHead_speed = "Speed (KM/H)";
  this.huaBaoHead_avgSpeed = "Avg.";
  this.huaBaoHead_masSpeed = "Max";
  this.huaBaoHead_overSpeedTimes = "OverSpeed Count";
  this.huaBaoHead_oil = "Fuel Consumption ";
  this.huaBaoHead_oilUse = "Usage (L)";
  this.huaBaoHead_oilPerKm = "L/Km";
  this.huaBaoHead_park = "Idling";
  this.huaBaoHead_parkLength = "Time (HH:MM)";
  this.huaBaoHead_parkTimes = "Count";
  this.huaBaoHead_safeAlarm = "Alarms Count Per Trip";
  this.huaBaoHead_drink = "Breathalyzer";
  this.huaBaoHead_slamBrake = "Harsh Breaking";
  ...
  this.huaBaoReport = "Trip Detailed Report";
