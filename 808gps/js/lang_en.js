function langEnglish() {
    ...
    this.rule_fatigue_single_span = "Fatigue driving alarm violation (single driving)";
    ...
    this.errGroupHasUsed = "The fleet information is still being occupied (there are still sub-fleet or vehicles under the fleet)!"; //RET_GROUP_HAS_USED = 27;  //车辆分组信息还在被占用（还存储子分组或者下级车辆）
    ...
    this.delete_before_company = "(Need to first remove the vehicle under the company, the team, role, device, sim card, driver, IC Card, Project filing, Rule information)";
    ...
    this.passwordcheck = "Password length of at 8 - 12, Must contain numbers, uppercase and lowercase letters";
...
//  2017-07-06 中石油电子路单
    ...
    this.normal_user_limit = "Ordinary users are not authorized to view drivers of unauthorized vehicle companies!";
    ...
    this.taxi_alarm_violation_ = "Operation Without Meter /Online Car Parade Alarm";
    ...
    this.alarm_type_nightdriving_zsy = "Night driving is forbidden without a road order at night (platform)";
    ...
    this.Reached_limit_operation_times_time = "Reached Limit Operation Times/Time";
    ...
    this.Limit_number_of_operations_time_not_reached = "Limit number of operations / time not reached";
    ...
    this.empty_weight_both_zero = "The number of empty cars and the number of shutdowns cannot be 0";
    ...
    this.companyIndexTrendSafeLabel = "Trend Chart Of Company Active Safety Indicators";
    ...
    this.Daily_monthly_report_of_network_access_rate = "Daily/monthly report of network access rate";

    this.Daily_monthly_report_of_online_rate_of_online_joint_control = "Daily / monthly report of online rate of online joint control";
    ...
    this.Daily_monthly_report_of_integrity_rate_networked_joint_control_track = "Daily/monthly report of integrity rate of networked joint control track";
    ...
    this.Report_of_Data_Qualification_Rate_for_Networked_Control = "Daily/Monthly Report of Networked Joint Control Data Qualification Rate";
    ...
    this.report_on_response_rate_of_online_joint_control_inspection = "Daily/monthly Report On Response Rate Of Online Joint Control Inspection";
    ...
    this.Internet_not_speeding_report = "Daily/monthly report of networked joint control without speeding";
    ...
    this.Alarm_report_of_network_joint_company = "Network Joint Control Company RPT";
    ...
    this.report_networked_control_daily_monthly_report = "Daily / monthly report of Networked Joint Control Summary";
    ...
    this.driver_identification_evidence_center = "Driver Identification Evidence Center";
    this.vehicle_operation_monitoring_evidence_center = "Vehicle Operation Monitoring Evidence Center";
    this.equipment_failure_monitoring_evidence_center = "Equipment Failure Monitoring Evidence Center";
    ...
    this.The_ranking_of_waste_disposal_field = "The ranking of waste disposal field";
    ...
    this.importMapTypeNew = "(3：Baidu 4：Autonavi 7：Baidu Offline 8：Google Offline  9：bing  10：OSM 11：Google 12：Mapbar 18: TianDi Map)";
    ...
    this.Online_Appointment_Driving_License_Validity_Start_Time = "Online Appointment Driving License Validity Start Time";
    this.Online_Appointment_Driving_License_Validity_End_Time = "Online Appointment Driving License Validity End Time";
    ...
    this.Offline_displacement_daily_report_black = "Offline displacement daily report";
    this.Prohibited_daily_report = "Daily report for night ban";
    this.Offline_daily_report_black = "Offline daily report";
    this.Monthly_report_of_vehicle_driving_behavior_ranking = "Monthly report of vehicle driving behavior ranking";
    ...
    this.Driver_evaluation_index_management = "Driver evaluation index management";
    this.Enterprise_evaluation_index_management = "Enterprise evaluation index management";
    this.Driver_indicator_version_management = "Driver evaluation index version management";
    ...
    this.Enterprise_credit_abnormal_warning = "Enterprise credit abnormal early warning";
    ...
    this['mountain_road_ban'] = 'Mountain Road Ban';
    this['account.strongPassword'] = 'Password (strongly used, the password length is 8-12 digits, Must contain numbers, uppercase and lowercase letters)';
    ...
    this.The_evaluation_result_was_not_found = "The evaluation result was not found";
    ...
    this.intelligent_risk_control_operation_report = "Intelligent risk control operation report";
    ...
    this.safe_assessment_summary = "Summary of active safety assessment indicators";
    ...
    this.enterprise_alarm_processing_analysis = "Enterprise Alarm Processing Analysis";
    this.enterprise_operation_management_score = "Enterprise Operation Management Score";
    ...
    this.company_vehicle_type_alarm_processing_analysis = "Enterprise Vehicle Types Analysis";
    this.company_alarm_type_processing_analysis = "Enterprise Alarm Type Analysis";
    this.company_company_type_processing_analysis = "Company Type Processing Analysis";
    ...
    this.password_error = "The password length is 8-12 digits and must contain numbers, uppercase letters and lowercase letters";
    ...
    this.active_security_enterprise_alarm_ranking = "Active Security Enterprise Alarm Ranking";
    ...
    this.admin_recv_platform_type1 = "The type of the admin receiving check post is the current connected sub-platform";
    ...
    this.On_board_terminal_maintenance_ledger = "On board terminal maintenance ledger";
    ...
    this.IntelligentRecognition_title = "Parameters of Intelligent Recognition System"
    ...
    this.Infrared_blocking_sunglasses_failure_alarm = "Infrared blocking sunglasses failure alarm"
    ...
    this.edit_alarm_summary_customize_info = "Custom Alarm Statistics Configuration";
    this.edit_alarm_push_customize_info = "Alarm Push Configuration";
    this.edit_alarm_key_customize_info = "Security Report Key Alarm Custom Configuration";
    ...
    this.edit_screen_alarm_customize_info = "Smart Cloud Screen Alarm Customization";
    ...
    this.No_operation_troubleshooting_account = "No operation troubleshooting account";
    ...
    this.department_labelSearchVehi = "Find People";
    this.department_drag_tip = "You can use the drag method to move the department, and the company's subordinate departments can move each other;";
    this.department_move_tip = "Click the company to refresh the unassigned personnel; click the department to refresh the assigned personnel; the personnel must be removed from the department before they can be assigned to other departments; the personnel can only be assigned to the departments under the company;";
    ...
    this.department_selectGroupNode = "Please select a company or department node!";
    this.department_editNotCompanyNode = "The company information cannot be modified, please select the department node!";
    this.department_selectTeamNode = "Please select department node!";
    this.department_groupHasChild = "There are sub-departments in this department, which cannot be deleted!";
    this.department_selectFreeVehi = "Please select unassigned personnel";
    this.department_selectGroupVehi = "Please select the assigned person";
    this.department_exist = "Department information does not exist";
    this.department_have_people = "There are also assigned personnel under the department";
    this.department_name_exist = "Department name already exists";
    ...
    this.please_choose_department = "Please select department or department sub-node!";
    this.approval_null_error = "The approval type cannot be empty!";
    this.sure_delete_this_approval_type = "Confirm to delete this approval type, the deletion cannot be revoked!";
    this.sure_push_all_info = "Do you want to push all process information under this approval type?";
    this.sure_cancel_push_all_info = "Do you want to cancel the push of all process information under this approval type?";
    this.push_info = "Push Approval Information";
    this.approval_flow_management = "Approval Process";
    ...
    this.process_tip_drag = "First select the department in the department list, load the approval type, and then select the approval type, load the user and user list in the approval process;";
    this.process_tip_move = "The approval type can be selected to move up and down; each approval type corresponds to an approval process; users in the same department can be assigned to different approval processes; deleting an approval type will delete the corresponding approval process.";
    ...
    this.confirm_dele_requisition = "Please confirm to delete the car application form!";
    this.approved_final = "Approval Completed";
    this.examine_mydriver = "Application number/approval code/application type/applicant";
    this.approval_error = "Approval Failed";
    this.approval_operate = "Approval Operation";
    this.application_type = "Application Type";
    this.application_date = "Application Date";
    ...
    this.waybilltype_tip_1 = "Only one driver/vehicle can be selected in the single selection, and the application number can only be the number that has not been uploaded.";
    this.waybilltype_tip_2 = "Multiple selection allows multiple drivers/vehicles to be selected, and the application number can only be the number of the uploaded file.";
    ...
    this.Handling_of_night_travel_ban_alarm = "Handling of night travel ban alarm";
    ...
    this.report_roadLvlOverSpeedWarning_platform = "Road Level Speeding Warning (Platform)";
    ...
    this.Vehicle_running_timeout_rule_daily = "Vehicle running timeout rule every day";
    ...
    this.batch_delete_data = "Data cannot be restored after deletion! Do you want to delete it?";
    ...
    this.zhanjiang_ledger_location_video = "Positioning, Video Equipment Fault Ledger";
    this.zhanjiang_ledger_smart_video = "Monthly Vehicle Intelligent Video Surveillance";
    this.zhanjiang_ledger_daily_smart_video = "Daily Vehicle Intelligent Video Surveillance";
    ...
    this.zhanjiang_ledger_troubleshooting = "Daily In-vehicle Video Troubleshooting";
    this.zhanjiang_ledger_violations = "Follow-up Handling Of Violations Ledger";
    this.zhanjiang_ledger_vehicle_dynamic = "Enterprise Vehicle Dynamic Monitoring Record";
    this.zhanjiang_ledger_satellite_dynamic = "Vehicle Satellite Positioning Dynamic Monitoring Record";
    this.zhanjiang_ledger_video_dynamic = "Vehicle Intelligent Video Dynamic Monitoring Record";
    ...
    this.Populate_order_tips="The current order can be filled from the driver's phone";
    ...
    this.average_fatigue_drive_time_report = "Average fatigue driving time report";
    ...
    this.jibiao_company_reporting_violations = "Company Violation Reporting (Jibiao)";
    ...
    this.keyActiveSafetyAlarmStatistics = "Key Active Safety Alarm Statistics RPT";
    ...
    this.Comparison_of_car_hailing_and_cruise_cars="Comparison of car-hailing and cruise cars";
    ...
    this.comprehensiveKeyAlarmReportConfig = "Comprehensive Key Alarm Custom Configuration";
    ...
    this.manual_acknowledgment_of_alarm_types = "MANUAL ACKNOWLEDGMENT OF ALARM TYPES";
    this.acknowledge_emergency_alarm = "ACKNOWLEDGE EMERGENCY ALARM";
    this.acknowledge_hazard_alarm = "ACKNOWLEDGE HAZARD ALARMS";
    this.acknowledge_entry_and_exit_alarm = "ACKNOWLEDGING ENTRY AND EXIT ZONE ALARMS";
    ...
    this.acknowledge_illegal_vehicle_displacement_alarm = "CONFIRMATION OF ILLEGAL VEHICLE DISPLACEMENT ALARM";
    ...
    this['Alarm.disposition.statistics.report'] = "Alarm handling statistics report";
    this['report.net_alarm_type_sb_l1_hit_pedestrian'] = "Pedestrian collision warning level 1";
